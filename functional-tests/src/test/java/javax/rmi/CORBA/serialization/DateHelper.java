...
/**
 * DateHelper.java Generated by the IDL-to-Java compiler (portable), version "3.0" from java/util/Date.idl 01 June 1999
 * 20:22:16 o'clock GMT+00:00
 */
...
abstract public class DateHelper {
    ...
    public static Date create__(org.omg.CORBA.ORB _orb) {
        try {
            DateValueFactory _factory = (DateValueFactory) ((org.omg.CORBA_2_3.ORB) _orb).lookup_value_factory(id());
    ...
    public static Date create__long__long__long__long__long__long(org.omg.CORBA.ORB _orb, int arg0, int arg1, int arg2, int arg3, int arg4,
            int arg5) {
        try {
            DateValueFactory _factory = (DateValueFactory) ((org.omg.CORBA_2_3.ORB) _orb).lookup_value_factory(id());
