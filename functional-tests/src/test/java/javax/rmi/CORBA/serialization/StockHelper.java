...
/**
 * gen/examples/stock/StockHelper.java Generated by the IDL-to-Java compiler (portable), version "3.0" from
 * examples/stock/Stock.idl 02 June 1999 21:47:31 o'clock GMT+00:00
 */
...
abstract public class StockHelper {
        ...
        if (__typeCode == null) {
            synchronized (org.omg.CORBA.TypeCode.class) {
                if (__typeCode == null) {
                    ...
                    _members0[0] = new org.omg.CORBA.ValueMember("current", "", _id, "", _tcOf_members0, null,
                            org.omg.CORBA.PRIVATE_MEMBER.value);
                    // ValueMember instance for symbol
                    _tcOf_members0 = org.omg.CORBA.WStringValueHelper.type();
                    _members0[1] = new org.omg.CORBA.ValueMember("symbol", org.omg.CORBA.WStringValueHelper.id(), _id, "", _tcOf_members0,
    ...
    public static Stock create(org.omg.CORBA.ORB _orb, String name) {
        try {
            StockValueFactory _factory = (StockValueFactory) ((org.omg.CORBA_2_3.ORB) _orb).lookup_value_factory(id());
