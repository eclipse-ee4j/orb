        ...
        if (__typeCode == null) {
            synchronized (org.omg.CORBA.TypeCode.class) {
                if (__typeCode == null) {
                    ...
                    _members0[0] = new org.omg.CORBA.ValueMember("fInt", "", _id, "", _tcOf_members0, null,
                    ...
                    _members0[1] = new org.omg.CORBA.ValueMember("fLong", "", _id, "", _tcOf_members0, null,
                            org.omg.CORBA.PRIVATE_MEMBER.value);
                    // ValueMember instance for fFloat
                    _tcOf_members0 = org.omg.CORBA.ORB.init().get_primitive_tc(org.omg.CORBA.TCKind.tk_float);
                    _members0[2] = new org.omg.CORBA.ValueMember("fFloat", "", _id, "", _tcOf_members0, null,
                            org.omg.CORBA.PRIVATE_MEMBER.value);
                    // ValueMember instance for fDouble
                    _tcOf_members0 = org.omg.CORBA.ORB.init().get_primitive_tc(org.omg.CORBA.TCKind.tk_double);
                    _members0[3] = new org.omg.CORBA.ValueMember("fDouble", "", _id, "", _tcOf_members0, null,
                            org.omg.CORBA.PRIVATE_MEMBER.value);
                    // ValueMember instance for fString
                    _tcOf_members0 = org.omg.CORBA.ORB.init().create_string_tc(0);
                    _members0[4] = new org.omg.CORBA.ValueMember("fString", "", _id, "", _tcOf_members0, null,
                            org.omg.CORBA.PRIVATE_MEMBER.value);
                    __typeCode = org.omg.CORBA.ORB.init().create_value_tc(_id, "OBVTestObjectOne", org.omg.CORBA.VM_NONE.value, null,
                            _members0);
                    __active = false;
                }
            }
