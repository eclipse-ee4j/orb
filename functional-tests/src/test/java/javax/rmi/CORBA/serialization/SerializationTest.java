...
public class SerializationTest extends test.Test {
    ...
    public void run() {
        ...
        try {
            ...
            orbProps.put("org.omg.CORBA.ORBClass", "com.sun.corba.ee.impl.orb.ORBImpl");
            orbProps.put("org.omg.CORBA.ORBSingletonClass", "com.sun.corba.ee.impl.orb.ORBSingleton");
            org.omg.CORBA.ORB orb = org.omg.CORBA.ORB.init(getArgsAsArgs(), orbProps);
            ...
            org.omg.CORBA_2_3.portable.OutputStream sos = (org.omg.CORBA_2_3.portable.OutputStream) orb.create_output_stream();
...
// Start of writing phase:
            ...
            Graph graph = new Graph("This",
                    new Graph("is", new Graph("a", new Graph("graph", new Graph("object", new Graph("test.", null))))));
            ...
            org.omg.CORBA_2_3.portable.OutputStream sos2 = (org.omg.CORBA_2_3.portable.OutputStream) orb.create_output_stream();
            ...
            javax.rmi.CORBA.serialization.ComplexTestObjectTwo test2 = new javax.rmi.CORBA.serialization.ComplexTestObjectTwo();
            sos.write_value(test2);

            test("writeComplexTestObjectTwoSubclass");
            javax.rmi.CORBA.serialization.ComplexTestObjectTwoSubclass test2subclass = new javax.rmi.CORBA.serialization.ComplexTestObjectTwoSubclass();
            sos.write_value(test2subclass);

            test("writeComplexTestObjectTwoSubclassDefaults");
            javax.rmi.CORBA.serialization.ComplexTestObjectTwoSubclassDefaults test2subclassDefaults = new javax.rmi.CORBA.serialization.ComplexTestObjectTwoSubclassDefaults();
            ...
            javax.rmi.CORBA.serialization.EmptyTestObject testEmptyA = new javax.rmi.CORBA.serialization.EmptyTestObject();
            sos.write_value(testEmptyA);

            test("writeEmptyTestObject2");
            javax.rmi.CORBA.serialization.EmptyTestObject testEmptyB = new javax.rmi.CORBA.serialization.EmptyTestObject();
            ...
            javax.rmi.CORBA.serialization.ComplexTestObjectFour test4 = new javax.rmi.CORBA.serialization.ComplexTestObjectFour();
            ...
            long[][] array2 = { { 9, 8, 7, 6, 1 }, { 18, 4, 6 }, { 0, 5, 7, 9, 11, 13 } };
            ...
            short[][][] dim3 = { { { 0, 8, 7, 6, 1 }, { 1, 5, 7, 13 }, { 2, 4, 6 }, }, { { 3, 4, 10 }, { 4, 5, 7, 9, 13 } },
                    { { 5, 4, 6 }, { 6, 5, 8, 9, 11, 13 }, { 7, 8, 7, 6, 1 }, { 8, 8, 7, 6, 9 }, }, };
            sos.write_value(dim3);

            test("writeObjectArray");
            // Check single dimensional object array...

            ObjectByValue[] array3 = { new ObjectByValue(5, 10, "a", "f"), new ObjectByValue(6, 11, "b", "g"),
                    new ObjectByValue(7, 12, "c", "h"), new ObjectByValue(8, 13, "d", "i"), new ObjectByValue(9, 14, "e", "j"), };
            ...
            ObjectByValue[][] array4 = {
                    { new ObjectByValue(0, 10, "a", "g"), new ObjectByValue(0, 11, "b", "h"), new ObjectByValue(0, 12, "c", "i"), },
                    { new ObjectByValue(1, 13, "d", "j"), new ObjectByValue(1, 14, "e", "k"), }, { new ObjectByValue(2, 15, "f", "l"), } };
            ...
            test("readData2");
            java.util.Date _aDate = (java.util.Date) sis.read_value();
