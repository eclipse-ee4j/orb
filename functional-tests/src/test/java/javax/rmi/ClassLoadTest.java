...
public class ClassLoadTest extends Test {
    ...
    private static String[] failure = { "SUCCEED", "ClassNotFoundException", "IllegalArgumentException", "NullPointerException",
    ...
    private Class loadClass(String className, int where, int shouldFail) {
        ...
        try {
            ...
            if (shouldFail == FAIL_NOT_FOUND || (shouldFail == FAIL_NOT_FOUND12_OR_ILLEGAL_ARG11 && is12VM)) {
                helper.pass();
                return null;
            }
            e.printStackTrace();
            ...
            if (shouldFail == FAIL_ILLEGAL_ARG || (shouldFail == FAIL_NOT_FOUND12_OR_ILLEGAL_ARG11 && isPre12VM)) {
                helper.pass();
                return null;
            }
            e.printStackTrace();
