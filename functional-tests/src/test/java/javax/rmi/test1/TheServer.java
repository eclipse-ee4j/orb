...
public class TheServer {
    ...
    // This test runs its own NameServer on test.Util.TEST1_NAME_SERVER_PORT.

    private static String[] myArgs = new String[] { "-ORBInitialPort", test.Util.TEST1_NAME_SERVER_PORT };
    ...
    public static void main(String[] args) {
        try {
            ...
            ComboInterface combo = (ComboInterface) PortableRemoteObject.narrow(ic.lookup("TheTestServer"), ComboInterface.class);
