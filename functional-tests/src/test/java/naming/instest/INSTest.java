...
public class INSTest extends CORBATest {
    ...
    // compiled with these.
    public static String[] javaFiles = { "Client.java", "HelloImpl.java", "INSServer.java" };
    ...
    protected void doTest() throws Throwable {
        ...
        serverProps.setProperty(ORBConstants.PERSISTENT_SERVER_PORT_PROPERTY, TestConstants.PERSISTENT_PORT);

        Controller server = createServer("naming.instest.INSServer");

        server.start();

        Properties clientProps = Options.getClientProperties();
        clientProps.setProperty(TestConstants.URL_PROPERTY,
                "corbaloc:iiop:1.2@localhost:" + TestConstants.PERSISTENT_PORT + '/' + TestConstants.INSServiceName);
