...
public class GameUI implements ActionListener {
    ...
    public synchronized void beginTurn() {
        ...
        if (messages != null) {
            for (int i = 0; i < messages.size(); i++) {
                ...
                if (message != null) {
                    JOptionPane.showMessageDialog(fFrame, message, "Turn Results", JOptionPane.INFORMATION_MESSAGE);
                }
            }
        }
    ...
    class CreateShip implements java.awt.event.ActionListener {
        ...
        public void actionPerformed(ActionEvent e) {
            ...
            if (!message.equals("")) {
                JOptionPane.showMessageDialog(fFrame, message, "IBM Space Conquest", JOptionPane.OK_OPTION);
                return;
            }

            message = "Cost = " + cost + ", Metal = " + metal + ".";
            int build = JOptionPane.showConfirmDialog(fFrame, message, "IBM Space Conquest", JOptionPane.YES_NO_OPTION);
