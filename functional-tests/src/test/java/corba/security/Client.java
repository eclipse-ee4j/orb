...
public class Client {
    ...
    public Client(Properties props, String args[], PrintStream out, PrintStream err) {
...
// *************************************************
    ...
    private void dumpProtectionDomainForClass(Class cls) {
        dumpProtectionDomain("ProtectionDomain for " + cls, cls.getProtectionDomain());
    }
    ...
    private void dumpProperty(String name) {
        info("Property " + name + " has value " + System.getProperty(name));
    }
    ...
    private void runTests() {
        ...
        dumpProtectionDomainForPath(System.getProperty("com.sun.corba.ee.ORBBase") + "/build");
        dumpProtectionDomainForPath(System.getProperty("com.sun.corba.ee.ORBBase") + "/optional/build");
        dumpProtectionDomainForPath(System.getProperty("com.sun.corba.ee.ORBBase") + "/test/build");

        dumpProtectionDomainForClass(com.sun.corba.ee.spi.orb.ORB.class);
        dumpProtectionDomainForClass(com.sun.corba.ee.impl.orb.ORBImpl.class);
        dumpProtectionDomainForClass(org.omg.CORBA.ORB.class);
