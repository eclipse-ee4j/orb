...
public class Server {
    ...
    public static void main(String[] args) {
        ...
        try {
            ...
            createReferenceAndBind("poa1", new idlI1ServantLocator(orb), idlI1Helper.id(), "idlI1");
            System.out.println("Created and Bound idlI1");
            System.out.flush();
            createReferenceAndBind("poa2", new idlI2ServantLocator(orb), idlI2Helper.id(), "idlI2");
    ...
    private static void createReferenceAndBind(String poaName, ServantLocator locator, String repId, String bindingName) {
        try {
            ...
            org.omg.CosNaming.NamingContextExt nctx = org.omg.CosNaming.NamingContextExtHelper.narrow(obj);

            POA poa = rPOA.create_POA(poaName, null, policies);
            poa.set_servant_manager(locator);
            obj = poa.create_reference_with_id((new String("idlI")).getBytes(), repId);
