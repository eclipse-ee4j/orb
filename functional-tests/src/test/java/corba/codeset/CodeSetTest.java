...
public class CodeSetTest extends CORBATest {
    protected void doTest() throws Throwable {
        ...
        Controller server = createServer("corba.codeset.Server", "server");
        Controller client = createClient("corba.codeset.Client", "client1_1");
        ...
        client = createClient("corba.codeset.Client", "client1_2");
