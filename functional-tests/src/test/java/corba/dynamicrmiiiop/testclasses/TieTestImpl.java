...
public class TieTestImpl implements TieTest {
    ...
    private static Object[][] data = {
            ...
            { "vm0", Boolean.FALSE, null, null, null, new Class[0] },
            { "vm1", Boolean.FALSE, null, null, new Object[] { "vm1 arg" }, new Class[0] },
            { "vm2", Boolean.FALSE, null, null, new Object[] { null, "vm2 arg" }, new Class[0] } };
    ...
    private void checkArgs(String mname, Object[] args) {
        ...
        for (int ctr = 0; ctr < expected.length; ctr++) {
            if (!ObjectUtility.equals(expected[ctr], args[ctr])) {
                lastError = "Argument " + ctr + " does not match expected result";
                break;
            }
        }
    }
