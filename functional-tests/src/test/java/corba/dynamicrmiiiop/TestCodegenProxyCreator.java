...
/**
 * Test for the codegen-based ProxyCreator. Steps to test:
 * <OL>
 * <LI>Create a class with a method Object invoke( int methodNumber, Object[] args ). The invoke method simply forwards
 * the invocation to the corresponding method.
 * <LI>Create a suitable remote interface for testing.
 * <LI>Implement the remote interface with an implementation that provides for testing correct behavior.
 * <LI>Be able to run the tests on 2 implementations of the interface.
 * <LI>Create the second implementation of the interface by constructing a proxy that delegates to the first
 * implementation.
...
public class TestCodegenProxyCreator extends TestCase {
    ...
    public static abstract class TestInterfaceImplTester extends TestCase {
        ...
        public void testLongEcho() {
            assertEquals(getTestInterface().echo(12345678901234L), 12345678901234L);
        }
        ...
        public void testConcatSS() {
            assertEquals(getTestInterface().concat("Another ", "Test"), "Another Test");
        }
        ...
        public void testConcatSIS() {
            assertEquals(getTestInterface().concat("Test", 1, " Another"), "Test1 Another");
        }

        public void testConcatISI() {
            assertEquals(getTestInterface().concat(1, "Test", 2), "1Test2");
        }
    }
    ...
    public static class ProxyTestSuite extends TestInterfaceImplTester {
        ...
        public static class TestBase {
            ...
            public Object invoke(int methodNumber, Object[] args) throws Throwable {
                try {
        ...
        private void init() {
            ...
            if (proxyClass == null) {
                ...
                CodegenProxyCreator pc = new CodegenProxyCreator("corba.dynamicrmiiiop.TestInterfaceProxy", baseClass, interfaces, methods);
