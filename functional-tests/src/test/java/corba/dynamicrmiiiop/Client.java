...
public class Client extends TestCase {
    ...
    public void testExceptionNameMangling() {
        Class testClass = corba.dynamicrmiiiop.testclasses.exception.TestException.class;
        String expectedId = "IDL:corba/dynamicrmiiiop/testclasses/_exception/TestEx:1.0";

        ExceptionHandlerImpl eh = new ExceptionHandlerImpl(new Class[0]);
        ExceptionHandlerImpl.ExceptionRW erw = eh.getRMIExceptionRW(testClass);
    ...
    public static void sameException(Object obj1, Object obj2) {
        ...
        if (!obj1.getClass().equals(obj2.getClass())) {
            fail("Objects have different classes: obj1 = " + obj1 + " obj2 = " + obj2);

            return;
        }

        if (!(obj1 instanceof Throwable) || !(obj2 instanceof Throwable)) {
            fail("Objects are not both throwable: obj1 = " + obj1 + " obj2 = " + obj2);
        ...
        /*
         * Don't care about matching messages: that's up to the logex code. boolean sameMessage = equalOrNull(
         * thr1.getMessage(), thr2.getMessage() ) ; if (!sameMessage) { fail(
         * "thr1 and thr2 do not have the same message: thr1 message = " + thr1.getMessage() + " thr2 message = " +
         * thr2.getMessage() ) ; }
         */
    ...
    public static class ORBInitTestSuite extends TestCase {
        /**
         * A simple class that allows checking of the result of a computation both in the current thread and in a new thread.
         */
        ...
        /*
         * Tests: create ORB with dynamic stubs, verify get dynamic stubs from chooser. init ORBSingleton, verify no affect on
         * chooser. chooser.
         */
    ...
    public static class TypeIdTestSuite extends TestCase {
        ...
        public void testDiamondInterface() {
            doTest(A.class, A.class, new Class[] { B.class, C.class, D.class });
        }
        ...
        public void testClassDiamondInterface() {
            doTest(C3.class, A.class, new Class[] { B.class, C.class, D.class });
        }

        public void testClassInheritance() {
            doTest(C4.class, A.class, new Class[] { B.class, C.class, D.class });
        }

        public void testClassMultipleInterface() {
            doTest(C5.class, C5.class, new Class[] { A.class, B.class, C.class, D.class, E.class, F.class, G.class });
        }

        public void testClassComplexInterface() {
            doTest(C6.class, C6.class, new Class[] { A.class, B.class, C.class, D.class, E.class, F.class, G.class, H.class });
        }
        ...
        private void doTest(Class root, Class expectedZerothId, Class[] otherIds) {
            ...
            assertEquals("firstId = " + firstId + " expectedFirstId = " + expectedFirstId, firstId, expectedFirstId);

            assertTrue("rest = " + rest + " expectedRest = " + expectedRest, rest.equals(expectedRest));
        }
    ...
    public static class DMMTestSuite extends TestCase {
        /*
         * Test strategy: Same test class as in the TieTestSuite? Simple methods: 0,1 arg; 0,1 result; Echo test: for each kind
         * of type, have an echo method that takes and returns that type. Verify that the DMM reads and writes these types
         * correctly (run the test for R/W arg/result). Kinds: int Integer byte short char long float double Remote
         * org.omg.CORBA.Object subclass of org.omg.CORBA.Object java.Object java.io.Serializable java.io.Externalizable
         * IDLEntity HashMap (a value type)
         *
         * It is actually more important to verify that the DMM correctly assigns the right ReaderWriter to each type.
         */
    ...
    public static class DMMImplTestSuite extends TestCase {
        /*
         * It is actually more important to verify that the DMM correctly assigns the right ReaderWriter to each type. To do
         * this, we test DynamicMethodMarshalledImpl.makeReadWriter directly to see that the correct ReaderWriter is created by
         * checking the name of the ReaderWriter.
         */
        ...
        private void doTest(Class cls, String cname) {
            DynamicMethodMarshallerImpl.ReaderWriter rw = DynamicMethodMarshallerImpl.makeReaderWriter(cls);
            assertEquals(makeRWName(cname), rw.toString());
        }

        private void doClassTest(Class cls, String type) {
            DynamicMethodMarshallerImpl.ReaderWriter rw = DynamicMethodMarshallerImpl.makeReaderWriter(cls);
            assertEquals(makeRWName(type, cls.getName()), rw.toString());
        }
        ...
        public void testCORBAObject() {
            doTest(org.omg.CORBA.Object.class, "org.omg.CORBA.Object");
        }
        ...
        public void testAllRemote() {
            doTest(DMMImplTestClasses.AllRemote.class, "abstract_interface");
        }

        public void testSomeRemote() {
            doClassTest(DMMImplTestClasses.SomeRemote.class, "value");
        }

        public void testNoRemote() {
            doClassTest(DMMImplTestClasses.NoRemote.class, "value");
        }

        public void testNoMethods() {
            doTest(DMMImplTestClasses.NoMethods.class, "abstract_interface");
        }

        public void testIDLSimpleInterface() {
            doTest(DMMImplTestClasses.IDLSimpleInterface.class, "abstract_interface");
        }

        public void testIDLValue() {
            doTest(DMMImplTestClasses.IDLValue.class, "abstract_interface");
        }

        public void testIDLStruct() {
            doClassTest(DMMImplTestClasses.IDLStruct.class, "value");
        }

        public void testIDLInterface() {
            doClassTest(DMMImplTestClasses.IDLInterface.class, "org.omg.CORBA.Object");
        }
    }
    ...
    public static class IDLTypeTestSuite extends TestCase {
        ...
        private void init() {
            ...
            itype2 = new IDLType(Object.class, new String[] { "first" }, "Bar");
            itype3 = new IDLType(Object.class, new String[] { "first", "second" }, "BazException");
            itype4 = new IDLType(Exception.class, new String[] { "java", "lang" }, "Exception");
        }
        ...
        public void testGetExceptionName1() {
            assertTrue("Actual value=" + itype1.getExceptionName(), itype1.getExceptionName().equals("IDL:FooEx:1.0"));
        }

        public void testGetExceptionName2() {
            assertTrue("Actual value=" + itype2.getExceptionName(), itype2.getExceptionName().equals("IDL:first/BarEx:1.0"));
        }

        public void testGetExceptionName3() {
            assertTrue("Actual value=" + itype3.getExceptionName(), itype3.getExceptionName().equals("IDL:first/second/BazEx:1.0"));
        }

        public void testGetExceptionName4() {
            assertTrue("Actual value=" + itype4.getExceptionName(), itype4.getExceptionName().equals("IDL:java/lang/Ex:1.0"));
        }
    ...
    public static class TieTestSuite extends TestCase {
        /*
         * Test strategy: Create a remote interface TieTest that contains all necessary methods for different argument and
         * result patterns. Assume that the DMM test has handled all of the oddball cases. Give the methods unique names just to
         * make things easier. For each method, define a set of arguments and an expected result. Have some methods throw
         * exceptions: 1. System Exception 2. Java exception (we don't do anything at this level with other types). Create a
         * TieTestImpl class that implements TieTest and also defines the arguments to pass to a method and the expected result.
         * Each method impl checks that it received the expected args and returns the expected result. The client stub is
         * simulated as follows: 1. Create an input stream. 2. Lookup the expected args for the test method, and write them to
         * the input stream using the DMM. 3. Get the method name from the IDLNameTranslator. 4. Create a ReponseHandler that
         * just returns an OutputStream. 5. Call _invoke on the Tie. 6. Check the result. Test cases: 0,1,2 args X 0,1 result 1
         * arg, 1 result, throws sysex 1 arg, 1 result, throws java exception
         */
        ...
        private void checkOutputStream(Object expectedResult, String mname, OutputStream os) {
            InputStream is = transport.getInputStream(os);
            Method method = getMethodByName(mname);
            DynamicMethodMarshaller dmm = pm.getDynamicMethodMarshaller(method);
        ...
        public void doTest(String mname) {
            ...
            try {
                OutputStream os = (OutputStream) tie._invoke(methodWireName, is, rhandler);
    ...
    public static class StubTestSuite extends TestCase {
        /*
         * Test strategy: Create a remote interface StubTest that contains all necessary methods for different argument and
         * result patterns. Assume that the DMM test has handled all of the oddball cases. Give the methods unique names just to
         * make things easier. For each method, define a set of arguments and an expected result. Have some methods throw
         * exceptions: 1. System Exception 2. Java exception 3. Remarshal exception 4. Application exception We'll reuse the Tie
         * test in the remote case. The delegate is simulated as follows: Most of the Delegate methods are no-ops. We only
         * implement those methods required by the dynamic stub: 1. Delegate.request( proxy, String, respExp ) Just create a
         * stream and return it. This must contain the method name. 2. Delegate.invoke( proxy, OutputStream ) Unmarshal args and
         * check that they match. Construct response according to method name for the test case. 3. Delegate.releaseReply(
         * proxy, InputStream ) Just set a flag that this has been called, which needs to be checked in the test case. 4.
         * Delegate.servant_preinvoke( proxy, String, Class ) 5. Delegate.servant_postinvoke( proxy, ServantObject ) 6. Delegate
         * is an instance of CorbaClientDelegate 7. Delegate.getContactInfoList needs to return a CorbaContactInfoList that: 8.
         * Implement getLocalClientRequestDispatcher by returning a LocalClientRequestDispatcher that allows the test to return
         * either true or false for lcrd.useLocalInvocation.
         *
         * Test cases: (we have already exercised enough of the 0-1 arg/result cases) 1 arg, 1 result, return result check for
         * correct result 1 arg, 1 result, throws system exception check for correctly mapped exception 1 arg, 1 result, throws
         * java exception check for Unknown 1 arg, 1 result, throws declared exception 1 arg, 1 result, throws remarshal
         * exception once only Also do these simulating the local case. This should be just a flag.
         */
        ...
        private void init() {
            ...
            delegate = new TestClientDelegate(orb, transport, impl, tie, rhandler);
            Class cls = TieTest.class;
            stub = sff.createStubFactory(cls.getName(), false, "", cls, cls.getClassLoader()).makeStub();
        ...
        /*
         * Commented out for now: needs further investigation public void testLocalJavaException() { doLocalTest(
         * "throwsJavaException" ) ; }
         */
