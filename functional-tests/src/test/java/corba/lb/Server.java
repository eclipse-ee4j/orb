...
public class Server {
    ...
    private static void testLocalCalls(ORB orb) {
        ...
        try {
            ...
            Test test = (Test) PortableRemoteObject.narrow(initialContext.lookup(Common.ReferenceName), Test.class);

            System.out.println("test.is_local() = " + ((org.omg.CORBA.portable.ObjectImpl) test)._is_local());
