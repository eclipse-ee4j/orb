...
public class Client {
    ...
    public static void main(String[] av) {
        try {
            ...
            Test ref = (Test) lookupAndNarrow(Common.ReferenceName, Test.class, ic);
            ...
            if (errorCount == 1) {
                System.out.println("Client failed (" + errorCount + ") time(s) due to server restart");
                errorCount = 0;
            }
    ...
    public static Object lookupAndNarrow(String name, Class clazz, InitialContext ic) throws Exception {
