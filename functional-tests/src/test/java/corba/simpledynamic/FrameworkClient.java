...
public class FrameworkClient extends Framework {
    ...
    protected Properties extraClientProperties() {
        ...
        result.setProperty(ORBConstants.SOCKET_FACTORY_CLASS_PROPERTY, NortelSocketFactory.class.getName());

        // register ORBInitializer
        result.setProperty(ORBConstants.PI_ORB_INITIALIZER_CLASS_PREFIX + InterceptorTester.class.getName(), "true");

        // result.setProperty( ORBConstants.DEBUG_PROPERTY,
        // "transport" ) ;

        result.setProperty(ORBConstants.TRANSPORT_TCP_CONNECT_TIMEOUTS_PROPERTY, "100:2000:100");
    ...
    public void testCorbalocRir() {
        ...
        try {
            ...
            getClientORB().register_initial_reference(name, (org.omg.CORBA.Object) stub);
    ...
    private void doOperation(String msg, NullaryFunction func) {
        ...
        try {
            /*
             * if (DEBUG_5161) { timerContext.enable() ; }
             */
            ...
            /*
             * if (DEBUG_5161) { timerContext.disable() ; timerContext.display( msg ) ; timerContext.clear() ; }
             */
        }
    }
    /*
     ...
     * clientRef5161.echo( bpvo ) ; } finally { stop() ; } Assert.assertTrue( bpvo2.equals( bpvo ) ) ; return null ; } catch
     * (RemoteException exc) { throw new RuntimeException( exc ) ; } } } ) ; }
     */
    ...
    public void test5161() throws RemoteException {
        ...
        /**
         * This case passes, so comment out for now doOperation( "Testing ArrayList", new NullaryFunction() { public Object
         * evaluate() { try { BuckPasserAL bpal2 = clientRef5161.echo( bpal ) ; Assert.assertTrue( bpal2.equals( bpal ) ) ;
         * return null ; } catch (RemoteException exc) { throw new RuntimeException( exc ) ; } } } ) ;
         */
    }
