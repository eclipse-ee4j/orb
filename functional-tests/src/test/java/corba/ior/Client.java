...
// *************************************************
    ...
    class IdentifiableImpl implements Identifiable {
        ...
        public boolean equals(Object obj) {
            ...
            return (ii.getId() == getId()) && (ii.getValue() == getValue());
        }
    }

    public void checkIdentifiableIterator(Iterator iter, IdentifiableImpl[] result, int index) {
        int ctr = 0;
        while (iter.hasNext()) {
            Object obj = iter.next();
            if (ctr >= result.length) {
                error("Too many IdentifiableImpls returned by iterator" + index);
            }

            if (!result[ctr].equals(obj)) {
                error("Wrong IdentifiableImpl " + result[ctr] + " in iterator" + index);
            }
            ctr++;
        }

        if (ctr != result.length) {
            error("Too few identifiableImpls returned by iterator" + index + " (ctr=" + ctr + " length=" + result.length + ")");
        }
    }
    ...
    public void testCorbalocIOR() {
        ...
        //
        org.omg.CORBA.Object ref = orb.string_to_object("corbaloc:iiop:1.2@pico:4444/NameService");
        IOR ior1 = orb.getIOR(ref, false);

        addr = IIOPFactories.makeIIOPAddress("pico", 4444);
        IIOPProfileTemplate profileTemplate_1_2 = IIOPFactories.makeIIOPProfileTemplate(orb, GIOPVersion.V1_2, addr);
        ...
        /*
         * // This does not work since CorbalocURL.java validates the // GIOP version so GIOP version 2.9 throw exception
        ...
        addr = IIOPFactories.makeIIOPAddress("pico", 4444);
        profileTemplate_1_2 = IIOPFactories.makeIIOPProfileTemplate(orb, GIOPVersion.V1_2, addr);
        ...
        /*
         * addr = IIOPFactories.makeIIOPAddress( "mega", 7777); IIOPProfileTemplate profileTemplate_2_9 =
         * IIOPFactories.makeIIOPProfileTemplate(orb, new GIOPVersion(2,9), addr);
         */

        addr = IIOPFactories.makeIIOPAddress("femto", 5555);
        IIOPProfileTemplate profileTemplate_1_1 = IIOPFactories.makeIIOPProfileTemplate(orb, GIOPVersion.V1_1, addr);
        ...
        IIOPProfileTemplate profileTemplate_1_0 = IIOPFactories.makeIIOPProfileTemplate(orb, GIOPVersion.V1_0, addr);
        profileList_1_0.add(profileTemplate_1_0);
        addr = IIOPFactories.makeIIOPAddress("tera", 6667);
        profileTemplate_1_0 = IIOPFactories.makeIIOPProfileTemplate(orb, GIOPVersion.V1_0, addr);
        profileList_1_0.add(profileTemplate_1_0);
    ...
    public void testZeroPortPolicy() {
        ...
        Policy[] policies = { rootpoa.create_id_assignment_policy(IdAssignmentPolicyValue.SYSTEM_ID), ZeroPortPolicy.getPolicy() };
    ...
    public void testIdentifiableContainerBase1() {
        ...
        IdentifiableImpl[] obj = { new IdentifiableImpl(0, 27), new IdentifiableImpl(1, 28), new IdentifiableImpl(0, 29),
                new IdentifiableImpl(0, 30), new IdentifiableImpl(2, 31), new IdentifiableImpl(0, 32), new IdentifiableImpl(2, 33) };
        ...
        IdentifiableImpl[][] results = { { obj[0], obj[2], obj[3], obj[5] }, { obj[1] }, { obj[4], obj[6] }, {} };
    ...
    public void testIdentifiableContainerBase2() {
        ...
        TaggedComponent[] comps = { new GenericTaggedComponent(1234, data),
                IIOPFactories.makeJavaCodebaseComponent("http://foo.sun.com:34567"), IIOPFactories.makeORBTypeComponent(0x47653243),
                IIOPFactories.makeAlternateIIOPAddressComponent(addr1), IIOPFactories.makeCodeSetsComponent(orb),
    ...
    public void testIIOPAddress() {
        ...
        IIOPAddress[] addrs = { IIOPFactories.makeIIOPAddress("FOO.SUN.COM", 23), IIOPFactories.makeIIOPAddress("FOO.SUN.COM", 32768),
                IIOPFactories.makeIIOPAddress("FOO.SUN.COM", 40151), IIOPFactories.makeIIOPAddress("FOO.SUN.COM", 65535) };
    ...
    public void testIIOPProfileTemplate() {
        ...
        POAObjectKeyTemplate temp = new POAObjectKeyTemplate(orb, scid, serverid, orbid, poaid);
        ...
        IIOPProfileTemplate ptemp = IIOPFactories.makeIIOPProfileTemplate(orb, gversion, primary);
        ...
        ORBTypeComponent comp = IIOPFactories.makeORBTypeComponent(0x34567ABF);
        ...
        IIOPProfileTemplate ptemp2 = IIOPFactories.makeIIOPProfileTemplate(orb, GIOPVersion.V1_0, primary);
    ...
    public IIOPProfileTemplate makeIIOPProfileTemplate(int port) {
        ...
        IIOPProfileTemplate ptemp = IIOPFactories.makeIIOPProfileTemplate(orb, GIOPVersion.V1_2, primary);
    ...
    public void testIOR() {
        ...
        JavaCodebaseComponent jcomp = IIOPFactories.makeJavaCodebaseComponent(URL);
        ...
        AlternateIIOPAddressComponent comp2 = IIOPFactories.makeAlternateIIOPAddressComponent(addr);
    ...
    private IORTemplate makeIORTemplate(String[] oaid, int[] ports, boolean addComponent) {
        POAObjectKeyTemplate poktemp = makePOAObjectKeyTemplate(new ObjectAdapterIdArray(oaid));
    ...
    private IORTemplateList makeIORTemplateList(String[][] oaids, int[][] ports, boolean addComponent) {
        IORTemplateList result = IORFactories.makeIORTemplateList();
        for (int ctr = 0; ctr < oaids.length; ctr++) {
            result.add(makeIORTemplate(oaids[ctr], ports[ctr], (ctr == 0) && addComponent));
        }
        return result;
    }
    ...
    public void testIORTemplateList() {
        ...
        String[][] oaids = { { "1", "2", "3", "4", "5", "6" }, { "1", "3", "4", "6" }, { "4", "5", "6" },
                { "1", "2", "3", "4", "5", "6", "7", "8" } };

        int[][] ports1 = { { 34567, 23416, 38491, 9321, 65001 }, { 23416, 38491, 9321, 65001 }, { 38491, 9321, 65001 }, { 34567, 65001 }, };

        int[][] ports2 = { { 34567, 23416, 38491, 9321, 65001 }, { 23416, 38491, 65001 }, { 38491, 9321, 65001 }, { 34567, 65001, 3232 }, };
    ...
    private void testIORFactory(IORFactory iorfactory1, IORFactory iorfactory2, boolean equalResult, boolean equivalentResult) {
    ...
    public void testOldJIDLObjectKeyTemplate() {
        ...
        OldJIDLObjectKeyTemplate temp = new OldJIDLObjectKeyTemplate(orb, ObjectKeyFactoryImpl.JAVAMAGIC_OLD, scid, serverid);
        checkOldJIDLObjectKeyTemplate(temp, scid, serverid, ORBVersionFactory.getOLD());

        temp = new OldJIDLObjectKeyTemplate(orb, ObjectKeyFactoryImpl.JAVAMAGIC_NEW, scid, serverid);
        checkOldJIDLObjectKeyTemplate(temp, scid, serverid, ORBVersionFactory.getNEW());

        boolean failed = false;
        try {
            temp = new OldJIDLObjectKeyTemplate(orb, ObjectKeyFactoryImpl.JAVAMAGIC_NEWER, scid, serverid);
        } catch (INTERNAL ex) {
            failed = true;
        } catch (Exception exc) {
    ...
    private void checkOldJIDLObjectKeyTemplate(OldJIDLObjectKeyTemplate temp, int scid, int serverid, ORBVersion version) {
    ...
    public void testJIDLObjectKeyTemplate() {
        ...
        JIDLObjectKeyTemplate temp = new JIDLObjectKeyTemplate(orb, scid, serverid);
        ...
        byte[] fullKey = generator.makeKey(ObjectKeyFactoryImpl.JAVAMAGIC_NEWER);
        ...
        is = makeInputStream(os);
        ObjectKeyTemplate newTemplate = orb.getObjectKeyFactory().createTemplate(is);
    ...
    private void checkIterator(String msg, Iterator iter, String values) {
        ...
        while (st.hasMoreTokens()) {
            ...
            if (!refValue.equals(value)) {
                error(msg + ": got value " + value + ", expected value " + refValue);
            }
        }
    ...
    class JIDLKeyGenerator extends KeyGeneratorBase {
        public JIDLKeyGenerator() {
            super(OldJIDLObjectKeyTemplate.class, JIDLObjectKeyTemplate.class);
        }
    ...
    public void testObjectKeyFactory_JIDL() {
        ...
        byte[] key = generator.makeKey(ObjectKeyFactoryImpl.JAVAMAGIC_OLD);
    ...
    class POAKeyGenerator extends KeyGeneratorBase {
        ...
        public POAKeyGenerator() {
            super(OldPOAObjectKeyTemplate.class, POAObjectKeyTemplate.class);
        }
    ...
    public void testOldPOAObjectKeyTemplate() {
        ...
        OldPOAObjectKeyTemplate temp = new OldPOAObjectKeyTemplate(orb, ObjectKeyFactoryImpl.JAVAMAGIC_OLD, scid, serverid, orbid, poaid);
        checkOldPOAObjectKeyTemplate(temp, scid, serverid, orbid, poaid, ORBVersionFactory.getOLD());

        temp = new OldPOAObjectKeyTemplate(orb, ObjectKeyFactoryImpl.JAVAMAGIC_NEW, scid, serverid, orbid, poaid);
        checkOldPOAObjectKeyTemplate(temp, scid, serverid, orbid, poaid, ORBVersionFactory.getNEW());

        boolean failed = false;
        try {
            temp = new OldPOAObjectKeyTemplate(orb, ObjectKeyFactoryImpl.JAVAMAGIC_NEWER, scid, serverid, orbid, poaid);
        } catch (INTERNAL ex) {
            failed = true;
        } catch (Exception exc) {
    ...
    private void checkOldPOAObjectKeyTemplate(OldPOAObjectKeyTemplate temp, int scid, int serverid, int orbid, int poaid,
            ORBVersion version) {
        if (temp.getSubcontractId() != scid) {
            error("getSubcontractId returns bad value");
        }
    ...
    public void testJavaCodebaseComponent() {
        ...
        JavaCodebaseComponent comp = IIOPFactories.makeJavaCodebaseComponent(URL);
    ...
    public void testORBTypeComponent() {
        ...
        ORBTypeComponent comp = IIOPFactories.makeORBTypeComponent(orbtype);
    ...
    private void testObjectAdapterIdIterator(String[] data, int count, ObjectAdapterId poaid) {
        ...
        if (numLevels != count) {
            error("getNumLevels() returned " + numLevels + " expected " + count);
        }

        Iterator<String> iterator = poaid.iterator();
        int ctr = 0;
        ...
        while (iterator.hasNext()) {
            ...
            if (current.equals(data[ctr])) {
                ...
                error("iterator return bad element at index " + ctr + ": expected " + data[ctr] + " got " + current);
            }
        }
    ...
    public void testObjectAdapterId() {
        ...
        String[] data = { "first", "second", "third", "fourth", "fifth", "sixth" };
    ...
    public void testObjectReferenceTemplateImpl() {
        ...
        ObjectReferenceTemplateImpl orti = (ObjectReferenceTemplateImpl) IORFactories.makeObjectReferenceTemplate(orb, iortemp);
        ...
        // check make_object
        org.omg.CORBA.Object oref = orti.make_object("IDL:org/omg/CORBA/Object:1.0", oid);
        ...
        ObjectReferenceTemplateImpl orti2 = (ObjectReferenceTemplateImpl) IORFactories.makeObjectReferenceTemplate(orb, iortemp2);
        ...
        // check make_object
        oref = orti2.make_object("IDL:org/omg/CORBA/Object:1.0", oid);
