...
public class CharGenerator {
    ...
    private static class LatinSelector extends CharSelector {
        public boolean testThisCharacter(char ch) {
            ...
            return (blk != null && blk == Character.UnicodeBlock.BASIC_LATIN);
        }
    }
    ...
    private static class WideSelector extends LatinSelector {
        public boolean testThisCharacter(char ch) {
            ...
            return (blk != null && (blk == Character.UnicodeBlock.KATAKANA || blk == Character.UnicodeBlock.HIRAGANA
                    || blk == Character.UnicodeBlock.LATIN_1_SUPPLEMENT || blk == Character.UnicodeBlock.LATIN_EXTENDED_A
                    || blk == Character.UnicodeBlock.LATIN_EXTENDED_B || blk == Character.UnicodeBlock.LATIN_EXTENDED_ADDITIONAL
                    || blk == Character.UnicodeBlock.NUMBER_FORMS || blk == Character.UnicodeBlock.CJK_COMPATIBILITY_FORMS
                    || blk == Character.UnicodeBlock.CJK_COMPATIBILITY_IDEOGRAPHS
                    || blk == Character.UnicodeBlock.CJK_SYMBOLS_AND_PUNCTUATION || blk == Character.UnicodeBlock.CJK_UNIFIED_IDEOGRAPHS
                    || blk == Character.UnicodeBlock.ARABIC || super.testThisCharacter(ch)));
        }
    }
}
