...
public class Server extends LocalObject implements ORBInitializer {
    ...
    private static class ServerRequestHandler implements BadServerIdHandler {
        ...
        public void handle(ObjectKey objectKey) {
            ...
            throw new ForwardException((com.sun.corba.ee.spi.orb.ORB) orb, ior);
        }
    }

    static class InterceptorImpl extends org.omg.CORBA.LocalObject implements ServerRequestInterceptor {
    ...
    public static void writeObjref(org.omg.CORBA.Object ref, String file, org.omg.CORBA.ORB orb) {
        ...
        try {
            java.io.DataOutputStream out = new java.io.DataOutputStream(new FileOutputStream(fil));
    ...
    public static void main(String args[]) {
        try {
            ...
            props.setProperty(ORBConstants.BAD_SERVER_ID_HANDLER_CLASS_PROPERTY, className);

            ORB orb = ORB.init(args, System.getProperties());

            com.sun.corba.ee.spi.orb.ORB ourORB = (com.sun.corba.ee.spi.orb.ORB) orb;

            System.out.println("==== Server GIOP version " + ourORB.getORBData().getGIOPVersion() + " with strategy "
