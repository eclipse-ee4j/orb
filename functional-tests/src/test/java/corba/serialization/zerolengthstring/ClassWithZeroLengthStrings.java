...
public class ClassWithZeroLengthStrings implements Serializable {
    ...
    /**
     * Important method to check whether the structure of the object is maintained correctly after Util.copyObject( )
     */
    public boolean validateObject() {
        ...
        if (!field2.equals(zeroLengthString) || !field3.equals(zeroLengthString) || !field4.equals(zeroLengthString)
                || !field5.equals(zeroLengthString)) {
            System.err.println("if( !field2.equals( zeroLengthString)" + "|| !field3.equals( zeroLengthString )"
                    + "|| !field4.equals( zeroLengthString ) " + "|| !field5.equals( zeroLengthString ) returned true");
            return false;
        }
