    ...
    public SocketInfo getEndPointInfo(ORB orb, IOR ior, SocketInfo socketInfo) {
        ...
        if (socketInfo != null) {
            if (socketInfo instanceof SocketInfoImpl) {
                System.out.println("MySocketFactory.getEndPointInfo: found cookie: " + ((SocketInfoImpl) socketInfo).getCookie());
            } else {
        ...
        if (portList == null) {
            ...
            socketInfo = new SocketInfoImpl(ORBSocketFactory.IIOP_CLEAR_TEXT, host, port, "clear text cookie");
        } else {
