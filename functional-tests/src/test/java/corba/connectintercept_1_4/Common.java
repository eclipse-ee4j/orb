...
public abstract class Common {
    ...
    public static final String DEFAULT_FACTORY_CLASS = "com.sun.corba.ee.impl.legacy.connection.DefaultSocketFactory";
    ...
    public static void up(int x) {
        if (x >= currentOrder) {
            ...
            throw new INTERNAL("Interceptor ordering (up): " + x + " " + currentOrder, -45, CompletionStatus.COMPLETED_MAYBE);
        }
    }
    ...
    public static void down(int x) {
        if (x <= currentOrder) {
            ...
            throw new INTERNAL("Interceptor ordering (down): " + x + " " + currentOrder, -45, CompletionStatus.COMPLETED_MAYBE);
        }
    }
    ...
    public static String createComponentData(String msg, Object o) {
        ...
        if (o instanceof IORInfoExt) {
            ...
            throw new RuntimeException(ccd + ": unexpected type of object: " + o);
        }

        return createComponentData(msg, MyType1Port, MyType2Port, MyType3Port);
    }

    public static String createComponentData(String msg, int MyType1Port, int MyType2Port, int MyType3Port) {
        String componentData = Common.MyType1 + ":" + MyType1Port + "," + Common.MyType2 + ":" + MyType2Port + "," + Common.MyType3 + ":"
                + MyType3Port;
