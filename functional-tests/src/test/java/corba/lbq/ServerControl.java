...
public interface ServerControl extends Remote {
    ...
    /**
     * Register the reporter with this server. It is invoked every time the server handles a request.
     */
    void registerReportCallback(ServerReporter reporter) throws RemoteException;

    /**
     * Causes the server to start rejecting requests after numRequests have been handled. setRejecting and clearRejecting
     * can be queued.
     */
    void setRejecting(int numRequests) throws RemoteException;

    /**
     * Causes the server to stop rejecting requests after numRequests have been rejected. setRejecting and clearRejecting
     * can be queued.
     */
