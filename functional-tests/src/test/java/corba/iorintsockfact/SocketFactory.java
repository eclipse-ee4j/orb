 ...
 * @author Harold Carr
 */
public class SocketFactory extends DefaultSocketFactory implements ORBSocketFactory {
    ...
    public SocketInfo getEndPointInfo(ORB orb, IOR ior, SocketInfo socketInfo) {
        ...
        Iterator iterator = iptemp.iteratorById(org.omg.IOP.TAG_ALTERNATE_IIOP_ADDRESS.value);
        ...
        while (iterator.hasNext()) {
            ...
            AlternateIIOPAddressComponent iiopAddressComponent = (AlternateIIOPAddressComponent) iterator.next();
            return new EndPointInfoImpl(ORBSocketFactory.IIOP_CLEAR_TEXT, iiopAddressComponent.getAddress().getPort(),
