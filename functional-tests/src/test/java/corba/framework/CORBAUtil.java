...
public class CORBAUtil {
    /**
     * Create the specified directory, including any intermediate directories that do not exist.
     *
    ...
    /**
     * Open/create a file with the given name in the specified directory. Calls openNewFile(String) with a full path created
     * by combining dir and name with the File.separator. This also ensures that the directory exists first.
     *
     ...
     */
    public static OutputStream openFile(String dir, String name) throws FileNotFoundException {
        CORBAUtil.mkdir(dir);
    ...
    /**
     * Open/create a file at the given full path, appending to it if it is already there.
     *
     * @param fullpath Path and name of the file
     * @return OutputStream for writing to the file
     * @exception FileNotFoundException Error creating the file
     */
    public static OutputStream openFile(String fullpath) throws FileNotFoundException {
        return new BufferedOutputStream(new FileOutputStream(fullpath, true));
    }

    /**
     * Convert the given Vector to a String array. Returns null if the given Vector is null.
     *
    ...
    /**
     * Return the package name of the given object. Sometimes getPackage() returns null, but Class getName() always returns
     * a fully qualified package and class name.
     *
     * @param obj Object to examine (can't be null)
     * @return String representing the package name of the object or the empty string if it couldn't be determined/top level
     * package
     */
    ...
    /**
     * Find the given file name in one of the provided directories, and return the resulting absolute path of the result.
     * Neither the filename nor the directory array can be null.
     *
     ...
     *
     * @exception FileNotFoundException Couldn't find the file in provided locations
     */
    public static String toAbsolutePath(String filename, String[] dirs) throws FileNotFoundException {
    ...
    /**
     * Find the given files in the given set of directories, and convert them to absolute paths. Neither files nor dirs can
     * be null.
     *
     * @param files Array of file names to convert to absolute paths
     * @param dirs Directories to search in
     *
     * @exception FileNotFoundException At least one requested file couldn't be found in the directories
     *
     */
    ...
    /**
     * Compare the two files, throwing an exception if there was an error or a difference between them.
     *
     ...
     */
    public static void fileCompare(String filePath1, String filePath2) throws Exception {
