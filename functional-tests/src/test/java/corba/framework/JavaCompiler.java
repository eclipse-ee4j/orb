...
public class JavaCompiler extends Compiler {
    ...
    public String compilerClassName() {
        ...
        return (newVM() ? "com.sun." : "sun.") + "tools.javac.Main";
    }

    /**
     * Compile the given .java files. Files are given as absolute paths. The text output messages from the compile are
     * placed in files named javac.out.txt and javac.err.txt in the given report directory.
     *
     * @param files Absolute paths to .java files for compilation (can be null)
