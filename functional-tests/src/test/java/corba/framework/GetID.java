 ...
 *
 * The GetID class generates a test-ID for identifying tests in the log files. The ID is generated by replacing the '.'s
 * in the full-qualified package name by '_'s, and then appending a user-specified string Id. Since, the fully qualified
 * package name is unique across a test-suite, this results in unique IDs.
 *
...
public class GetID {
    ...
    /**
     * Generates a unique ID for a test from the package name and a user-specified id.
     *
     * @param o an instance of the test class
     * @param id a user-specified id to be appended to the id generated by this method. <em>Note: Usually, one would specify
     * a string,</em> <em>representive of the test case. </em>
