...
public class Client {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            GIOPCombo ref = (GIOPCombo) PortableRemoteObject.narrow(obj, GIOPCombo.class);
            ...
            if (doCMVT) {
                ...
                System.out
                        .println("Echoed CustomMarshalledValueType equals the sent CustomMarshalledValueType == " + cmvt.equals(cmvtEcho));
            }
