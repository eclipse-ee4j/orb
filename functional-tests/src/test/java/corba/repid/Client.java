...
public class Client {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            OutputStream ostr = (org.omg.CORBA_2_3.portable.OutputStream) ourORB.create_output_stream();
            ostr.write_value(inStrSeq, new test.StringSeqHelper());
            InputStream istr = (org.omg.CORBA_2_3.portable.InputStream) ostr.create_input_stream();
            String[] outStrSeq = (String[]) istr.read_value(new test.StringSeqHelper());
