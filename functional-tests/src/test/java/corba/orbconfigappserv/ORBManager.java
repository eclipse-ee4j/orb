...
public class ORBManager {
    private static final String poaOrbClass = "com.sun.corba.ee.impl.orb.ORBImpl";
    private static final String poaOrbSingletonClass = "com.sun.corba.ee.impl.orb.ORBSingleton";
    private static final String peorbConfigClass = "corba.orbconfigappserv.UserORBConfiguratorImpl";
    ...
    public static final String SUN_PEORB_CONFIGURATOR_CLASS_PROPERTY = "com.sun.corba.ee.ORBUserConfigurators";
    ...
    public static final String SUN_ORB_SOCKET_FACTORY_CLASS_PROPERTY = "com.sun.corba.ee.connection.ORBSocketFactoryClass";

    private static final String J2EE_INITIALIZER = "corba.orbconfigappserv.ORBInitializerImpl";
    private static final String PI_ORB_INITIALIZER_CLASS_PREFIX = "org.omg.PortableInterceptor.ORBInitializerClass.";

    public static final String ORB_LISTEN_SOCKET_PROPERTY = "com.sun.corba.ee.connection.ORBListenSocket";
    ...
    public static void main(String[] av) {
        ...
        props.put(UserORBConfiguratorImpl.propertyName, "corba.orbconfigappserver.ORBManager");
    ...
    public static void testInit(String msg, String[] av, Properties props) {
        ...
        System.out.println();
        init(av, null);
        System.out.println(((com.sun.corba.ee.spi.orb.ORB) orb).getORBData().getORBInitialHost());
    }

    /**
     * Initializes the single ORB in this process. This must be called before calling other methods within this class.
     */
    public static synchronized void init(String[] args, Properties props) {
        /*
         * if (orb != null) // There should be only ONE ORB. return;
         */
    ...
    private static synchronized ORB createORB(String[] args, Properties props) {
        ...
        System.setProperty(SUN_PEORB_CONFIGURATOR_CLASS_PROPERTY + "." + peorbConfigClass, "");

        System.setProperty(SUN_ORB_SOCKET_FACTORY_CLASS_PROPERTY, "corba.orbconfigappserv.SocketFactoryImpl");

        if (System.getProperty(ORB_UTIL_CLASS_PROPERTY) == null) {
            System.setProperty(ORB_UTIL_CLASS_PROPERTY, "com.sun.corba.ee.impl.javax.rmi.CORBA.Util");
        }
        ...
        try {
            ...
            orbInitProperties.put(PI_ORB_INITIALIZER_CLASS_PREFIX + J2EE_INITIALIZER, "");
            ...
            orbInitProperties.put(OMG_ORB_SINGLETON_CLASS_PROPERTY, poaOrbSingletonClass);
    ...
    public static Tie exportObject(java.rmi.Remote remote) throws java.rmi.RemoteException {
    ...
    private static void checkDelegateProps() {
        ...
        if (utilDelegate == null || utilDelegate.equals("")) {
            ...
            System.setProperty(RMIIIOP_STUB_DELEGATE_CLASS_PROPERTY, "com.sun.corba.ee.impl.javax.rmi.CORBA.StubDelegateImpl");
            System.setProperty(RMIIIOP_PRO_DELEGATE_CLASS_PROPERTY, "com.sun.corba.ee.impl.javax.rmi.PortableRemoteObject");
        }
    }
}
