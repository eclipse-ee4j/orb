...
public class Client {
    ...
    private void setSystemProperties() {
        ...
        dprint("Setting property " + ORBConstants.USE_DYNAMIC_STUB_PROPERTY + " to true");
    ...
    private ORB makeORB(boolean isServer) {
        ...
        if (isServer) {
            ...
            props.setProperty(ORBConstants.SOCKET_FACTORY_CLASS_PROPERTY, NortelSocketFactory.class.getName());
    ...
    private void doLoop(Echo ref, boolean useNio) {
        ...
        for (int ctr = 0; ctr < NUMBER_ITERATIONS; ctr++) {
            ...
            try {
                ...
                dprint("Caught exception on loop call[" + ctr + "]: " + exc);
                exc.printStackTrace();
            }
        }
