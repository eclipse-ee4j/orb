...
public class Client extends TestCase {
    static final String[][] idInfo = { { "", "orb" }, { "A", "orb_A_1" }, { "", "orb__2" }, { "A", "orb_A_2" }, { "B", "orb_B_1" } };
     ...
     *
     * public void testMonitoringRootName() { for (int ctr=0; ctr<idInfo.length; ctr++) { String rootName =
     * orbs[ctr].getMonitoringManager().getRootMonitoredObject().getName() ; assertEquals( rootName, idInfo[ctr][1] ) ; } }
     */
    ...
    public void testBrooksPOAActivationProblem() {
        try {
            ...
            Policy[] policies = new Policy[] { rootPOA.create_servant_retention_policy(ServantRetentionPolicyValue.RETAIN),
    ...
    public void testReadResolve() {
        ...
        RRTest[] data = new RRTest[] { rr1_1, rr2_1, rr1_1, rr1_2, rr2_2, rr2_2, rr3_1, rr3_2 };
        ...
        RRTest[] expected = new RRTest[] { RRTest.rr1, RRTest.rr2, RRTest.rr1, RRTest.rr1, RRTest.rr2, RRTest.rr2, null, null };
     ...
     * cili.add( tp.ContactInfoListIteratorImpl__hasNext() ) ; cili.add( tp.ContactInfoListIteratorImpl__next() ) ;
    ...
    public void testOperationTracer() {
        ...
        System.out.println("OperationTracer test complete in " + elapsed + " milliseconds");
    }
    ...
    public void testClassMarshaling() {
        ...
        Object[] arr = { boolean.class, byte.class, Byte.class, short.class, int.class, float.class, long.class, double.class, char.class,
                this.getClass() };
    ...
    public void testTypeCode() {
        ...
        try {
            ...
            try {
                rfm = ReferenceFactoryManager.class.cast(lorb.resolve_initial_references("ReferenceFactoryManager"));
            } catch (Exception exc) {
                // do nthing
            }
            rfm.activate();

            final PresentationManager pm = com.sun.corba.ee.spi.orb.ORB.getPresentationManager();
            String repositoryId;
