...
public class counterClient implements InternalProcess {
    private counterIF createLocalObject(ORB orb) throws java.rmi.RemoteException {
        counterImpl cimpl = new counterImpl();

        return cimpl;
    }

    private counterIF createRemoteObject(ORB orb) throws java.rmi.RemoteException {
    ...
    private counterIF createRemoteObjectMarshal(ORB orb) throws java.rmi.RemoteException, java.rmi.NoSuchObjectException {
        counterImpl obj = new counterImpl();
        ...
        return (counterIF) (PortableRemoteObject.narrow(obj2, counterIF.class));
    }

    private static final int COUNT = 10000;

    private void performTest(PrintStream out, counterIF counterRef, String testType) throws RemoteException {
    ...
    public void run(Properties environment, String args[], PrintStream out, PrintStream err, Hashtable extra) throws Exception {
        ...
        try {
            ...
            /*
             * There are problems here that need further investigation counterIF counterRef3 = createRemoteObjectMarshal( orb ) ;
