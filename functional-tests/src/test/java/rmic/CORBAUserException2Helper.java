...
/**
 * rmic/CORBAUserException2Helper.java Generated by the IBM IDL-to-Java compiler (portable), version "3.0" from cue.idl
        ...
        if (__typeCode == null) {
            synchronized (org.omg.CORBA.TypeCode.class) {
                if (__typeCode == null) {
                    ...
                    __typeCode = org.omg.CORBA.ORB.init().create_struct_tc(rmic.CORBAUserException2Helper.id(), "CORBAUserException2",
                            _members0);
                    __active = false;
                }
            }
