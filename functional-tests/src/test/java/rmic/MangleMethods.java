...
public interface MangleMethods extends Remote {
    ...
    class Asserts {
        ...
        private static String[][] ASSERTS = {
                ...
                // ---------------------- ----------- ------------------- -------------------------
                { "int getFoo()", "GET", "foo", "_get_foo" }, { "int getAB()", "GET", "AB", "_get_AB" },
                { "boolean isX()", "IS", "x", "_get_x" }, { "char getChar()", "GET_RW", "_char", "_get_char" },
                { "void setChar(char)", "SET", "_char", "_set_char" }, { "byte getByte()", "NONE", null, "getByte" },
                { "boolean is()", "NONE", null, "is" }, { "void setZ(int)", "NONE", null, "setZ" },
                { "boolean isLong()", "NONE", null, "isLong" }, { "long getLong()", "GET", "_long", "_get_long" },
                { "boolean isShort()", "NONE", null, "isShort" }, { "void setShort(short)", "NONE", null, "setShort" },
                { "int getSomething()", "GET", "something", "_get_something" }, { "int getOther(char)", "NONE", null, "getOther" },
                { "void getIt()", "NONE", null, "getIt" }, { "int getY()", "GET", "y", "_get_y" }, { "void setY()", "NONE", null, "setY" },
                { "boolean isFloat()", "NONE", null, "isFloat" }, { "float getFloat()", "GET_RW", "_float", "_get_float" },
                { "void setFloat(float)", "SET", "_float", "_set_float" }, { "boolean isEmpty()", "IS", "empty", "_get_empty" },
                { "boolean IsEmpty()", "NONE", null, "IsEmpty" }, { "int doAJob()", "NONE", null, "doAJob_2_3" },
                { "int doAjob()", "NONE", null, "doAjob_2" }, { "boolean isAJob()", "IS", "AJob_0_1", "_get_AJob_0_1" },
                { "boolean getAjob()", "GET", "ajob_", "_get_ajob_" }, { "byte getfred()", "GET", "fred", "_get_fred" },
                { "void setFred(byte)", "NONE", null, "setFred" }, { "int _do\u01c3It$()", "NONE", null, "J_doU01C3ItU0024__" },
                { "int _do\u01c3It$(int)", "NONE", null, "J_doU01C3ItU0024__long" },
                { "int _do\u01c3It$(char)", "NONE", null, "J_doU01C3ItU0024__wchar" },
                { "int getFooBar()", "GET", "fooBar__", "_get_fooBar__" }, { "int fooBar()", "NONE", null, "fooBar" },
                { "int typeDef()", "NONE", null, "_typeDef" }, { "int getDefault()", "GET", "_default", "_get_default" },
                { "int getObject()", "GET", "_object", "_get_object" }, { "int getException()", "GET", "_exception", "_get_exception" }, };
    }
}
