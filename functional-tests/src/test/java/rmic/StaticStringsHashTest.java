...
public class StaticStringsHashTest extends Test {
    ...
    static final String[][] TEST_CASES = { { "a", "b", "c" }, { "one", "two", "three" }, { "a", "bb", "ccc" },
            ...
            { "imageUpdate", "_get_font", "remove", "postEvent", "_get_name", "_set_name", "_get_parent", "_get_peer", "_get_treeLock",
                    "_get_toolkit", "_get_valid", "_get_visible", "_get_showing", "_get_enabled", "_set_enabled", "enable__",
                    "enable__boolean", "disable", "_set_visible", "show__", "show__boolean", "hide", "_get_foreground", "_set_foreground",
                    "_get_background", "_set_background", "_set_font", "_get_locale", "_set_locale", "_get_colorModel", "_get_location__",
                    "_get_locationOnScreen", "location", "setLocation", "move", "_set_location__", "_get_size__", "size", "setSize",
                    "resize__long__long", "_set_size__", "resize__java_awt_Dimension", "_get_bounds__", "bounds", "setBounds", "reshape",
                    "_set_bounds__", "_get_preferredSize__", "preferredSize", "_get_minimumSize__", "minimumSize", "_get_maximumSize",
                    "_get_alignmentX", "_get_alignmentY", "doLayout", "layout", "validate", "invalidate", "_get_graphics", "getFontMetrics",
                    "_set_cursor", "_get_cursor", "paint", "update", "paintAll", "repaint__", "repaint__long_long",
                    "repaint__long__long__long__long", "repaint__long_long__long__long__long__long", "print", "printAll",
                    "createImage__java_awt_image_ImageProducer", "createImage__long__long",
                    ...
                    "checkImage__java_awt_Image__long__long__java_awt_image_ImageObserver", "contains__long__long", "inside",
                    "contains__java_awt_Point", "getComponentAt__long__long", "locate", "getComponentAt__java_awt_Point", "deliverEvent",
                    "dispatchEvent", "dispatchEventImpl", "areInputMethodsEnabled", "eventEnabled", "addComponentListener",
                    "removeComponentListener", "addFocusListener", "removeFocusListener", "addKeyListener", "removeKeyListener",
                    "addMouseListener", "removeMouseListener", "addMouseMotionListener", "removeMouseMotionListener", "_get_inputContext",
                    "enableEvents", "disableEvents", "processEvent", "processComponentEvent", "processFocusEvent", "processKeyEvent",
                    "processMouseEvent", "processMouseMotionEvent", "postsOldMouseEvents", "handleEvent", "mouseDown", "mouseDrag",
                    "mouseUp", "mouseMove", "mouseEnter", "mouseExit", "keyDown", "keyUp", "action", "addNotify", "removeNotify",
                    "gotFocus", "lostFocus", "_get_focusTraversable", "requestFocus", "transferFocus", "nextFocus", "add", "paramString",
                    "toString", "list__", "list__java_io_PrintStream", "list__java_io_PrintStream__long", "list__java_io_PrintWriter",
                    "list__java_io_PrintWriter__long", "_get_nativeContainer", },
            { "* This interface imposes a total ordering on the objects of each class that",
                    ...
                    "* value as <tt>e1.equals((Object)e2)</tt> for every <tt>e1</tt> and", "* <tt>e2</tt> of class <tt>C</tt>.<p>",
                    "* It is strongly recommended (though not required) that natural orderings be",
                    "* consistent with equals.  This is so because sorted sets (and sorted maps)",
                    "* without explicit comparators behave \"strangely\" when they are used with",
                    "* elements (or keys) whose natural ordering is inconsistent with equals.  In",
                    "* particular, such a sorted set (or sorted map) violates the general contract",
                    "* for set (or map), which is defined in terms of the <tt>equals</tt>", "* operation.<p>",
                    "* For example, if one adds two keys <tt>a</tt> and <tt>b</tt> such that",
                    "* <tt>(a.equals((Object)b) && a.compareTo((Object)b) != 0)</tt> to a sorted",
                    "* set that does not use an explicit comparator, the second <tt>add</tt>",
                    "* operation returns false (and the size of the sorted set does not increase)",
                    "* because <tt>a</tt> and <tt>b</tt> are equivalent from the sorted set's", "* perspective.<p>",
                    "* Virtually all Java core classes that implement ComparableX have natural",
                    "* orderings that are consistent with equals.  One exception is",
                    "* <tt>java.math.BigDecimal</tt>, whose natural ordering equates",
                    "* <tt>BigDecimals</tt> with equal values and different precisions (such as", "* 4.0 and 4.00).<p>",
                    "* For the mathematically inclined, the <i>relation</i> that defines",
                    "* the natural ordering on a given class C is:<pre>", "*   {(x, y) such that x.compareTo((Object)y) &lt;= 0}.",
                    "* </pre> The <i>quotient</i> for this total order is: <pre>", "*   {(x, y) such that x.compareTo((Object)y) == 0}.",
                    "* It follows immediately from the contract for <tt>compareTo</tt> that the",
                    "* quotient is an <i>equivalence relation</i> on <tt>C</tt>, and that the",
                    "* natural ordering is a <i>total order</i> on <tt>C</tt>.  When we say that a",
                    "* class's natural ordering is <i>consistent with equals</i>, we mean that the",
                    "* quotient for the natural ordering is the equivalence relation defined by",
                    "* the class's <tt>equals(Object)</tt> method:<pre>", "* {(x, y) such that x.equals((Object)y)}.", "* </pre>", }, };
