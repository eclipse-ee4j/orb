...
/**
 * Servant implementation, shared by ServerRequestDispatcher and POA versions of the servant.
 */
class DSIImpl {
    ...
    public DSIImpl(ORB orb, PrintStream out, String symbol, helloDelegate.ClientCallback clientCallback) {
        super();
        this.orb = orb;
