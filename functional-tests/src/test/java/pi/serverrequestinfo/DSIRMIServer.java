...
public abstract class DSIRMIServer extends ServerCommon implements helloDelegate.ClientCallback {
    ...
    public org.omg.CORBA.Object createAndBind(String name, String symbol) throws Exception {
        ...
        helloDSIDeprecatedServant obj = new helloDSIDeprecatedServant(orb, out, symbol, this);
        orb.connect(obj);
        initialNamingContext.rebind(name, obj);

        java.lang.Object o = initialNamingContext.lookup(name);
        return (org.omg.CORBA.Object) PortableRemoteObject.narrow(o, org.omg.CORBA.Object.class);
    }
