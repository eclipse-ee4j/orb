...
class helloDelegate implements helloIF {
    ...
    public helloDelegate(PrintStream out, String symbol, ClientCallback callback) {
        super();
        this.out = out;
        this.symbol = symbol;
    ...
    public void sayInvokeAgain(int n) {
        ...
        switch (n) {
            ...
            case INVOKE_SAY_SYSTEM_EXCEPTION.value:
                out.println("    - helloDelegate: invoking saySystemException...");
                clientCallback.saySystemException();
                break;
        }

        out.println("    - helloDelegate: sayInvokeAgain( " + n + " ) returning...");
    }
