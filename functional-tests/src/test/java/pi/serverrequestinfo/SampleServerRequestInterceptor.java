...
/**
 * Sample ServerRequestInterceptor for use in testing. This interceptor is dynamically configurable via an
 * InterceptorStrategy. It assumes three interceptors have been registered, and most operations will be performed on
 * interceptor number 2 and only if the target() is not helloRefForward.
 */
public class SampleServerRequestInterceptor extends org.omg.CORBA.LocalObject implements ServerRequestInterceptor {
