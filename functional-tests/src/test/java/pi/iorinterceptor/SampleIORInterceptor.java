 ...
 */
public class SampleIORInterceptor extends LocalObject implements IORInterceptor {
    ...
    public void establish_components(IORInfo info) {
        ...
        try {
            ...
            TaggedComponent tcAllProfiles = new TaggedComponent(FAKE_TAG_1, FAKE_DATA_1);
            ...
            TaggedComponent tcSpecificProfile = new TaggedComponent(FAKE_TAG_2, FAKE_DATA_2);
            ...
            try {
                info.add_ior_component_to_profile(tcSpecificProfile, INVALID_PROFILE_ID);
            ...
            try {
                ...
                policy = info.get_effective_policy(ID_UNIQUENESS_POLICY_ID.value);
                if (policy == null) {
                    ...
                    IdUniquenessPolicy idUniquenessPolicy = (IdUniquenessPolicy) policy;
                    if (idUniquenessPolicy.value().value() == IdUniquenessPolicyValue._MULTIPLE_ID) {
                        out.println("ok");
                    } else {
            ...
            try {
                ...
                out.println("INV_POLICY thrown. (error - should return null)");
                establishComponentsPassed = false;
            }
        } catch (Exception f) {
