 ...
 */
public class DIIPOAClient extends ClientCommon implements InternalProcess {
    ...
    public static void main(String args[]) {
        try {
            (new DIIPOAClient()).run(System.getProperties(), args, System.out, System.err, null);
        } catch (Exception e) {
     ...
     */
    private helloDIIClientStub resolve(ORB orb, String name) throws Exception {
     ...
     */
    protected void testDynamic() throws Exception {
        out.println("+ Testing DII ClientRequestInfo methods...");

        InterceptorStrategy interceptorStrategy = new DynamicStrategy();
    ...
    protected void testException() throws Exception {
        ...
        InterceptorStrategy interceptorStrategy = new ExceptionStrategy(true);
