 ...
 * <p>
 * Should be called as follows: count = 1 send_request receive_reply count = 2 send_request receive_exception count = 3
 * send_request receive_other count = 4, effective_target is now helloRefForward send_request receive_exception
 */
public class ForwardReferenceStrategy extends InterceptorStrategy {
    ...
    public void send_request(SampleClientRequestInterceptor interceptor, ClientRequestInfo ri) throws ForwardRequest {
        ...
        try {
            ...
            try {
                ...
                fail("send_request(): forward_reference() did not " + "raise BAD_INV_ORDER");
            } catch (BAD_INV_ORDER e) {
                log("send_request(): forward_reference() " + "raised BAD_INV_ORDER (ok)");
            }
    ...
    public void receive_reply(SampleClientRequestInterceptor interceptor, ClientRequestInfo ri) {
        ...
        try {
            ...
            try {
                ri.forward_reference();
                fail("receive_reply(): forward_reference() did not " + "raise BAD_INV_ORDER");
            } catch (BAD_INV_ORDER e) {
                log("receive_reply(): forward_reference() " + "raised BAD_INV_ORDER (ok)");
            }
    ...
    public void receive_exception(SampleClientRequestInterceptor interceptor, ClientRequestInfo ri) throws ForwardRequest {
        ...
        try {
            ...
            try {
                ri.forward_reference();
                fail("receive_exception(): forward_reference() did not " + "raise BAD_INV_ORDER");
            } catch (BAD_INV_ORDER e) {
                log("receive_exception(): forward_reference() " + "raised BAD_INV_ORDER (ok)");
            }
        ...
        try {
            try {
                ...
                if (TestInitializer.helloRefForward._is_equivalent(obj)) {
                    ...
                    fail("receive_other(): forward_reference() is " + "invalid.");
                }
            } catch (BAD_INV_ORDER e) {
                fail("receive_other(): forward_reference() raised " + "BAD_INV_ORDER");
            }
