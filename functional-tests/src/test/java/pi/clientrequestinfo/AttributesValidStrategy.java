...
public class AttributesValidStrategy extends InterceptorStrategy {
    ...
    public void send_request(SampleClientRequestInterceptor interceptor, ClientRequestInfo ri) throws ForwardRequest {
        try {
            ...
            log("send_request(): Actual operation name = " + this.operationName);
            ...
            try {
                ...
                fail("send_request(): Should not be able to execute " + "reply_status() here");
            } catch (BAD_INV_ORDER e) {
                log("send_request(): Tried reply_status() and received " + "BAD_INV_ORDER (ok)");
            }
    ...
    private void checkReplyStatus(String method, ClientRequestInfo ri, boolean[] validValues) {
        int i;
