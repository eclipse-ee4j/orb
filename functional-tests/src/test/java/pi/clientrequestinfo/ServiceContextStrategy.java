...
public class ServiceContextStrategy extends InterceptorStrategy {
    ...
    private void testSC(String reqOrRep, String methodName, ClientRequestInfo ri) {
    ...
    private void testAddRequestSC(String methodName, ClientRequestInfo ri) {
        ...
        if (methodName.equals("send_request")) {
            try {
                ...
                fail(header + "denied access to add_request_service_context.");
            }
        } else {
            ...
            try {
                ...
                ri.add_request_service_context(sc, true);
                fail(header + "invalid access to add_request_service_context.");
            } catch (BAD_INV_ORDER e) {
                log(header + "denied access to add_request_service_context (ok).");
            }
        }
