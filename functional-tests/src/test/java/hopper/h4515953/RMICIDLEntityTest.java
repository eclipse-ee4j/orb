...
/**
 * A very simple test to make sure that RMIC compilation works for Interfaces which has methods with IDLEntity as
 * parameters or return values.
 */
public class RMICIDLEntityTest extends CORBATest {
    public static final String[] javaFiles = { "Processor.java", "ProcessorImpl.java" };
