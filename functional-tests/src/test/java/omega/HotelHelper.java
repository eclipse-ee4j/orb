...
/**
 * genJava/omega/HotelHelper.java Generated by the IDL-to-Java compiler (portable), version "3.0" from
 * d:/java/java/idl/omega/Hotel.idl 22 April 1999 22:03:19 o'clock GMT+00:00
 */
...
public final class HotelHelper implements com.sun.org.omg.CORBA.portable.ValueHelper {
    ...
    private static String[] _truncatable_ids = { _id };
        ...
        if (__typeCode == null) {
            synchronized (org.omg.CORBA.TypeCode.class) {
                if (__typeCode == null) {
                    ...
                    _members0[0] = new org.omg.CORBA.ValueMember("tango", "", _id, "", _tcOf_members0, null,
                            org.omg.CORBA.PUBLIC_MEMBER.value);

                    // ValueMember instance for quickstep
                    _tcOf_members0 = org.omg.CORBA.ORB.init().get_primitive_tc(org.omg.CORBA.TCKind.tk_long);
                    _members0[1] = new org.omg.CORBA.ValueMember("quickstep", "", _id, "", _tcOf_members0, null,
                            org.omg.CORBA.PUBLIC_MEMBER.value);
