...
/**
 * A thread which pipes everything from an input stream to an output stream. Note that this closes the output stream and
 * dies when the reader encounters an end of stream! Thus just end the stream it's reading from to make it quit. For
 * instance, this should occur when a process ends.
 */
public class StreamReader extends Thread {
    /**
     * The NULL_OUTPUT_STREAM can be used to create a StreamReader which reads everything from the input stream and can even
    ...
    public StreamReader(OutputStream output, InputStream input) {
    ...
    public StreamReader(OutputStream output, InputStream input, String handshake) {
        this(output, input);
        this.handshake = handshake;
    }

    public StreamReader(OutputStream output, InputStream input, String handshake, String prefix) {
    ...
    public void run() {
        ...
        try {
            ...
            while (true) {
                ...
                if (handshake != null && handshakeStatus == WAITING && handshake.equals(input)) {
    ...
    public synchronized void waitForHandshake() throws InterruptedException, Exception {
