...
/**
 * DistributedSet is a remote interface which supports a distributed collection of sets, all of which coordinate with
 * each other to maintain, in each instance, a list of all the currently active sets.
 *
 * @version 1.0, 5/13/98
 * @author Bryan Atsatt
 */
