...
public class TheServer {
    ...
    // This test runs its own NameServer on test.Util.FVD_NAME_SERVER_PORT.
    ...
    public static void main(String[] args) {
        try {
            ...
            Servant iServant = (Servant) PortableRemoteObject.narrow(ic.lookup("TheFVDTestServer"), Servant.class);
