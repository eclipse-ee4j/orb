...
/**
 * Allows dynamic handling of object invocations. POA-based DSI servants inherit from the standard
 * <code>DynamicImplementation</code> class, this class inherits from the <code>Servant</code> class. Based on IDL to
 * Java spec. CORBA V 2.3.1 ptc/00-01-08.pdf.
 */
