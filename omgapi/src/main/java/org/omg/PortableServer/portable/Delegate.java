...
/**
 * The portability package contains interfaces and classes that are designed for and intended to be used by ORB
 * implementor. It exposes the publicly defined APIs that are used to connect stubs and skeletons to the ORB. The
 * Delegate interface provides the ORB vendor specific implementation of PortableServer::Servant. Conformant to spec
...
public interface Delegate {
     ...
     * object.
     * @return boolean indicating whether the specified repid is in the list or is same as that got generic CORBA object.
     */
