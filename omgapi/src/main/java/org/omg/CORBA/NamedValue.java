...
/**
 * An object used in the DII and DSI to describe arguments and return values. <code>NamedValue</code> objects are also
 * used in the <code>Context</code> object routines to pass lists of property names and values.
 * <P>
 * A <code>NamedValue</code> object contains:
 * <UL>
 * <LI>a name -- If the <code>NamedValue</code> object is used to describe arguments to a request, the name will be an
 * argument identifier specified in the OMG IDL interface definition for the operation being described.
 ...
 * <LI>zero -- if this <code>NamedValue</code> object represents a property in a <code>Context</code> object rather than
 ...
 * </PRE>
 * <P>
 * Note that the method <code>value</code> returns an <code>Any</code> object. In order to access the <code>long</code>
 * contained in the <code>Any</code> object, we used the method <code>extract_long</code>.
 *
 * @see Any
 * @see ARG_IN
 * @see ARG_INOUT
...
public abstract class NamedValue {
     ...
     *
     * @return a <code>String</code> object representing the name of this <code>NamedValue</code> object
     */
     ...
     *
     * @return an <code>int</code> representing the argument mode for this <code>NamedValue</code> object
     */
