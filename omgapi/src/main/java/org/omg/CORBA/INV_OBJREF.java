...
/**
 * This exception indicates that an object reference is internally malformed. For example, the repository ID may have
 * incorrect syntax or the addressing information may be invalid. This exception is raised by ORB::string_to_object if
 * the passed string does not decode correctly. An ORB may choose to detect calls via nil references (but is not obliged
 * to do detect them). <tt>INV_OBJREF</tt> is used to indicate this.
 * <P>
...
public final class INV_OBJREF extends SystemException {
    /**
     * Constructs an <code>INV_OBJREF</code> exception with a default minor code of 0 and a completion state of
     * COMPLETED_NO.
     */
    public INV_OBJREF() {
        this("");
    ...
    /**
     * Constructs an <code>INV_OBJREF</code> exception with the specified detail message, a minor code of 0, and a
    ...
    /**
     * Constructs an <code>INV_OBJREF</code> exception with the specified detail message, minor code, and completion status.
