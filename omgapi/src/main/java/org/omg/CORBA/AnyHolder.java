 ...
 * <P>
 * A Holder class for <code>Any</code> objects that is used to store "out" and "inout" parameters in IDL methods. If an
 * IDL method signature has an IDL <code>any</code> as an "out" or "inout" parameter, the programmer must pass an
 * instance of <code>AnyHolder</code> as the corresponding parameter in the method invocation; for "inout" parameters,
 ...
 * <P>
 * If <code>myAnyHolder</code> is an instance of <code>AnyHolder</code>, the value stored in its <code>value</code>
 * field can be accessed with <code>myAnyHolder.value</code>.
 *
