 ...
 * takes either <code>SetOverrideType.SET_OVERRIDE</code> or <code>SetOverrideType.ADD_OVERRIDE</code> as its second
 * argument. The method <code>_set_policy_override</code> creates a new <code>Object</code> initialized with the
 * <code>Policy</code> objects supplied as the first argument. If the second argument is <code>ADD_OVERRIDE</code>, the
 * new policies are added to those of the <code>Object</code> instance that is calling the
 * <code>_set_policy_override</code> method. If <code>SET_OVERRIDE</code> is given instead, the existing policies are
