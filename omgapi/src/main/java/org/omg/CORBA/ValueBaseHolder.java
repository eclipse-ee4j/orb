 ...
 * <P>
 * A Holder class for a <code>java.io.Serializable</code> that is used to store "out" and "inout" parameters in IDL
 * methods. If an IDL method signature has an IDL <code>ValueBase</code> as an "out" or "inout" parameter, the
 * programmer must pass an instance of <code>ValueBaseHolder</code> as the corresponding parameter in the method
 ...
 * <P>
 * If <code>myValueBaseHolder</code> is an instance of <code>ValueBaseHolder</code>, the value stored in its
 * <code>value</code> field can be accessed with <code>myValueBaseHolder.value</code>.
 *
 */
public final class ValueBaseHolder implements Streamable {

    /**
     * The <code>java.io.Serializable</code> value held by this <code>ValueBaseHolder</code> object.
     */
