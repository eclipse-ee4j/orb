...
/**
 * The <code>DynUnion</code> interface represents a <code>DynAny</code> object that is associated with an IDL union.
 * Union values can be traversed using the operations defined in <code>DynAny</code>. The first component in the union
 * corresponds to the discriminator; the second corresponds to the actual value of the union. Calling the method
 * <code>next()</code> twice allows you to access both components.
 *
...
public interface DynUnion extends org.omg.CORBA.Object, org.omg.CORBA.DynAny {
     ...
     *
     * @return <code>true</code> if the discriminator has a default value; <code>false</code> otherwise
     */
    ...
    /**
     * Returns a DynAny object reference that must be narrowed to the type of the discriminator in order to insert/get the
     * discriminator value.
     *
