...
/**
 * This interface provides a dispatching mechanism for an incoming call. It is invoked by the ORB to dispatch a request
 * to a servant.
 */
...
public interface InvokeHandler {
     ...
     *
     * ORB passes the method name, an InputStream containing the marshalled arguments, and a ResponseHandler which the
     * servant uses to construct a proper reply.
     *
     * Only CORBA SystemException may be thrown by this method.
     *
     * The method must return an OutputStream created by the ResponseHandler which contains the marshalled reply.
     *
     * A servant must not retain a reference to the ResponseHandler beyond the lifetime of a method invocation.
     *
     ...
     * @return The <code>OutputStream</code> created by the ResponseHandler which contains the marshalled reply
