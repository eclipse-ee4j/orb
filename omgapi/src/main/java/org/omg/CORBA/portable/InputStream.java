...
/**
 * InputStream is the Java API for reading IDL types from CDR marshal streams. These methods are used by the ORB to
 * unmarshal IDL types as well as to extract IDL types out of Anys. The <code>_array</code> versions of the methods can
 * be directly used to read sequences and arrays of IDL types.
 *
...
public abstract class InputStream extends java.io.InputStream {
    ...
    /**
     * Unmarshals an object and returns a CORBA Object, which is an instance of the class passed as its argument. This class
     * is the stub class of the expected type.
     *
     * @param clz The Class object for the stub class which corresponds to the type that is statistically expected, or the
     * Class object for the RMI/IDL interface type that is statistically expected.
