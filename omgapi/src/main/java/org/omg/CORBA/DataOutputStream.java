...
/**
 * Defines the methods used to write primitive data types to output streams for marshalling custom value types. This
 * interface is used by user written custom marshalling code for custom value types.
 *
...
public interface DataOutputStream extends org.omg.CORBA.portable.ValueBase {
    ...
    /**
     * Writes the array of IDL unsigned shorts (represented as Java shorts) from offset for length elements to the output
     * stream.
     *
     * @param seq The array to be written.
     * @param offset The index into seq of the first element to write to the output stream.
    ...
    /**
     * Writes the array of IDL unsigned longs (represented as Java ints) from offset for length elements to the output
     * stream.
     *
     * @param seq The array to be written.
     * @param offset The index into seq of the first element to write to the output stream.
    ...
    /**
     * Writes the array of IDL unsigned long longs (represented as Java longs) from offset for length elements to the output
     * stream.
     *
     * @param seq The array to be written.
     * @param offset The index into seq of the first element to write to the output stream.
