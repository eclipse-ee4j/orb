...
/**
 * Exception thrown when an operation is invoked by a client but the passed context does not contain the context values
...
public final class BAD_CONTEXT extends SystemException {
    ...
    /**
     * Constructs a <code>BAD_CONTEXT</code> exception with a default minor code of 0 and a completion state of
     * COMPLETED_NO.
     */
    public BAD_CONTEXT() {
        this("");
    ...
    /**
     * Constructs a <code>BAD_CONTEXT</code> exception with the specified detail message, a minor code of 0 and a completion
    ...
    /**
     * Constructs a <code>BAD_CONTEXT</code> exception with the specified detail message, minor code, and completion status.
