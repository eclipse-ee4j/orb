...
/**
 * Exception thrown when the request carried an invalid transaction context. For example, this exception could be raised
 * if an error occurred when trying to register a resource.
 * <P>
...
public final class INVALID_TRANSACTION extends SystemException {
    /**
     * Constructs an <code>INVALID_TRANSACTION</code> exception with a default minor code of 0 and a completion state of
     * COMPLETED_NO.
     */
