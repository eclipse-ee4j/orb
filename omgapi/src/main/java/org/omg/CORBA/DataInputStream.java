...
public interface DataInputStream extends org.omg.CORBA.portable.ValueBase {
     ...
     * @throws <code>org.omg.CORBA.MARSHAL</code> If an inconsistency is detected, including not having registered a
     * streaming policy, then the standard system exception MARSHAL is raised.
     */
