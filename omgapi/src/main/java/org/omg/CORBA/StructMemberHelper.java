...
/**
 * The Helper for <tt>StructMember</tt>. For more information on Helper files, see
 * <a href="doc-files/generatedfiles.html#helper"> "Generated Files: Helper Files"</a>.
 * <P>
 * org/omg/CORBA/StructMemberHelper.java Generated by the IDL-to-Java compiler (portable), version "3.0" from ir.idl 03
 * June 1999 11:33:43 o'clock GMT+00:00
 */
        ...
        if (__typeCode == null) {
            synchronized (org.omg.CORBA.TypeCode.class) {
                if (__typeCode == null) {
                    ...
                    __typeCode = org.omg.CORBA.ORB.init().create_struct_tc(org.omg.CORBA.StructMemberHelper.id(), "StructMember",
                            _members0);
                    __active = false;
                }
            }
