...
/**
 * This exception indicates that the caller has invoked operations in the wrong order. For example, it can be raised by
 * an ORB if an application makes an ORB-related call without having correctly initialized the ORB first.
 * <P>
...
public final class BAD_INV_ORDER extends SystemException {
    ...
    /**
     * Constructs a <code>BAD_INV_ORDER</code> exception with a default minor code of 0 and a completion state of
     * COMPLETED_NO.
     */
    ...
    /**
     * Constructs a <code>BAD_INV_ORDER</code> exception with the specified detail message, a minor code of 0, and a
