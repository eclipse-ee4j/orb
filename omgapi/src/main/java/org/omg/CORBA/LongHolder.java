 ...
 * <P>
 * A Holder class for a <code>long</code> that is used to store "out" and "inout" parameters in IDL methods. If an IDL
 * method signature has an IDL <code>long long</code> as an "out" or "inout" parameter, the programmer must pass an
 * instance of <code>LongHolder</code> as the corresponding parameter in the method invocation; for "inout" parameters,
 ...
 * <P>
 * If <code>myLongHolder</code> is an instance of <code>LongHolder</code>, the value stored in its <code>value</code>
 * field can be accessed with <code>myLongHolder.value</code>.
 *
