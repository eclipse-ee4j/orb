...
/**
 * The Stub for <tt>Policy</tt>. For more information on Stub files, see <a href="doc-files/generatedfiles.html#stub">
 * "Generated Files: Stubs"</a>.
 * <P>
 * org/omg/CORBA/_PolicyStub.java Generated by the IDL-to-Java compiler (portable), version "3.0" from
...
public class _PolicyStub extends org.omg.CORBA.portable.ObjectImpl implements org.omg.CORBA.Policy {
    ...
    /**
     * Returns the constant value that corresponds to the type of the policy object. The values of the polivy objectys are
