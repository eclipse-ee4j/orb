...
/**
 * Exception thrown when the ORB has encountered a malformed type code (for example, a type code with an invalid
 * <tt>TCKind</tt> value).
 * <P>
...
public final class BAD_TYPECODE extends SystemException {
    ...
    /**
     * Constructs a <code>BAD_TYPECODE</code> exception with a default minor code of 0 and a completion state of
     * COMPLETED_NO.
     */
    public BAD_TYPECODE() {
        this("");
    ...
    /**
     * Constructs a <code>BAD_TYPECODE</code> exception with the specified detail, a minor code of 0, and a completion state
     * of COMPLETED_NO.
     *
    ...
    /**
     * Constructs a <code>BAD_TYPECODE</code> exception with the specified detail message, minor code, and completion
