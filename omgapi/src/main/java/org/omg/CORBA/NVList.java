 ...
 * <UL>
 * <LI>to describe arguments for a <code>Request</code> object in the Dynamic Invocation Interface and the Dynamic
 * Skeleton Interface
 ...
 * by supplying 3 to the method <code>create_list</code>. Note that the new <code>NVList</code> will not necessarily
 * have a length of 3; it could have a length of 2 or 4, for instance. Note also that you can add any number of
 ...
 * </OL>
 * <P>
 * The methods in the class <code>NVList</code> all deal with the <code>NamedValue</code> objects in the list. There are
 * three methods for adding a <code>NamedValue</code> object, a method for getting the count of <code>NamedValue</code>
...
public abstract class NVList {
     ...
     *
     * @return an <code>int</code> indicating the number of <code>NamedValue</code> objects in this <code>NVList</code>.
     */

    public abstract int count();

    /**
     * Creates a new <code>NamedValue</code> object initialized with the given flag and adds it to the end of this
     * <code>NVList</code> object. The flag can be any one of the argument passing modes: <code>ARG_IN.value</code>,
    ...
    /**
     * Creates a new <code>NamedValue</code> object initialized with the given name and flag, and adds it to the end of this
     * <code>NVList</code> object. The flag can be any one of the argument passing modes: <code>ARG_IN.value</code>,
     * <code>ARG_OUT.value</code>, or <code>ARG_INOUT.value</code>.
     *
    ...
    /**
     * Creates a new <code>NamedValue</code> object initialized with the given name, value, and flag, and adds it to the end
     * of this <code>NVList</code> object.
     *
     * @param item_name the name for the new <code>NamedValue</code> object
     * @param val an <code>Any</code> object containing the value for the new <code>NamedValue</code> object
     * @param flags one of the following argument passing modes: <code>ARG_IN.value</code>, <code>ARG_OUT.value</code>, or
     ...
     *
     * @param index the index of the desired <code>NamedValue</code> object, which must be between zero and the length of
     * the list minus one, inclusive. The first item is at index zero.
     * @return the <code>NamedValue</code> object at the given index
     * @exception org.omg.CORBA.Bounds if the index is greater than or equal to number of <code>NamedValue</code> objects
     */

    public abstract NamedValue item(int index) throws org.omg.CORBA.Bounds;

    /**
     * Removes the <code>NamedValue</code> object at the given index. Note that the indices of all <code>NamedValue</code>
     * objects following the one removed are shifted down by one.
     *
     * @param index the index of the <code>NamedValue</code> object to be removed, which must be between zero and the length
     * of the list minus one, inclusive. The first item is at index zero.
     * @exception org.omg.CORBA.Bounds if the index is greater than or equal to number of <code>NamedValue</code> objects in
     * the list
     */
