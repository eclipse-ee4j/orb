...
/**
 * A constant that signifies an "output" argument to an invocation, meaning that the argument is being passed from the
 * server to the client. <code>ARG_OUT.value</code> is one of the possible values used to indicate the direction in
