...
/**
 * This exception indicates that an IDL identifier is syntactically invalid. It may be raised if, for example, an
 * identifier passed to the interface repository does not conform to IDL identifier syntax, or if an illegal operation
...
public final class INV_IDENT extends SystemException {
    ...
    /**
     * Constructs an <code>INV_IDENT</code> exception with the specified detail message, a minor code of 0, and a completion
    ...
    /**
     * Constructs an <code>INV_IDENT</code> exception with the specified detail message, minor code, and completion status.
