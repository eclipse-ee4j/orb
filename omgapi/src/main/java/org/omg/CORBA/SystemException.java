...
/**
 * The root class for all CORBA standard exceptions. These exceptions may be thrown as a result of any CORBA operation
 * invocation and may also be returned by many standard CORBA API methods. The standard exceptions contain a minor code,
 * allowing more detailed specification, and a completion status. This class is subclassed to generate each one of the
 * set of standard ORB exceptions. <code>SystemException</code> extends <code>java.lang.RuntimeException</code>; thus
 * none of the <code>SystemException</code> exceptions need to be declared in signatures of the Java methods mapped from
 * operations in IDL interfaces.
 *
...
public abstract class SystemException extends java.lang.RuntimeException {
    ...
    /**
     * Constructs a <code>SystemException</code> exception with the specified detail message, minor code, and completion
