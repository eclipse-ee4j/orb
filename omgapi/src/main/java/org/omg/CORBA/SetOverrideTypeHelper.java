...
/**
 * The Helper for <tt>SetOverrideType</tt>. For more information on Helper files, see
 * <a href="doc-files/generatedfiles.html#helper"> "Generated Files: Helper Files"</a>.
 * <P>
 * org/omg/CORBA/SetOverrideTypeHelper.java Generated by the IDL-to-Java compiler (portable), version "3.0" 03 June 1999
...
abstract public class SetOverrideTypeHelper {
    ...
    synchronized public static org.omg.CORBA.TypeCode type() {
        if (__typeCode == null) {
            __typeCode = org.omg.CORBA.ORB.init().create_enum_tc(org.omg.CORBA.SetOverrideTypeHelper.id(), "SetOverrideType",
