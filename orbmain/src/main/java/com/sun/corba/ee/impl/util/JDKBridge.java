...
public class JDKBridge {
    ...
    private static class LoadClassCache {
        ...
        /**
         * Returns Class if it is still known to be the resolution of the parameters, throws ClassNotFoundException if it is
         * still known that the class can NOT be resolved, or return null if nothing is known.
         */
