...
public final class OSFCodeSetRegistry {
    ...
    /**
     * An entry in the OSF registry which allows users to find out the equivalent Java character encoding name as well as
     * some other facts from the registry.
     */
    public final static class Entry {
        ...
        public boolean equals(Object obj) {
            ...
            return (javaName.equals(other.javaName) && encodingNum == other.encodingNum && isFixedWidth == other.isFixedWidth
    ...
    /**
     * UTF-16 as specified in the OSF registry has an optional byte order marker. UTF-16BE and UTF-16LE are not in the OSF
     * registry since it is no longer being developed. When the OMG switches to the IANA registry, these can be public.
     * Right now, they're used internally by CodeSetConversion.
     */
    ...
    /**
     * Fallback char code set. Also the code set for char data in encapsulations. However, since CORBA says chars are only
     * one octet, it is really the same as Latin-1.
     */
    public static final Entry UTF_8 = new Entry("UTF-8", UTF_8_VALUE, false, 6);

    /*
     * At least in JDK 1.3, UCS-2 isn't one of the mandatory Java character encodings. However, our old ORBs require what
     * they call UCS2, even though they didn't necessarily do the correct encoding of it.
     *
    ...
    /**
     * This is the encoding older JavaSoft ORBs advertised as their CORBA char code set. Actually, they took the lower byte
     * of the Java char. This is a 7-bit encoding, so they were really sending ISO8859-1.
     */
