...
public class ClientRequestDispatcherImpl implements ClientRequestDispatcher {
    ...
    @Subcontract
    public CDRInputObject marshalingComplete1(ORB orb, MessageMediator messageMediator)
            throws ApplicationException, org.omg.CORBA.portable.RemarshalException {
        operationAndId(messageMediator.getOperationName(), messageMediator.getRequestId());
        ...
        try {
            ...
            if (messageMediator.isSystemExceptionReply()) {
                ...
                if (messageMediator.isDIIRequest()) {
                    ...
                    ApplicationException appException = new ApplicationException(exceptionRepoId, inputObject);
                ...
                getContactInfoListIterator(orb).reportAddrDispositionRetry(messageMediator.getContactInfo(),
    ...
    @Subcontract
    protected void continueOrThrowSystemOrRemarshal(MessageMediator messageMediator, Exception exception)
    ...
    protected void performCodeSetNegotiation(MessageMediator messageMediator) {
        ...
        synchronized (conn) {
            ...
            CodeSetComponentInfo.CodeSetContext result = CodeSetConversion.impl()
                    .negotiate(conn.getBroker().getORBData().getCodeSetComponentInfo(), serverCodeSets);
