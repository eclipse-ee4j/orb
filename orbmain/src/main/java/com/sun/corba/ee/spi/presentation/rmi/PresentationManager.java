...
public interface PresentationManager {
    ...
    public interface StubFactoryFactory {
        /**
         * Return the standard name of a stub (according to the RMI-IIOP specification and rmic). This is needed so that the
         * name of a stub is known for standalone clients of the app server.
         *
         ...
         */
        PresentationManager.StubFactory createStubFactory(String className, boolean isIDLStub, String remoteCodeBase, Class<?> expectedClass,
        ...
        /**
         * Return whether or not this StubFactoryFactory creates StubFactory instances that create dynamic stubs and ties. At
         * the top level, true indicates that rmic -iiop is not needed for generating stubs or ties.
         *
    ...
    public interface ClassData {
        ...
        /**
         * Get the InvocationHandlerFactory that is used to create an InvocationHandler for dynamic stubs of the type of the
         * ClassData.
         *
        ...
        /**
         * Get the dictionary for this ClassData instance. This is used to hold class-specific information for a Class in the
         * class data. This avoids the need to create other caches for accessing the information.
         *
