...
/**
 * Class TransientNameService implements a transient name service using TransientNamingContexts and
 * TransientBindingIterators, which implement the org.omg.CosNaming::NamingContext and
...
public class TransientNameService {
     ...
     */
    public TransientNameService(com.sun.corba.ee.spi.orb.ORB orb) throws org.omg.CORBA.INITIALIZE {
     ...
     * @exception org.omg.CORBA.INITIALIZE Thrown if the TransientNameService cannot initialize.
     */
    public TransientNameService(com.sun.corba.ee.spi.orb.ORB orb, String serviceName) throws org.omg.CORBA.INITIALIZE {
    ...
    /**
     * This method initializes Transient Name Service by associating Root context with POA and registering the root context
     * with INS Object Keymap.
     */
    @Naming
    private void initialize(com.sun.corba.ee.spi.orb.ORB orb, String nameServiceName) throws org.omg.CORBA.INITIALIZE {
        try {
