...
/**
 * Class InteroperableNamingImpl implements the methods defined for NamingContextExt which is part of Interoperable
 * Naming Service specifications. This class is added for doing more of Parsing and Building of Stringified names
 * according to INS Spec.
 */
public class InterOperableNamingImpl {
    /**
     * Method which stringifies the Name Components given as the input parameter.
     *
     * @param theNameComponents Array of Name Components (Simple or Compound Names)
    ...
    private String addEscape(String value) {
        if ((value != null) && (contains(value, '.') || contains(value, '/'))) {
     ...
     */
    public org.omg.CosNaming.NameComponent[] convertToNameComponent(String theStringifiedName) throws org.omg.CosNaming.NamingContextPackage.InvalidName {
        ...
        for (int i = 0; i < components.length; i++) {
            theNameComponents[i] = createNameComponentFromString(components[i]);
        }
    ...
    /**
     * Step1 in converting Stringified name into array of Name Component is breaking the String into multiple name
     * components
     */
    private String[] breakStringToNameComponents(final String sname) {
        ...
        for (int index = 0; index <= sname.length();) {
            theIndices[theIndicesIndex] = sname.indexOf('/', index);
        ...
        return StringComponentsFromIndices(theIndices, theIndicesIndex, sname);
    }
    ...
    /**
     * Step 2: After Breaking the Stringified name into set of NameComponent Strings, The next step is to create
     * Namecomponents from the substring by removing the escapes if there are any.
     */
    private NameComponent createNameComponentFromString(String theStringifiedNameComponent) throws org.omg.CosNaming.NamingContextPackage.InvalidName
