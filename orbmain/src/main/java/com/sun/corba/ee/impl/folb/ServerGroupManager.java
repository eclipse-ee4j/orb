...
public class ServerGroupManager extends org.omg.CORBA.LocalObject
    ...
    private void initialize() {
        ...
        try {
            ...
            gis = (GroupInfoService) PortableRemoteObject
    ...
    public void establish_components(IORInfo iorInfo) {
        try {
            ...
            String[] adapterName = ((com.sun.corba.ee.impl.interceptors.IORInfoImpl) iorInfo).getObjectAdapter().getAdapterTemplate()
                    .adapter_name();
            ...
            for (ClusterInstanceInfo clusterInstanceInfo : info) {
                ...
                final ClusterInstanceInfo ninfo = new ClusterInstanceInfo(clusterInstanceInfo.name(), clusterInstanceInfo.weight(),
                        listOfSocketInfo);
            ...
            if (gis.shouldAddMembershipLabel(adapterName)) {
                TaggedComponent tc = new TaggedComponent(ORBConstants.FOLB_MEMBERSHIP_LABEL_TAGGED_COMPONENT_ID,
