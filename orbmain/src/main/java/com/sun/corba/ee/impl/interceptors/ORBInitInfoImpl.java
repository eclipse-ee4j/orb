...
/**
 * ORBInitInfoImpl is the implementation of the ORBInitInfo class to be passed to ORBInitializers, as described in
 * orbos/99-12-02.
 */
public final class ORBInitInfoImpl extends org.omg.CORBA.LocalObject implements ORBInitInfo, ORBInitInfoExt {
    ...
    /**
     * Throws an exception if the current stage is STAGE_CLOSED. This is called before any method is invoked to ensure that
     * no method invocations are attempted after all calls to post_init() are completed.
     */
     ...
     * ORB::resolve_initial_references( "CodecFactory" ) but since the ORB is not yet available and Interceptors,
    ...
    /**
     * See orbos/99-12-02, Chapter 11, Dynamic Initial References on page 11-81. This operation is identical to
     * ORB::register_initial_reference described there. This same functionality exists here because the ORB, not yet fully
     * initialized, is not yet available but initial references may need to be registered as part of Interceptor
     * registration.
     * <p>
    ...
    /**
     * This operation is only valid during post_init. It is identical to ORB::resolve_initial_references. This same
     * functionality exists here because the ORB, not yet fully initialized, is not yet available, but initial references
     * may be required from the ORB as part of Interceptor registration.
     * <p>
    ...
    // New method from CORBA 3.1
    public void add_server_request_interceptor_with_policy(ServerRequestInterceptor interceptor, Policy[] policies)
