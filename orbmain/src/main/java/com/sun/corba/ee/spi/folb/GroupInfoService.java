...
public interface GroupInfoService {
    /**
     * Adds an observer that will receive a <code>membershipChange</code> invocation whenever the cluster membership
     * changes.
     *
     * The <code>membershipChange</code> invocation tells the observer to call <code>getClusterInstanceInfo</code> to get
     * info.
     *
    ...
    /**
     * Causes the <code>membershipChange</code> method to be called on each registered observer.
     */
    public void notifyObservers();

    /**
     * This is a separate call (rather than info being passed in <code>membershipChange</code>) so we can identifier the
     * adapter.
     *
