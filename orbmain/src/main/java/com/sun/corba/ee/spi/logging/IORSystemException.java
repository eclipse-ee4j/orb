...
public interface IORSystemException {
    IORSystemException self = WrapperGenerator.makeWrapper(IORSystemException.class, CorbaExtension.self);
    ...
    INTERNAL getLocalServantFailure(@Chain Exception exc, ObjectAdapterId oaid);
    ...
    @Message("MARSHAL error while attempting to create an ObjectKeyTemplate " + "from an input stream")
