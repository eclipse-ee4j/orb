...
public class RetryClientRequestInterceptor extends org.omg.CORBA.LocalObject implements ORBInitializer, ClientRequestInterceptor {
    ...
    private static final long TRANSIENT_RETRY_TIMEOUT_DEFAULT = 1000 * 60 * 5; // 5 minutes
    ...
    private boolean isBadServerIdException(ClientRequestInfo ri) {
        ...
        return se instanceof org.omg.CORBA.OBJECT_NOT_EXIST && se.minor == ORBUtilSystemException.BAD_SERVER_ID;
    }
}
