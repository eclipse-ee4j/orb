...
public class VirtualAddressAgentImpl extends LocalObject implements ORBConfigurator, ORBInitializer, IORInterceptor_3_0 {
    ...
    public static final String VAA_HOST_PROPERTY = ORBConstants.SUN_PREFIX + "ORBVAAHost";
    public static final String VAA_PORT_PROPERTY = ORBConstants.SUN_PREFIX + "ORBVAAPort";
    ...
    private class AddressParser extends ParserImplBase {
        ...
        public PropertyParser makeParser() {
            ...
            parser.add(VAA_PORT_PROPERTY, OperationFactory.integerAction(), "_port");
            return parser;
        }
    ...
    private class SpecialIIOPProfileImpl extends IIOPProfileImpl {
        ...
        public boolean isLocal() {
            if (!isLocalChecked) {
                ...
                IIOPProfileTemplate ptemp = (IIOPProfileTemplate) getTaggedProfileTemplate();
    ...
    private class SpecialIIOPProfileTemplateImpl extends IIOPProfileTemplateImpl {
    ...
    public void components_established(IORInfo info) {
        ...
        final IORTemplate iort = (IORTemplate) IORFactories.getIORFactory(myInfo.adapter_template());
        ...
        final ObjectReferenceTemplate newOrt = IORFactories.makeObjectReferenceTemplate(orb, result);
