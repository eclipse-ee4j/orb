...
public interface NamingSystemException {
    NamingSystemException self = WrapperGenerator.makeWrapper(NamingSystemException.class, CorbaExtension.self);
    ...
    String namingCtxRebindAlreadyBound = "Unexpected AlreadyBound exception in rebind";
