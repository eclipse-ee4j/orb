...
public interface ORBUtilSystemException {
    ORBUtilSystemException self = WrapperGenerator.makeWrapper(ORBUtilSystemException.class, CorbaExtension.self);
    ...
    int METHOD_NOT_FOUND_IN_TIE = CorbaExtension.self.getMinorCode(ORBUtilSystemException.class, "methodNotFoundInTie");
    ...
    BAD_OPERATION couldNotInstantiateStubClass(@Chain Exception exc, String arg0);
    ...
    BAD_OPERATION exceptionInConvertActionConstructor(@Chain Exception exc, String arg0);
    ...
    BAD_OPERATION bundleCouldNotLoadClass(@Chain Exception exc, String arg0, String arg1);
    ...
    int LOCAL_OBJECT_NOT_ALLOWED = CorbaExtension.self.getMinorCode(ORBUtilSystemException.class, "localObjectNotAllowed");
    ...
    BAD_PARAM couldNotCreateArray(@Chain Throwable exc, String arg0, Class<?> arg1, int arg2);
    ...
    BAD_PARAM couldNotSetArray(@Chain Throwable thr, String arg0, int arg1, Class<?> arg2, int arg3, Object arg4);
    ...
    BAD_PARAM invalidRequestPartitioningPolicyValue(int arg0, int arg1, int arg2);

    @Log(level = LogLevel.WARNING, id = 25)
    @Message("Could not set request partitioning component value to {0}, " + "valid values are {1} - {2}")
    BAD_PARAM invalidRequestPartitioningComponentValue(int arg0, int arg1, int arg2);
    ...
    String badTimeoutStringData = "{0} is not a valid positive decimal " + "integer for {1}";
    ...
    int CONNECTION_REBIND = CorbaExtension.self.getMinorCode(ORBUtilSystemException.class, "connectionRebind");
    ...
    COMM_FAILURE ioexceptionWhenReadingConnection(@Chain Exception exc, Connection arg0);
    ...
    COMM_FAILURE transportReadTimeoutExceeded(int arg0, int arg1, int arg2, int arg3);
    ...
    @Message("TemporarySelector's Selector, {0} .select(timeout) must called " + "with timeout value greater than 0, "
    ...
    @Message("Unexpected exception when reading with a temporary selector: " + "bytes read = {0}, bytes requested = {1}, "
            + "time spent waiting = {2} ms, max time to wait = {3}.")
    COMM_FAILURE exceptionWhenReadingWithTemporarySelector(@Chain Exception exc, int arg0, int arg1, int arg2, int arg3);

    @Log(level = LogLevel.SEVERE, id = 27)
    @Message("Unexpected exception when writing with a temporary selector:  "
            + "bytes written = {0}, total bytes requested to write = {1}, " + "time spent waiting = {2} ms, max time to wait = {3}.")
    COMM_FAILURE exceptionWhenWritingWithTemporarySelector(@Chain Exception exc, int arg0, int arg1, int arg2, int arg3);
    ...
    COMM_FAILURE exceptionBlockingReadWithTemporarySelector(@Chain Exception exc, Connection arg0);
    ...
    @Log(level = LogLevel.WARNING, id = 33)
    @Message("Ignoring request to read a message which exceeds read size " + "threshold of {0} bytes, requested size was {1}. "
            + "Use ORB property -D{2}=<# of bytes> to set threshold higher.")
    COMM_FAILURE maximumReadByteBufferSizeExceeded(int arg0, int arg1, String arg2);

    @Log(level = LogLevel.FINE, id = 34)
    @Message("Received {0}, in a blocking read on connection, {1}, " + "because an 'end of stream' was detected")
    COMM_FAILURE blockingReadEndOfStream(@Chain Exception exc, String arg0, String arg1);
    ...
    String boundsCannotOccur = "Bounds exception cannot occur in this context";
    ...
    INTERNAL invalidCodeSetString(@Chain NoSuchElementException exc, String arg0);
    ...
    INTERNAL invocationErrorInReflectiveTie(@Chain Exception exc, String arg0, String arg1);
    ...
    @Message("Ignoring unexpected InterruptedException while waiting for " + "next fragment in "
    ...
    INTERNAL changedTypeIdOnSetEffectiveTargetIOR(String oldTypeId, String newTypeId);
    ...
    @CS(CSValue.MAYBE)
    MARSHAL malformedUrl(@Chain MalformedURLException exc, String arg0, String arg1);
    ...
    String unknownCodeSet = "Unknown code set {0} specified by client ORB as a " + "negotiated code set";
    ...
    MARSHAL couldNotInstantiateHelper(@Chain InstantiationException exc, Class<?> arg0);
    ...
    MARSHAL couldNotInvokeHelperReadMethod(@Chain Exception exc, Class<?> arg0);
    ...
    MARSHAL enumClassNotFound(@Chain ClassNotFoundException ex, String arg0);

    String proxyClassNotFound = "Could not find Proxy class for " + "interfaces {0} while reading a proxy";

    @Log(level = LogLevel.WARNING, id = 63)
    @Message(proxyClassNotFound)
    MARSHAL proxyClassNotFound(@Chain ClassNotFoundException exc, List<String> interfaceNames);

    @Log(level = LogLevel.WARNING, id = 63)
    @Message(proxyClassNotFound)
    MARSHAL proxyClassNotFound(@Chain ClassNotFoundException exc, String interfaceNames);

    @Log(level = LogLevel.WARNING, id = 64)
    @Message("Unable to load proxy class for interfaces {0} because " + "codebase URL {1} is malformed")
    MARSHAL malformedProxyUrl(@Chain MalformedURLException exc, List<String> interfaceNames, String url);
    ...
    int BAD_SERVER_ID = CorbaExtension.self.getMinorCode(ORBUtilSystemException.class, "badServerId");
    ...
    UNKNOWN classNotFoundInJDKClassLoader(String className, @Chain ClassNotFoundException e);
}
