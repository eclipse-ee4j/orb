...
public class Util implements javax.rmi.CORBA.UtilDelegate {
     ...
     *
     * This only works in RMI-IIOP with Util.writeAny since we actually know what ORB and stream we're writing with when we
     * insert the value.
     *
    ...
    private TypeCode createTypeCode(Serializable obj, org.omg.CORBA.Any any, org.omg.CORBA.ORB orb) {
        ...
        if (any instanceof com.sun.corba.ee.impl.corba.AnyImpl && orb instanceof ORB) {

            com.sun.corba.ee.impl.corba.AnyImpl anyImpl = (com.sun.corba.ee.impl.corba.AnyImpl) any;
    ...
    public Object readAny(InputStream in) {
        ...
        // specific details such as indirections, etc.
        if (ORBUtility.getEncodingVersion() != ORBConstants.CDR_ENC_VERSION) {
            return ((org.omg.CORBA_2_3.portable.InputStream) in).read_abstract_interface();
        }
     ...
     *
     * @throws RemoteException The Java to IDL specification does to specify the conditions that cause a RemoteException to
     * be thrown.
     */
    @Override
    public boolean isLocal(javax.rmi.CORBA.Stub stub) throws RemoteException {
        ...
        try {
            ...
            if (delegate instanceof ClientDelegate) {
                ...
                LocalClientRequestDispatcher lcs = cil.getLocalClientRequestDispatcher();
    ...
    public Object copyObject(Object obj, org.omg.CORBA.ORB orb) throws RemoteException {
        try {
            ...
            if (orb instanceof ORB) {
                ...
                org.omg.CORBA_2_3.portable.InputStream in = (org.omg.CORBA_2_3.portable.InputStream) out.create_input_stream();
    ...
    /**
     * Tries to find the correct remote exception to instantiate depending on whether javax.transaction or
     * jakarta.transaction is on the classpath
     * 
    ...
    private RemoteException createTransactionException(String className, String message) {
        ...
        try {
            clazz = Class.forName("jakarta.transaction." + className, true, Thread.currentThread().getContextClassLoader());
        } catch (ClassNotFoundException ex1) {
            try {
                clazz = Class.forName("javax.transaction." + className, true, Thread.currentThread().getContextClassLoader());
