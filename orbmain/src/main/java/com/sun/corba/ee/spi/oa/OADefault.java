...
/**
 * OADefault provides methods to create the standard ObjectAdapterFactory instances for this version of the ORB. These
 * methods are generally used in ORBConfigurator instances to construct an ORB instance.
 */
