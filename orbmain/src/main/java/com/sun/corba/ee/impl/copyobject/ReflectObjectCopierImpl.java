...
/**
 * Class used to deep copy arbitrary data. A single ReflectObjectCopierImpl instance will preserve all object aliasing
 * across multiple calls to copy.
 */
public class ReflectObjectCopierImpl implements ObjectCopier {
    ...
    // performance.
    private static final PipelineClassCopierFactory ccf = DefaultClassCopierFactories.getPipelineClassCopierFactory();
    ...
    /**
     * Return a deep copy of obj. Aliasing is preserved within obj and between objects passed in multiple calls to the same
     * instance of ReflectObjectCopierImpl.
     */
    @Override
