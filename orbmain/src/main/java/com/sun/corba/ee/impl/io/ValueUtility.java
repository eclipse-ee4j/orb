...
public class ValueUtility {
    ...
    public static boolean isAssignableFrom(String clzRepositoryId, FullValueDescription type, com.sun.org.omg.SendingContext.CodeBase sender) {
    ...
    private static TypeCode createTypeCodeForClassInternal(ORB orb, java.lang.Class c, ValueHandler vh, IdentityKeyValueStack createdIDs) {
    ...
    private static TypeCode createTypeCodeInternal(ORB orb, java.lang.Class c, ValueHandler vh, String id, IdentityKeyValueStack createdIDs) {
        ...
        if (superClass != null && ClassInfoCache.get(superClass).isASerializable(superClass)) {
