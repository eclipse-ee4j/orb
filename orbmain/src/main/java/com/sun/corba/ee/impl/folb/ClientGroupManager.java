...
public class ClientGroupManager extends org.omg.CORBA.LocalObject
    ...
    public List getSocketInfo(IOR ior, List previous) {
        ...
        try {
            ...
            final Iterator<ClusterInstanceInfoComponent> iterator = iiopProfileTemplate
            ...
            final Iterator<AlternateIIOPAddressComponent> aiterator = iiopProfileTemplate
                    .iteratorById(org.omg.IOP.TAG_ALTERNATE_IIOP_ADDRESS.value, AlternateIIOPAddressComponent.class);
    ...
    public List<ClusterInstanceInfo> getInitialClusterInstanceInfo(ORB orb, List<String> endpoints) {
        try {
            ...
            InitialGroupInfoService.InitialGIS initGIS = (InitialGroupInfoService.InitialGIS) PortableRemoteObject
                    .narrow(nctx.resolve(path), InitialGroupInfoService.InitialGIS.class);
    ...
    public void send_request(ClientRequestInfo ri) {
        try {
            ...
            if (iterator.hasNext()) {
                org.omg.IOP.TaggedComponent membershipLabelTaggedComponent = ((com.sun.corba.ee.spi.ior.TaggedComponent) iterator.next())
                        .getIOPComponent(orb);
