...
public interface POASystemException {
    POASystemException self = WrapperGenerator.makeWrapper(POASystemException.class, CorbaExtension.self);
    ...
    INTERNAL findPOALocksNotReleased(boolean readLocked, boolean writeLocked, boolean childReadLocked);
    ...
    int JTS_INIT_ERROR = CorbaExtension.self.getMinorCode(POASystemException.class, "jtsInitError");
