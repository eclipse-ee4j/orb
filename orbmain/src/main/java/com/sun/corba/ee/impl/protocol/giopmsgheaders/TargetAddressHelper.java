...
/**
 * com/sun/corba/ee/impl/protocol/giopmsgheaders/TargetAddressHelper.java Generated by the IDL-to-Java compiler
...
abstract public class TargetAddressHelper {
    ...
    synchronized public static org.omg.CORBA.TypeCode type() {
        if (__typeCode == null) {
            ...
            _disTypeCode0 = org.omg.CORBA.ORB.init().create_alias_tc(
                    com.sun.corba.ee.impl.protocol.giopmsgheaders.AddressingDispositionHelper.id(), "AddressingDisposition", _disTypeCode0);
            org.omg.CORBA.UnionMember[] _members0 = new org.omg.CORBA.UnionMember[3];
            org.omg.CORBA.TypeCode _tcOf_members0;
            org.omg.CORBA.Any _anyOf_members0 = org.omg.CORBA.ORB.init().create_any();
    ...
    public static com.sun.corba.ee.impl.protocol.giopmsgheaders.TargetAddress read(org.omg.CORBA.portable.InputStream istream) {
        ...
        switch (_dis0) {
            case com.sun.corba.ee.impl.protocol.giopmsgheaders.KeyAddr.value:
                ...
                byte _object_key[] = new byte[_len1];
            ...
            case com.sun.corba.ee.impl.protocol.giopmsgheaders.ProfileAddr.value:
                org.omg.IOP.TaggedProfile _profile = org.omg.IOP.TaggedProfileHelper.read(istream);
                value.profile(_profile);
                break;
            case com.sun.corba.ee.impl.protocol.giopmsgheaders.ReferenceAddr.value:
                com.sun.corba.ee.impl.protocol.giopmsgheaders.IORAddressingInfo _ior = com.sun.corba.ee.impl.protocol.giopmsgheaders.IORAddressingInfoHelper
                        .read(istream);
                value.ior(_ior);
                break;
            default:
    ...
    public static void write(org.omg.CORBA.portable.OutputStream ostream,
            com.sun.corba.ee.impl.protocol.giopmsgheaders.TargetAddress value) {
