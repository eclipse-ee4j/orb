...
abstract public class TargetAddressHelper {
    ...
    synchronized public static org.omg.CORBA.TypeCode type() {
        if (__typeCode == null) {
            ...
            _disTypeCode0 = org.omg.CORBA.ORB.init().create_alias_tc(com.sun.corba.ee.impl.protocol.giopmsgheaders.AddressingDispositionHelper.id(),
            ...
            __typeCode = org.omg.CORBA.ORB.init().create_union_tc(com.sun.corba.ee.impl.protocol.giopmsgheaders.TargetAddressHelper.id(), "TargetAddress",
