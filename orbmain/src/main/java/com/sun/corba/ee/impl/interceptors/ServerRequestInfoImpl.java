...
public final class ServerRequestInfoImpl extends RequestInfoImpl implements ServerRequestInfo, ServerRequestInfoExt {
    ...
    private static final boolean validCall[][] = {
            ...
            // RequestInfo methods:
            /* request_id */ { true, true, true, true, true }, /* operation */ { true, true, true, true, true },
            /* arguments */ { false, true, true, false, false }, /* exceptions */ { false, true, true, true, true },
            /* contexts */ { false, true, true, true, true }, /* operation_context */ { false, true, true, false, false },
            /* result */ { false, false, true, false, false }, /* response_expected */ { true, true, true, true, true },
            /* sync_scope */ { true, true, true, true, true }, /* reply_status */ { false, false, true, true, true },
            /* forward_reference */ { false, false, false, false, true }, /* get_slot */ { true, true, true, true, true },
            /* get_request_service_context */ { true, true, true, true, true }, /* get_reply_service_context */ { false, false, true, true, true },
            //
            // ServerRequestInfo methods::
            /* sending_exception */ { false, false, false, true, false }, /* object_id */ { false, true, true, true, true },
            /* adapter_id */ { false, true, true, true, true }, /* target_most_derived_inte... */ { false, true, false, false, false },
            /* get_server_policy */ { true, true, true, true, true }, /* set_slot */ { true, true, true, true, true },
            /* target_is_a */ { false, true, false, false, false }, /* add_reply_service_context */ { true, true, true, true, true },
            /* orb_id */ { false, true, true, true, true }, /* server_id */ { false, true, true, true, true },
    ...
    /**
     * Creates a new ServerRequestInfo implementation. The constructor is package scope since no other package need create
     ...
     *
     * These are implemented here because they have differing implementations depending on whether this is a client or a
     * server request info object.
     **********************************************************************/
    ...
    public int request_id() {
        ...
        /*
         * NOTE: The request id in server interceptors is NOT the same as the GIOP request id. The ORB may be servicing several
         * connections, each with possibly overlapping sets of request ids. Therefore we create a request id specific to
         * interceptors.
         */
    ...
    private void enqueue(AddReplyServiceContextCommand addReply) {
        ...
        for (int i = 0; i < size; i++) {
            AddReplyServiceContextCommand cmd = addReplyServiceContextQueue.get(i);
            ...
            if (cmd.service_context.context_id == addReply.service_context.context_id) {
                ...
                if (addReply.replace) {
                    ...
                    throw stdWrapper.serviceContextAddFailed(cmd.service_context.context_id);
                }
                break;
            }
        }
    ...
    protected void setCurrentExecutionPoint(int executionPoint) {
        ...
        if ((executionPoint == EXECUTION_POINT_ENDING) && (addReplyServiceContextQueue != null)) {
            int size = addReplyServiceContextQueue.size();
            for (int i = 0; i < size; i++) {
                AddReplyServiceContextCommand addReply = addReplyServiceContextQueue.get(i);
                try {
     ...
     */
    protected synchronized void setInfo(MessageMediator request, ObjectAdapter oa, byte[] objectId, ObjectKeyTemplate oktemp) {
    ...
    protected void setInfo(java.lang.Object servant, String targetMostDerivedInterface) {
        ...
        this.isDynamic = (servant instanceof org.omg.PortableServer.DynamicImplementation) || (servant instanceof org.omg.CORBA.DynamicImplementation);
    }
    ...
    /**
     * Release the servant object so the user has control over its lifetime. Called after receive_request is finished
     * executing.
     */
    void releaseServant() {
        this.servant = null;
    ...
    /**
     * Sets the forwardRequestRaisedInEnding flag to true, indicating that a server ending point has raised location forward
     * at some point.
     */
