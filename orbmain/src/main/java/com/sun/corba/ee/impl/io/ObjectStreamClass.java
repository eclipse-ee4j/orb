...
public class ObjectStreamClass implements java.io.Serializable {
                            ...
                            for (int j = fields.length - 1; j >= 0; j--) {
                                try {
                                    ...
                                    if (fields[j].getType() == reflField.getType()) {
                                        ...
                                        Exceptions.self.fieldTypeMismatch(cl.getName(), fields[j].getName(), fields[j].getType(), reflField.getName(),
                                                reflField.getType());
                                    }
    ...
    public static final int FIELD_MASK = Modifier.PUBLIC | Modifier.PRIVATE | Modifier.PROTECTED | Modifier.STATIC | Modifier.FINAL | Modifier.TRANSIENT
            | Modifier.VOLATILE;
    public static final int METHOD_MASK = Modifier.PUBLIC | Modifier.PRIVATE | Modifier.PROTECTED | Modifier.STATIC | Modifier.FINAL | Modifier.SYNCHRONIZED
     ...
     */
    static private final SoftCache<Class<?>, ObjectStreamClass> descriptorFor = new SoftCache<Class<?>, ObjectStreamClass>();
