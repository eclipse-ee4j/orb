...
public abstract class InputStreamHook extends ObjectInputStream {
    ...
    static final UtilSystemException utilWrapper = UtilSystemException.self;
    ...
    abstract void readFields(java.util.Map<String, Object> fieldToValueMap)
            throws java.io.InvalidClassException, java.io.StreamCorruptedException, ClassNotFoundException, java.io.IOException;
    ...
    protected static class ReadObjectState {
        ...
        @StreamFormatVersion
        public final void beginUnmarshalCustomValue(InputStreamHook stream, boolean calledDefaultWriteObject, boolean hasReadObject)
                throws IOException {
