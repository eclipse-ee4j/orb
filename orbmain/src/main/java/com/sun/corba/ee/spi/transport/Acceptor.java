...
public abstract interface Acceptor {
     ...
     *
     * For example, initialization may mean to create a {@link java.nio.channels.ServerSocketChannel ServerSocketChannel}.
     *
    ...
    /**
     * Used to determine if the <code>Acceptor</code> should register with a Selector to handle accept events.
     *
     * For example, this may be <em>false</em> in the case of Solaris Doors which do not actively listen.
     *
     * @return <code>true</code> if the <code>Acceptor</code> should be registered with a Selector.
     */
