...
// The real state of the connection
    ...
    public String toString() {
        return "OutboundConnectionState[csv=" + csv + ",cinfo=" + cinfo + ",connection=" + connection + ",busyCount=" + busyCount + ",expectedResponceCount="
...
// State exposed as managed attributes
    ...
    public OutboundConnectionState(final ContactInfo<C> cinfo, final OutboundCacheEntry<C> entry, final C conn) {
