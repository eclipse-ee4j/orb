...
public class ByteBuffer {
    /**
     * The array buffer into which the components of the ByteBuffer are stored. The capacity of the ByteBuffer is the length
    ...
    /**
     * The amount by which the capacity of the ByteBuffer is automatically incremented when its size becomes greater than
     * its capacity. If the capacity increment is less than or equal to zero, the capacity of the ByteBuffer is doubled each
     ...
     * @param capacityIncrement the amount by which the capacity is increased when the ByteBuffer overflows.
    ...
    /**
     * Trims the capacity of this ByteBuffer to be the ByteBuffer's current size. If the capacity of this cector is larger
     * than its current size, then the capacity is changed to equal the size by replacing its internal data array, kept in
     * the field <tt>elementData</tt>, with a smaller one. An application can use this operation to minimize the storage of
     * a ByteBuffer.
     */
     ...
     *
     * @return the current capacity (the length of its internal data arary, kept in the field <tt>elementData</tt> of this
     * ByteBuffer.
     */
    public int capacity() {
