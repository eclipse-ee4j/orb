...
public class ServerRequestDispatcherImpl implements ServerRequestDispatcher {
     ...
     * request to.
     * @exception OBJECT_NOT_EXIST is thrown if we know the object does not exist here, and we are not forwarding.
     */
    @Subcontract
    ...
    @Subcontract
    protected java.lang.Object getServantWithPI(MessageMediator request, ObjectAdapter objectAdapter, byte[] objectId, ObjectKeyTemplate oktemp,
        ...
        if (((servant != null) && !(servant instanceof org.omg.CORBA.DynamicImplementation)
                && !(servant instanceof org.omg.PortableServer.DynamicImplementation)) || (SpecialMethod.getSpecialMethod(operation) != null)) {
