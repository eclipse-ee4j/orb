...
public interface ClientRequestDispatcher {
     ...
     *
     * @throws org.omg.CORBA.portable.ApplicationException if the remote side raises an exception declared in the remote
     * interface.
     * 
     * @throws org.omg.CORBA.portable.RemarshalException RemarshalException if the PEPt runtime would like the presentation
     * block to start over.
     */
