...
public class ORBImpl extends com.sun.corba.ee.spi.orb.ORB {
    ...
    @InfoMethod
    private void isLocalServerIdInfo(int subcontractId, int serverId, int transientServerId, boolean aTransient, boolean persistentServerIdInitialized,
            int psid) {
    }
    ...
    @Override
    public synchronized org.omg.CORBA.TypeCode create_value_tc(String id, String name, short type_modifier, TypeCode concrete_base, ValueMember[] members) {
        checkShutdownState();
