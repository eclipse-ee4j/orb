...
public abstract class RequestInfoImpl extends LocalObject implements RequestInfo, RequestInfoExt {
    ...
    /**
     * This method returns the list of exceptios that was raised when the operation was invoked. It raises NO_RESOURCES
     ...
     * request's service context does not contain an etry for that ID, BAD_PARAM with a minor code of TBD_BP is raised.
     */
     ...
     */
    protected org.omg.IOP.ServiceContext getServiceContext(Map<Integer, org.omg.IOP.ServiceContext> cachedServiceContexts, ServiceContexts serviceContexts,
            int id) {
    ...
    protected void addServiceContext(Map<Integer, org.omg.IOP.ServiceContext> cachedServiceContexts, ServiceContexts serviceContexts,
        ...
        coreServiceContext = ServiceContextDefaults.makeUnknownServiceContext(inputStream.read_long(), (org.omg.CORBA_2_3.portable.InputStream) inputStream);
