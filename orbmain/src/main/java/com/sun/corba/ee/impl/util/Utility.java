...
public final class Utility {
     ...
     * @exception org.omg.CORBA.INV_OBJREF if obj is an implementation which has not been exported.
     */
     ...
     */
    public static Class loadClassForClass(String className, String remoteCodebase, ClassLoader loader, Class relatedType,
        ...
        // this step?
        if (loadedClass == null
                || (loadedClass.getClassLoader() != null && loadedClass.getClassLoader().loadClass(relatedType.getName()) != relatedType)) {
     ...
     */
    private static StubEntry loadStubAndUpdateCache(Tie tie, PresentationManager.StubFactory stubFactory, String remoteCodebase,
