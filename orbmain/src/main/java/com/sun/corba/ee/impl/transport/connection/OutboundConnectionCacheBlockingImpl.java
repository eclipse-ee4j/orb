...
public final class OutboundConnectionCacheBlockingImpl<C extends Connection> extends ConnectionCacheBlockingBase<C>
    ...
    public OutboundConnectionCacheBlockingImpl(final String cacheType, final int highWaterMark, final int numberToReclaim,
    ...
    private OutboundCacheEntry<C> getEntry(final ContactInfo<C> cinfo) throws IOException {
        ...
        if (result == null) {
            result = new OutboundCacheEntry<>(lock);
    ...
    private OutboundConnectionState<C> getConnectionState(ContactInfo<C> cinfo, OutboundCacheEntry<C> entry, C conn) {
        ...
        try {
            ...
            if (cs == null) {
                cs = new OutboundConnectionState<>(cinfo, entry, conn);
