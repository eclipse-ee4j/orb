...
public class ReferenceFactoryManagerImpl extends org.omg.CORBA.LocalObject implements ReferenceFactoryManager {
    ...
    public void activate() {
        ...
        try {
            ...
            parentPOAAdapterName = ObjectAdapter.class.cast(parentPOA).getIORTemplate().getObjectKeyTemplate().getObjectAdapterId().getAdapterName();
    ...
    @Poa
    public ReferenceFactory create(final String name, final String repositoryId, final List<Policy> policies, final ServantLocator locator) {
        lock.lock();
        try {
