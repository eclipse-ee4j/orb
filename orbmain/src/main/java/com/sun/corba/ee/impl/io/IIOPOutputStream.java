...
public class IIOPOutputStream extends com.sun.corba.ee.impl.io.OutputStreamHook {
    ...
    public final void simpleWriteObject(Object obj, byte formatVersion) {
        ...
        /*
         * If the recursion depth is 0, test for and clear the pending exception. If there is a pending exception throw it.
         */
    ...
    /**
     * Reset will disregard the state of any objects already written to the stream. The state is reset to be the same as a
    ...
    /*
     * Check for special cases of serializing objects. These objects are not subject to replacement.
     */
    ...
    /*
     * Check for special cases of substitutable serializing objects. These classes are replaceable.
     */
    ...
    private void outputObject(final Object obj) throws IOException {
        ...
        if (currentClassDesc.isExternalizable()) {
            ...
            /*
             * The object's classes should be processed from supertype to subtype. Push all the clases of the current object onto a
             * stack. Remember the stack pointer where this set of classes is being pushed.
             */
            ...
            try {
                ...
                } while (classDescStack.size() > stackMark && (currentClassDesc = classDescStack.pop()) != null);
            } finally {
    ...
    /*
     * Invoke writer. _REVISIT_ invokeObjectWriter and invokeObjectReader behave inconsistently with each other since the
     * reader returns a boolean...fix later
     */
    @ValueHandlerWrite
    ...
    void writeField(ObjectStreamField field, Object value) throws IOException {
        ...
        case 'L':
            ...
            break;
        default:
            throw Exceptions.self.invalidClassForWrite(currentClassDesc.getName());
        }
    }
