...
/**
 * Manage connections that are initiated from another VM. Connections are reclaimed when they are no longer in use and
 * there are too many connections open.
 * <P>
 ...
 */
@Transport
public final class InboundConnectionCacheImpl<C extends Connection> extends ConnectionCacheNonBlockingBase<C>
    ...
    public InboundConnectionCacheImpl(final String cacheType, final int highWaterMark, final int numberToReclaim, long ttl) {
