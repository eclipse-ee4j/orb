...
public final class CodeSetComponentInfo {
    ...
    /**
     * CodeSetComponent is part of an IOR multi-component profile. Two instances constitute a CodeSetComponentInfo (one for
     * char and one for wchar data)
     */
    public static final class CodeSetComponent {
        ...
        public boolean equals(Object obj) {
            ...
            return (nativeCodeSet == other.nativeCodeSet) && Arrays.equals(conversionCodeSets, other.conversionCodeSets);
        }
     ...
     *
     * Pre-Merlin/J2EE 1.3 JavaSoft ORBs listed ISO646 for char and UCS-2 for wchar, and provided no conversion sets. They
     * also didn't do correct negotiation or provide the fallback sets. UCS-2 is still in the conversion list for backwards
     * compatibility.
     *
     * The fallbacks are UTF-8 for char and UTF-16 for wchar.
     *
     * In GIOP 1.1, interoperability with wchar is limited to 2 byte fixed width encodings since its wchars aren't preceded
     * by a length. Thus, I've chosen not to include UTF-8 in the conversion set for wchar data.
     *
     */
    ...
    /**
     * Creates a CodeSetComponent from a String which contains a comma delimited list of OSF Code Set Registry numbers. An
     * INITIALIZE exception is thrown if any of the numbers are not known by our registry. Used by corba.ORB init.
     *
