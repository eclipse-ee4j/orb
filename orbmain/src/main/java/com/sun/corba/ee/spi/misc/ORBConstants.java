...
public class ORBConstants {
    ...
    public static final int FOLB_MEMBER_ADDRESSES_TAGGED_COMPONENT_ID = SUN_TAGGED_COMPONENT_ID_BASE + 3;
    // Introduced in AS 9.0
    public static final int FOLB_MEMBERSHIP_LABEL_TAGGED_COMPONENT_ID = SUN_TAGGED_COMPONENT_ID_BASE + 4;
    // Introduced in GFv2.1
    public static final int TAG_LOAD_BALANCING_ID = SUN_TAGGED_COMPONENT_ID_BASE + 5;
    ...
    // Introduced in AS 9.
    public static final int FOLB_MEMBERSHIP_LABEL_SERVICE_CONTEXT_ID = SUN_SERVICE_CONTEXT_ID_BASE + 1;
    // Introduced in AS 9.
    public static final int FOLB_IOR_UPDATE_SERVICE_CONTEXT_ID = SUN_SERVICE_CONTEXT_ID_BASE + 2;
    ...
    public static final String INITIAL_HOST_PROPERTY = CORBA_PREFIX + "ORBInitialHost";
    public static final String INITIAL_PORT_PROPERTY = CORBA_PREFIX + "ORBInitialPort";
    public static final String INITIAL_SERVICES_PROPERTY = CORBA_PREFIX + "ORBInitialServices";
    public static final String DEFAULT_INIT_REF_PROPERTY = CORBA_PREFIX + "ORBDefaultInitRef";
    public static final String ORB_INIT_REF_PROPERTY = CORBA_PREFIX + "ORBInitRef";
    ...
    public static final String ENV_IS_SERVER_PROPERTY = SUN_PREFIX + "ORBEnvironmentIsGlassFishServer";
    ...
    public static final String CONTACT_INFO_LIST_FACTORY_CLASS_PROPERTY = SUN_PREFIX + "transport.ORBContactInfoList";

    // Legacy:
    public static final String LEGACY_SOCKET_FACTORY_CLASS_PROPERTY = SUN_PREFIX + "legacy.connection.ORBSocketFactoryClass";
    ...
    public static final String IOR_TO_SOCKET_INFO_CLASS_PROPERTY = SUN_PREFIX + "transport.ORBIORToSocketInfoClass";
    public static final String IIOP_PRIMARY_TO_CONTACT_INFO_CLASS_PROPERTY = SUN_PREFIX + "transport.ORBIIOPPrimaryToContactInfoClass";
    ...
    public static final String TRANSPORT_TCP_TIMEOUTS_PROPERTY = SUN_PREFIX + "transport.ORBTCPTimeouts";

    // Same syntax as TRANSPORT_TCP_TIMEOUTS_PROPERTY
    public static final String TRANSPORT_TCP_CONNECT_TIMEOUTS_PROPERTY = SUN_PREFIX + "transport.ORBTCPConnectTimeouts";
    ...
    public static final String USE_NIO_SELECT_TO_WAIT_PROPERTY = SUN_PREFIX + "transport.ORBUseNIOSelectToWait";
    ...
    public static final String ACCEPTOR_SOCKET_USE_WORKER_THREAD_FOR_EVENT_PROPERTY = SUN_PREFIX + "transport.ORBAcceptorSocketUseWorkerThreadForEvent";

    // Applicable on client-side. "Socket" | "SocketChannel"
    public static final String CONNECTION_SOCKET_TYPE_PROPERTY = SUN_PREFIX + "transport.ORBConnectionSocketType";

    // Applicable if using SocketChannel and using select thread
    public static final String CONNECTION_SOCKET_USE_WORKER_THREAD_FOR_EVENT_PROPERTY = SUN_PREFIX + "transport.ORBConnectionSocketUseWorkerThreadForEvent";
    ...
    public static final String DISABLE_DIRECT_BYTE_BUFFER_USE_PROPERTY = SUN_PREFIX + "transport.ORBDisableDirectByteBufferUse";
    ...
    public static final String READ_BYTE_BUFFER_SIZE_PROPERTY = SUN_PREFIX + "transport.ORBReadByteBufferSize";

    // The default pooled DirectByteBuffer slab size.
    public static final int DEFAULT_POOLED_DIRECT_BYTE_BUFFER_SLAB_SIZE = 4000000; // 4 megabytes

    // The property name to set the size of the pooled DirectByteBuffer
    // slab size.
    public static final String POOLED_DIRECT_BYTE_BUFFER_SLAB_SIZE_PROPERTY = SUN_PREFIX + "transport.ORBPooledDirectByteBufferSlabSize";
    ...
    public static final String MAX_READ_BYTE_BUFFER_SIZE_THRESHOLD_PROPERTY = SUN_PREFIX + "transport.ORBMaximumReadByteBufferSize";
    ...
    public static final String ALWAYS_ENTER_BLOCKING_READ_PROPERTY = SUN_PREFIX + "transport.ORBOptimizedReadAlwaysEnterBlockingRead";

    // A property that can tell the optimized read implementation to read
    // until zero bytes are read by the non-blocking read.
    public static final String NON_BLOCKING_READ_CHECK_MESSAGE_PARSER_PROPERTY = SUN_PREFIX + "transport.ORBNonBlockingReadCheckMessageParser";

    // A property that can tell the optimized read implementation to be more
    // patient about expecting additional data to arrive.
    public static final String BLOCKING_READ_CHECK_MESSAGE_PARSER_PROPERTY = SUN_PREFIX + "transport.ORBBlockingReadCheckMessageParser";

    public static final String SOCKET = "Socket";
    public static final String SOCKETCHANNEL = "SocketChannel";

    public static final String WAIT_FOR_RESPONSE_TIMEOUT = SUN_PREFIX + "transport.ORBWaitForResponseTimeout";

    public static final String NO_DEFAULT_ACCEPTORS = SUN_PREFIX + "transport.ORBNoDefaultAcceptors";

    public static final String REGISTER_MBEANS = SUN_PREFIX + "ORBRegisterMBeans";

    public static final int DEFAULT_FRAGMENT_READ_TIMEOUT = 18000;

    public static final String FRAGMENT_READ_TIMEOUT = SUN_PREFIX + "ORBFragmentReadTimeout";

    // POA related policies
    public static final String PERSISTENT_SERVER_PORT_PROPERTY = SUN_PREFIX + "POA.ORBPersistentServerPort";
    public static final String BAD_SERVER_ID_HANDLER_CLASS_PROPERTY = SUN_PREFIX + "POA.ORBBadServerIdHandlerClass";
    ...
    public static final String ENABLE_JAVA_SERIALIZATION_PROPERTY = SUN_PREFIX + "encoding.ORBEnableJavaSerialization";
    ...
    public static final String USER_CONFIGURATOR_PREFIX = SUN_PREFIX + "ORBUserConfigurators.";

    public static final String RFM_PROPERTY = USER_CONFIGURATOR_PREFIX + "com.sun.corba.ee.impl.oa.rfm.ReferenceManagerConfigurator";

    public static final String USE_DYNAMIC_STUB_PROPERTY = SUN_PREFIX + "ORBUseDynamicStub";

    public static final String DEBUG_DYNAMIC_STUB = SUN_PREFIX + "ORBDebugStubGeneration";

    // Not available through ORBData: used only in test.Test
    // and in the optional ClassCopierOrdinaryImpl class.
    public static final String USE_CODEGEN_REFLECTIVE_COPYOBJECT = SUN_PREFIX + "ORBUseCodegenReflectiveCopyobject";

    public static final String DYNAMIC_STUB_FACTORY_FACTORY_CLASS = SUN_PREFIX + "ORBDynamicStubFactoryFactoryClass";
    ...
    public static final String LOG_RESOURCE_FILE = "com.sun.corba.ee.impl.logging.LogStrings";

    public static final String SHOW_INFO_MESSAGES = SUN_PREFIX + "ORBShowInfoMessages";

    public static final String GET_SERVICE_CONTEXT_RETURNS_NULL = SUN_PREFIX + "ORBGetServiceContextReturnsNull";
    ...
    public static final String FOLB_SERVER_GROUP_INFO_SERVICE = "FolbServerGroupInfoService";

    public static final String CSI_V2_SSL_TAGGED_COMPONENT_HANDLER = "CSIv2SSLTaggedComponentHandler";
    ...
    public static final String TIMING_POINTS_ENABLED = SUN_PREFIX + "ORBEnableTimingPoints";

    // Enable the use of the EnumDesc class for marshaling enums. Really only
    // present for testing.
    public static final String USE_ENUM_DESC = SUN_PREFIX + "ORBUseEnumDesc";

    // Specify an AMXv3-compliant ObjectName (as a string) for the parent of the
    // ORB's gmbal root.
    public static final String GMBAL_ROOT_PARENT_NAME = SUN_PREFIX + "ORBGmbalRootParentName";
}
