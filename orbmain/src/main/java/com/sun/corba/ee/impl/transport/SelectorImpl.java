...
public class SelectorImpl extends Thread implements com.sun.corba.ee.spi.transport.Selector {
    ...
    private void createReaderThread(EventHandler eventHandler) {
        ...
        ReaderThread readerThread = new ReaderThreadImpl(orb, connection);
        synchronized (this) {
