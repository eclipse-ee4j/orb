...
public interface OMGSystemException {
    OMGSystemException self = WrapperGenerator.makeWrapper(OMGSystemException.class, CorbaExtension.self);
    ...
    @Message("ServerRequest::ctx called more than once or before " + "ServerRequest::arguments or after ServerRequest::ctx, "
            + "ServerRequest::set_result or ServerRequest::set_exception")
    BAD_INV_ORDER badCtxCall();

    @Log(level = LogLevel.WARNING, id = 9)
    @Message("ServerRequest::set_result called more than once or before " + "ServerRequest::arguments or after ServerRequest::set_result or "
    ...
    int NOT_SERIALIZABLE = CorbaExtension.self.getMinorCode(OMGSystemException.class, "notSerializable");
    ...
    String soBadAddress = "string_to_object conversion failed due to " + "bad address in name {0}";
    ...
    int INVALID_PROFILE_ID = CorbaExtension.self.getMinorCode(OMGSystemException.class, "invalidProfileId");
    ...
    @Message("Two or more Policy objects with the same PolicyType value " + "supplied to Object::set_policy_overrides or "
    ...
    int RMIIIOP_OPTIONAL_DATA_INCOMPATIBLE = CorbaExtension.self.getMinorCode(OMGSystemException.class, "rmiiiopOptionalDataIncompatible1");
    ...
    String adapterActivatorException = "System exception in " + "POA::unknown_adapter for POA {0} with parent POA {1}";

    @Log(level = LogLevel.WARNING, id = 1)
    @Message(adapterActivatorException)
    OBJ_ADAPTER adapterActivatorException(@Chain Exception exc, String arg0, ObjectAdapterId arg1);
    ...
    String unknownUserException = "Unlisted user exception received by client ";
