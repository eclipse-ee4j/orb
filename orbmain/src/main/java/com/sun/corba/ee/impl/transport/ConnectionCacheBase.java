...
public abstract class ConnectionCacheBase implements ConnectionCache {
     ...
     * consequently executed in a separate thread. Currently, the accept & reclaim are done in the same thread, WorkerThread
     * by default. It could be changed such that the SelectorThread would do it for SocketChannels and WorkerThreads for
