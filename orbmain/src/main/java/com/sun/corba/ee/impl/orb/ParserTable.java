...
public class ParserTable {
    ...
    private ParserTable(UnaryFunction<String, Class<?>> cnr) {
        ...
        ParserData[] pd = {
                ParserDataFactory.make(ORBConstants.DEBUG_PROPERTY, OperationFactory.listAction(",", OperationFactory.stringAction()),
                        "debugFlags", new String[0], debugTestData, "subcontract,poa,transport"),
                ParserDataFactory.make(ORBConstants.INITIAL_HOST_PROPERTY, OperationFactory.stringAction(), "ORBInitialHost", "", "Foo",
                        "Foo"),
                ...
                // Boolean.TRUE, "27314" ),
                ParserDataFactory.make(ORBConstants.SERVER_HOST_PROPERTY, OperationFactory.stringAction(), "ORBServerHost", "", "camelot",
                        "camelot"),
                ParserDataFactory.make(ORBConstants.SERVER_PORT_PROPERTY, OperationFactory.integerAction(), "ORBServerPort",
                        Integer.valueOf(0), Integer.valueOf(38143), "38143"),
                ...
                ParserDataFactory.make(ORBConstants.ORB_SERVER_ID_PROPERTY, OperationFactory.integerAction(), "persistentServerId",
                        Integer.valueOf(-1), Integer.valueOf(1234), "1234"),
                ParserDataFactory.make(ORBConstants.ORB_SERVER_ID_PROPERTY, OperationFactory.setFlagAction(),
                        "persistentServerIdInitialized", Boolean.FALSE, Boolean.TRUE, "1234"),
                ...
                // "defaultInitRef", null,
                // "Fooref", "Fooref" ),
                ParserDataFactory.make(ORBConstants.HIGH_WATER_MARK_PROPERTY, OperationFactory.integerAction(), "highWaterMark",
                        Integer.valueOf(240), Integer.valueOf(3745), "3745"),
                ParserDataFactory.make(ORBConstants.LOW_WATER_MARK_PROPERTY, OperationFactory.integerAction(), "lowWaterMark",
                        Integer.valueOf(100), Integer.valueOf(12), "12"),
                ParserDataFactory.make(ORBConstants.NUMBER_TO_RECLAIM_PROPERTY, OperationFactory.integerAction(), "numberToReclaim",
                        Integer.valueOf(5), Integer.valueOf(231), "231"),
                ParserDataFactory.make(ORBConstants.GIOP_VERSION, makeGVOperation(), "giopVersion", GIOPVersion.DEFAULT_VERSION,
                ...
                ParserDataFactory.make(ORBConstants.GIOP_TARGET_ADDRESSING, makeADOperation(), "giopAddressDisposition",
                        Short.valueOf(KeyAddr.value), Short.valueOf((short) 2), "2"),
                ParserDataFactory.make(ORBConstants.ALWAYS_SEND_CODESET_CTX_PROPERTY, OperationFactory.booleanAction(),
                        "alwaysSendCodeSetCtx", Boolean.TRUE, Boolean.FALSE, "false"),
                ...
                ParserDataFactory.make(ORBConstants.WCHAR_CODESETS, makeCSOperation(), "wcharData",
                        ...
                        CodeSetComponentInfo.createFromString(codeSetTestString), codeSetTestString),
                ParserDataFactory.make(ORBConstants.ALLOW_LOCAL_OPTIMIZATION, OperationFactory.booleanAction(), "allowLocalOptimization",
                ...
                ParserDataFactory.make(ORBConstants.LISTEN_SOCKET_PROPERTY, makeUSLOperation(), "userSpecifiedListenPorts", new USLPort[0],
                ...
                ParserDataFactory.make(ORBConstants.IIOP_PRIMARY_TO_CONTACT_INFO_CLASS_PROPERTY, makeIIOPPrimaryToContactInfoOperation(),
                        "iiopPrimaryToContactInfo", null, new TestIIOPPrimaryToContactInfo(),
                ...
                ParserDataFactory.make(ORBConstants.CONTACT_INFO_LIST_FACTORY_CLASS_PROPERTY, makeContactInfoListFactoryOperation(),
                        "corbaContactInfoListFactory", null, new TestContactInfoListFactory(),
                        MY_CLASS_NAME + "$TestContactInfoListFactory"),
                ParserDataFactory.make(ORBConstants.PERSISTENT_SERVER_PORT_PROPERTY, OperationFactory.integerAction(),
                        "persistentServerPort", Integer.valueOf(0), Integer.valueOf(2743), "2743"),
                ParserDataFactory.make(ORBConstants.PERSISTENT_SERVER_PORT_PROPERTY, OperationFactory.setFlagAction(),
                        "persistentPortInitialized", Boolean.FALSE, Boolean.TRUE, "2743"),
                ParserDataFactory.make(ORBConstants.ACTIVATED_PROPERTY, OperationFactory.booleanAction(), "serverIsORBActivated",
                        Boolean.FALSE, Boolean.TRUE, "true"),
                ...
                ParserDataFactory.make(ORBConstants.PI_ORB_INITIALIZER_CLASS_PREFIX, makeROIOperation(), "orbInitializers",
                        new ORBInitializer[0], TestORBInitializers, TestORBInitData, ORBInitializer.class),
                ParserDataFactory.make(ORBConstants.ACCEPTOR_CLASS_PREFIX_PROPERTY, makeAcceptorInstantiationOperation(), "acceptors",
                        new Acceptor[0], TestAcceptors, TestAcceptorData, Acceptor.class),
                ...
                ParserDataFactory.make(ORBConstants.USE_NIO_SELECT_TO_WAIT_PROPERTY, OperationFactory.booleanAction(),
                        "acceptorSocketUseSelectThreadToWait", Boolean.TRUE, Boolean.TRUE, "true"),
                ...
                ParserDataFactory.make(ORBConstants.CONNECTION_SOCKET_TYPE_PROPERTY, OperationFactory.stringAction(),
                        "connectionSocketType", ORBConstants.SOCKETCHANNEL, "foo", "foo"),
                ParserDataFactory.make(ORBConstants.USE_NIO_SELECT_TO_WAIT_PROPERTY, OperationFactory.booleanAction(),
                        "connectionSocketUseSelectThreadToWait", Boolean.TRUE, Boolean.TRUE, "true"),
                ParserDataFactory.make(ORBConstants.CONNECTION_SOCKET_USE_WORKER_THREAD_FOR_EVENT_PROPERTY,
                        OperationFactory.booleanAction(), "connectionSocketUseWorkerThreadForEvent", Boolean.TRUE, Boolean.TRUE, "true"),
                ParserDataFactory.make(ORBConstants.WAIT_FOR_RESPONSE_TIMEOUT, OperationFactory.integerAction(), "waitForResponseTimeout",
                        1000 * 60 * 30, Integer.valueOf(1234), "1234"),
                ParserDataFactory.make(ORBConstants.DISABLE_DIRECT_BYTE_BUFFER_USE_PROPERTY, OperationFactory.booleanAction(),
                ...
                ParserDataFactory.make(ORBConstants.TRANSPORT_TCP_TIMEOUTS_PROPERTY,
                        OperationFactoryExt.convertAction(TcpTimeoutsImpl.class), "tcpTimeouts", defaultTcpTimeouts, testTcpTimeouts,
                        "2000:6000:20"),
                ...
                ParserDataFactory.make(ORBConstants.ENABLE_JAVA_SERIALIZATION_PROPERTY, OperationFactory.booleanAction(),
                        "enableJavaSerialization", Boolean.FALSE, Boolean.FALSE, "false"),
                ParserDataFactory.make(ORBConstants.USE_REP_ID, OperationFactory.booleanAction(), "useRepId", Boolean.TRUE, Boolean.TRUE,
                        "true"),
                ParserDataFactory.make(ORBConstants.ORB_INIT_REF_PROPERTY, OperationFactory.identityAction(), "orbInitialReferences",
                        new Pair[0], TestORBInitRefData, TestORBInitRefData, Pair.class),
                ParserDataFactory.make(ORBConstants.SHOW_INFO_MESSAGES, OperationFactory.booleanAction(), "showInfoMessages", Boolean.FALSE,
                        Boolean.FALSE, "false"),
                ParserDataFactory.make(ORBConstants.GET_SERVICE_CONTEXT_RETURNS_NULL, OperationFactory.booleanAction(),
                        "getServiceContextReturnsNull", Boolean.FALSE, Boolean.FALSE, "false"),
                ParserDataFactory.make(ORBConstants.APPSERVER_MODE, OperationFactory.booleanAction(), "isAppServerMode", Boolean.FALSE,
                        Boolean.FALSE, "FALSE"),
                ...
                ParserDataFactory.make(ORBConstants.MAX_READ_BYTE_BUFFER_SIZE_THRESHOLD_PROPERTY, OperationFactory.integerAction(),
                        "maxReadByteBufferSizeThreshold", Integer.valueOf(ORBConstants.MAX_READ_BYTE_BUFFER_SIZE_THRESHOLD),
                ...
                ParserDataFactory.make(ORBConstants.POOLED_DIRECT_BYTE_BUFFER_SLAB_SIZE_PROPERTY, OperationFactory.integerAction(),
                        "pooledDirectByteBufferSlabSize", Integer.valueOf(ORBConstants.DEFAULT_POOLED_DIRECT_BYTE_BUFFER_SLAB_SIZE),
                        Integer.valueOf(1048576), "1048576"),
                ParserDataFactory.make(ORBConstants.ALWAYS_ENTER_BLOCKING_READ_PROPERTY, OperationFactory.booleanAction(),
                        "alwaysEnterBlockingRead", Boolean.TRUE, Boolean.TRUE, "TRUE"),
                ...
                ParserDataFactory.make(ORBConstants.TIMING_POINTS_ENABLED, OperationFactory.booleanAction(), "timingPointsEnabled",
                        Boolean.FALSE, Boolean.TRUE, "TRUE"),
                ParserDataFactory.make(ORBConstants.USE_ENUM_DESC, OperationFactory.booleanAction(), "useEnumDesc", Boolean.TRUE,
                        Boolean.TRUE, "TRUE"),
                ParserDataFactory.make(ORBConstants.ENV_IS_SERVER_PROPERTY, OperationFactory.booleanAction(), "environmentIsGFServer",
                        Boolean.FALSE, Boolean.TRUE, "TRUE"),
                ParserDataFactory.make(ORBConstants.NO_DEFAULT_ACCEPTORS, OperationFactory.booleanAction(), "noDefaultAcceptors",
                        Boolean.FALSE, Boolean.TRUE, "TRUE"),
                ParserDataFactory.make(ORBConstants.REGISTER_MBEANS, OperationFactory.booleanAction(), "registerMBeans", Boolean.TRUE,
                        Boolean.FALSE, "FALSE"),
                ...
                ParserDataFactory.make(ORBConstants.DISABLE_ORBD_INIT_PROPERTY, OperationFactory.booleanAction(), "disableORBD",
                        Boolean.FALSE, Boolean.TRUE, "TRUE") };
    ...
    public static final class TestORBInitializer1 extends org.omg.CORBA.LocalObject implements ORBInitializer {
        private static final long serialVersionUID = 4400102154229477101L;
    ...
    public static final class TestORBInitializer2 extends org.omg.CORBA.LocalObject implements ORBInitializer {
        private static final long serialVersionUID = 6505693616140593993L;
