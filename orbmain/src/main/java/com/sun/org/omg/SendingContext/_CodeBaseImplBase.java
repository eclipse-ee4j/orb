...
/**
 * com/sun/org/omg/SendingContext/_CodeBaseImplBase.java Generated by the IDL-to-Java compiler (portable), version "3.0"
...
public abstract class _CodeBaseImplBase extends org.omg.CORBA.portable.ObjectImpl
    ...
    private static java.util.Map<String, Integer> _methods = new java.util.HashMap<>();
    ...
    private final static String[] __ids = { "IDL:omg.org/SendingContext/CodeBase:1.0", "IDL:omg.org/SendingContext/RunTime:1.0" };
