...
/**
 * com/sun/org/omg/CORBA/InitializerHelper.java Generated by the IDL-to-Java compiler (portable), version "3.0" from
        ...
        if (__typeCode == null) {
            synchronized (org.omg.CORBA.TypeCode.class) {
                if (__typeCode == null) {
                    ...
                    _tcOf_members0 = org.omg.CORBA.ORB.init().create_alias_tc(com.sun.org.omg.CORBA.StructMemberSeqHelper.id(),
                            "StructMemberSeq", _tcOf_members0);
                    ...
                    __typeCode = org.omg.CORBA.ORB.init().create_struct_tc(com.sun.org.omg.CORBA.InitializerHelper.id(), "Initializer",
                            _members0);
                    __active = false;
                }
            }
