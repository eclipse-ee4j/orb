...
/**
 * com/sun/org/omg/SendingContext/_CodeBaseStub.java Generated by the IDL-to-Java compiler (portable), version "3.0"
...
public class _CodeBaseStub extends org.omg.CORBA.portable.ObjectImpl implements com.sun.org.omg.SendingContext.CodeBase {
    ...
    public com.sun.org.omg.CORBA.ValueDefPackage.FullValueDescription meta(String x) {
        ...
        try {
            ...
            com.sun.org.omg.CORBA.RepositoryIdHelper.write(_out, x);
            _in = _invoke(_out);
            com.sun.org.omg.CORBA.ValueDefPackage.FullValueDescription __result = com.sun.org.omg.CORBA.ValueDefPackage.FullValueDescriptionHelper
                    .read(_in);
            return __result;
        } catch (org.omg.CORBA.portable.ApplicationException _ex) {
            _in = _ex.getInputStream();
    ...
    public com.sun.org.omg.CORBA.ValueDefPackage.FullValueDescription[] metas(String[] x) {
        ...
        try {
            ...
            com.sun.org.omg.CORBA.RepositoryIdSeqHelper.write(_out, x);
            _in = _invoke(_out);
            com.sun.org.omg.CORBA.ValueDefPackage.FullValueDescription __result[] = com.sun.org.omg.SendingContext.CodeBasePackage.ValueDescSeqHelper
                    .read(_in);
            return __result;
        } catch (org.omg.CORBA.portable.ApplicationException _ex) {
            _in = _ex.getInputStream();
