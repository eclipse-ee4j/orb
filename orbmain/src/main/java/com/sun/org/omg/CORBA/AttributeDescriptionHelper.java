...
/**
 * com/sun/org/omg/CORBA/AttributeDescriptionHelper.java Generated by the IDL-to-Java compiler (portable), version "3.0"
        ...
        if (__typeCode == null) {
            synchronized (org.omg.CORBA.TypeCode.class) {
                if (__typeCode == null) {
                    ...
                    __typeCode = org.omg.CORBA.ORB.init().create_struct_tc(com.sun.org.omg.CORBA.AttributeDescriptionHelper.id(),
                            "AttributeDescription", _members0);
                    __active = false;
                }
            }
        }
