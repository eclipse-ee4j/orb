...
/**
 * com/sun/org/omg/CORBA/AttributeModeHelper.java Generated by the IDL-to-Java compiler (portable), version "3.0" from
...
public final class AttributeModeHelper {
    ...
    synchronized public static org.omg.CORBA.TypeCode type() {
        if (__typeCode == null) {
            __typeCode = org.omg.CORBA.ORB.init().create_enum_tc(com.sun.org.omg.CORBA.AttributeModeHelper.id(), "AttributeMode",
