...
/**
 * com/sun/org/omg/CORBA/AttrDescriptionSeqHelper.java Generated by the IDL-to-Java compiler (portable), version "3.0"
...
public final class AttrDescriptionSeqHelper {
    ...
    synchronized public static org.omg.CORBA.TypeCode type() {
        if (__typeCode == null) {
            ...
            __typeCode = org.omg.CORBA.ORB.init().create_alias_tc(com.sun.org.omg.CORBA.AttrDescriptionSeqHelper.id(), "AttrDescriptionSeq",
                    __typeCode);
        }
        return __typeCode;
    }
