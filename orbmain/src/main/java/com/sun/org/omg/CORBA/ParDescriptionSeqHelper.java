...
/**
 * com/sun/org/omg/CORBA/ParDescriptionSeqHelper.java Generated by the IDL-to-Java compiler (portable), version "3.0"
...
public final class ParDescriptionSeqHelper {
    ...
    synchronized public static org.omg.CORBA.TypeCode type() {
        if (__typeCode == null) {
            ...
            __typeCode = org.omg.CORBA.ORB.init().create_alias_tc(com.sun.org.omg.CORBA.ParDescriptionSeqHelper.id(), "ParDescriptionSeq",
                    __typeCode);
        }
        return __typeCode;
    }
    ...
    public static void write(org.omg.CORBA.portable.OutputStream ostream, com.sun.org.omg.CORBA.ParameterDescription[] value) {
        ...
        for (ParameterDescription element : value) {
            com.sun.org.omg.CORBA.ParameterDescriptionHelper.write(ostream, element);
        }
    }
