...
/**
 * com/sun/org/omg/CORBA/OpDescriptionSeqHelper.java Generated by the IDL-to-Java compiler (portable), version "3.0"
...
public final class OpDescriptionSeqHelper {
    ...
    synchronized public static org.omg.CORBA.TypeCode type() {
        if (__typeCode == null) {
            ...
            __typeCode = org.omg.CORBA.ORB.init().create_alias_tc(com.sun.org.omg.CORBA.OpDescriptionSeqHelper.id(), "OpDescriptionSeq",
                    __typeCode);
        }
        return __typeCode;
    }
    ...
    public static void write(org.omg.CORBA.portable.OutputStream ostream, com.sun.org.omg.CORBA.OperationDescription[] value) {
        ...
        for (OperationDescription element : value) {
            com.sun.org.omg.CORBA.OperationDescriptionHelper.write(ostream, element);
        }
    }
