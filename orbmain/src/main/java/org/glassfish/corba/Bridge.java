 ...
 * <li>putXXX/getXXX methods that allow unchecked access to fields of objects. This is used for setting uninitialzed
...
public final class Bridge {
     ...
     * @throws SecurityException if the caller does not have the required permissions and the caller has a non-null security
     * manager.
     */
    ...
    /**
     * Fetches a field element within the given object <code>o</code> at the given offset. The result is undefined unless
     * the offset was obtained from {@link #objectFieldOffset} on the {@link java.lang.reflect.Field} of some Java field and
     * the object referred to by <code>o</code> is of a class compatible with that field's class.
     *
     * @param o Java heap object in which the field from which the offset was obtained resides
     * @param offset indication of where the field resides in a Java heap object
     ...
     * field. The given value is stored into that field.
     * <p>
     * The field must be of the same type as the method parameter <code>x</code>.
     *
     * @param o Java heap object in which the field resides, if any, else null
     * @param offset indication of where the field resides in a Java heap object.
    ...
    /**
     * Obtain a constructor for Class cl using constructor cons which may be the constructor defined in a superclass of cl.
     * This is used to create a constructor for Serializable classes that constructs an instance of the Serializable class
     * using the no args constructor of the first non-Serializable superclass of the Serializable class.
     */
    @SuppressWarnings("unchecked")
