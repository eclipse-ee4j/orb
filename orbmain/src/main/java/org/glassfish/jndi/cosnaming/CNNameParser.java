...
/**
 * Parsing routines for NameParser as well as COS Naming stringified names. This is used by CNCtx to create a
 * NameComponent[] object and vice versa. It follows Section 4.5 of Interoperable Naming Service (INS) 98-10-11. In
 * summary, the stringified form is a left-to-right, forward-slash separated name. id and kinds are separated by '.'.
...
final public class CNNameParser implements NameParser {
    ...
    /**
     * Creates a CompositeName from a NameComponent[]. Used by ExceptionMapper and CNBindingEnumeration to convert a
     * NameComponent[] into a composite name.
     */
    ...
    /**
     * Converts an INS-syntax string name into a Vector in which each element of the vector contains a stringified form of a
     * NameComponent.
     */
