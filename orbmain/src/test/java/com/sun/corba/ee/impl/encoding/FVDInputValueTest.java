...
public class FVDInputValueTest extends ValueTestBase {
    ...
    private void defineOriginalValue1FVD() {
        defineFullValueDescription(Value1.REPID).withMember("aChar", char.class).withMember("anInt", int.class).build();
    }

    private void defineEvolvedValue1FVD() {
        defineFullValueDescription(VALUE1_REPID2).withMember("aChar", char.class).withMember("ignoreMe", int.class)
                .withMember("anInt", int.class).build();
    }
    ...
    private void defineDerivedValueFVD() {
        defineFullValueDescription(DERIVED_VALUE_REPID).withBaseRepId(VALUE1_REPID2).withMember("ready", boolean.class)
                .withMember("aByte", byte.class).withMember("extra", float.class).withMember("aShort", short.class).build();
    }
    ...
    private void defineDerivedWithDefaultMarshalledGhostSuperclassesFVD() {
        ...
        defineFullValueDescription(DERIVED_VALUE_REPID).withBaseRepId(VALUE1_REPID2).withMember("ready", boolean.class)
                .withMember("aByte", byte.class).withMember("extra", int.class).withMember("aShort", short.class).build();
    }

    private void defineValue1FvdWithGhostSuperclasses() {
        defineGhostSuperclass2FVD();
        defineFullValueDescription(VALUE1_REPID2).withBaseRepId(GHOST_SUPERCLASS_2_REPID).withMember("aChar", char.class)
                .withMember("extra", float.class).withMember("anInt", int.class).build();
    }

    private void defineGhostSuperclass2FVD() {
        defineGhostSuperclass1FVD();
        defineFullValueDescription(GHOST_SUPERCLASS_2_REPID).withBaseRepId(GHOST_SUPERCLASS_1_REPID)
                .withMember("noSuchBoolean", boolean.class).withMember("noSuchChar", char.class).withMember("noSuchFloat", float.class)
                .withMember("noSuchDouble", double.class).build();

    }

    private void defineGhostSuperclass1FVD() {
        defineFullValueDescription(GHOST_SUPERCLASS_1_REPID).withMember("noSuchInt", int.class).withMember("noSuchByte", byte.class)
                .withMember("noSuchShort", short.class).withMember("noSuchLong", long.class).build();
    }
    ...
    private void defineValue1FvdWithCustomMarshalledGhostSuperclass() {
        ...
        defineFullValueDescription(VALUE1_REPID2).withBaseRepId(GHOST_SUPERCLASS_1_REPID).withMember("aChar", char.class)
                .withMember("extra", float.class).withMember("anInt", int.class).build();
    }

    private void defineCustomMarshalledGhostSuperclassFVD() {
        defineFullValueDescription(GHOST_SUPERCLASS_1_REPID).withCustomMarshalling().withMember("noSuchShort", short.class)
                .withMember("noSuchLong", long.class).build();
    }

    @Test
    @Ignore("There is code that is supposed to handle this, but it appears to be wrong")
    ...
    private void defineValue2Fvd() {
        defineFullValueDescription(VALUE2_REPID2).withMember("aLong", long.class).withMember("extra", float.class)
                .withMember("aValue", VALUE1_REPID2).build();
    }
    ...
    private void defineCustomMarshalledValueFvd() {
        defineFullValueDescription(CUSTOM_VALUE_REPID).withCustomMarshalling().withMember("aDouble", double.class)
                .withMember("value1", Value1.REPID).withMember("extra", int.class).withMember("aFloat", float.class).build();
    }
    ...
    private void defineCustomWriteValueFvd() {
        defineFullValueDescription(CUSTOM_WRITE_VALUE_REPID).withCustomMarshalling().withMember("extra", int.class)
                .withMember("aPositiveValue", int.class).build();
    }
    ...
    private void defineCustomReadValueFvd() {
        defineFullValueDescription(CUSTOM_READ_VALUE_REPID).withMember("extra", int.class).withMember("aPositiveValue", int.class).build();
    }
    ...
    private void defineCustomAllTypesFieldsFvd() {
        defineFullValueDescription(CUSTOM_ALL_FIELDS_REPID).withCustomMarshalling().withMember("aBoolean", boolean.class)
                .withMember("aByte", byte.class).withMember("aChar", char.class).withMember("aShort", short.class)
                .withMember("anInt", int.class).withMember("aLong", long.class).withMember("aFloat", float.class)
                .withMember("aDouble", double.class).withMember("aString", String.class).build();
