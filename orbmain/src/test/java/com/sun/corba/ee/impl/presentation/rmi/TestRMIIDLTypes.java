...
public class TestRMIIDLTypes extends TestCase {
    ...
    public void testPrimitiveTypes() {
        Class[] primitives = { Void.TYPE, Boolean.TYPE, Byte.TYPE, Character.TYPE, Short.TYPE, Integer.TYPE, Long.TYPE, Float.TYPE, Double.TYPE };
        ...
        Class[] nonPrimitives = { Byte.class, Short.class, Integer.class, Long.class, Float.class, Double.class, String.class, java.util.Date.class,
                Object.class };
