...
class AllTypesFields implements Serializable {
    ...
    private static final ObjectStreamField[] serialPersistentFields = { new ObjectStreamField("aBoolean", boolean.class),
            new ObjectStreamField("aByte", byte.class), new ObjectStreamField("aChar", char.class),
            new ObjectStreamField("aShort", short.class), new ObjectStreamField("anInt", int.class),
            new ObjectStreamField("aLong", long.class), new ObjectStreamField("aFloat", float.class),
            new ObjectStreamField("aDouble", double.class), new ObjectStreamField("aString", String.class) };
