...
public class CDRInputTest extends EncodingTestBase {
    ...
    public void can_read_integers() {
        setMessageBody(0x04, pad(), /* short */ FF, (byte) 0xf2, /* short */ 0x00, 0x03, pad(), pad(), /* long1 */ 0, 1, 2, (byte) 0x83, /* long2 */ FF, FF,
                (byte) 0xfd, 0x71, pad(), pad(), pad(), pad(), /* long long */ 0, 0, 1, 0, 0, (byte) 0x80, 1, 7, /* long long */ 0, 0, 1, 0, 0, 0, 1, 2);
    ...
    public void can_read_little_endian_integers() {
        setMessageBody(0x04, pad(), /* short */ 0xf2, FF, /* ushort */ 0x03, 0x00, /* for long */ pad(), pad(), /* long */ 0x83, 2, 1, 0, /* ulong */ 0x71,
                0xfd, FF, FF, /* for long_long */ pad(), pad(), pad(), pad(), /* long long */ 7, 1, 0x80, 0, 0, 1, 0, 0);
        useLittleEndian();
    ...
    public void whenUsingV1_1_canReadCharAndWCharStrings() {
        useV1_1();
        int[] data = { 0, 0, 0, 11, 't', 'h', 'i', 's', ' ', 'w', 'o', 'r', 'k', 's', 0, pad(), 0, 0, 0, 11, 0, 'T', 0, 'h', 0, 'i', 0, 's', 0, ',', 0, ' ', 0,
                't', 0, 'o', 0, 'o', 0, '!', 0, 0, pad(), pad(), 0, 0, 0, 0 };
        setMessageBody(data);
    ...
    public void whenUsingV1_2_canReadCharAndWCharStrings() {
        useV1_2();
        int[] data = { 0, 0, 0, 11, 't', 'h', 'i', 's', ' ', 'w', 'o', 'r', 'k', 's', 0, pad(), 0, 0, 0, 22, FE, FF, 0, 'T', 0, 'h', 0, 'i', 0, 's', 0, ',', 0,
                ' ', 0, 't', 0, 'o', 0, 'o', 0, '!', pad(), pad(), 0, 0, 0, 0 };
        setMessageBody(data);
