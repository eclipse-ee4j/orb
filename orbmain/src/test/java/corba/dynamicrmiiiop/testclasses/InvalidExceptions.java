...
public class InvalidExceptions {
    ...
    public static final Class[] CLASSES = { InvalidException1.class, InvalidException2.class, InvalidException3.class, InvalidException4.class,
            InvalidException5.class, InvalidException6.class, InvalidException7.class, InvalidException8.class, InvalidException9.class,
