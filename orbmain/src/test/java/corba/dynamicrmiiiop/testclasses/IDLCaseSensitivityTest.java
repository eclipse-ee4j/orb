...
public class IDLCaseSensitivityTest {
    ...
    //
    public static final String[] IDL_NAMES = { "ABCDEFGHIJKLmNOPQRSTUVWXYzA_0_1_2_3_4_5_6_7_8_9_10_11_13_14_15_16_17_18_19_20_21_22_23_24_26", "B_0",
            "JACK_0_1_2_3", "JACKY", "Jack_0", "a", "abcdefghijklMnopqrstuvwxyza_12", "abcdefghijklmnopqrstuvwxyzA_26", "b_", "b__", "jAcK_1_3", "jack_" };
    ...
    public interface IDLCaseSensitivity extends java.rmi.Remote {
        String ABCDEFGHIJKLmNOPQRSTUVWXYzA(int a) throws java.rmi.RemoteException;
