...
public class IDLPropertiesTest {
    ...
    //
    static final String[] IDL_NAMES = { "a", "get", "_get_a__", "_get_ABc", "_get_b", "_get_CDE", "getDAB", "getDCD", "getDzzz", "getEfg",
            "_get_zde", "is", "isA", "isBCD", "_get_c", "_get_CCCCCe", "isCZ", "_get_cf", "set", "_set_a__", "_set_b", "setCDE", "setEfg",
            "_set_zde" };
