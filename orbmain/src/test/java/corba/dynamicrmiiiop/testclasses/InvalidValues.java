...
public class InvalidValues {
    ...
    public static final Class[] CLASSES = { InvalidValue1.class, InvalidValue2.class, InvalidValue3.class, InvalidValue4.class,
            InvalidValue5.class, InvalidValue6.class, InvalidValue7.class };
