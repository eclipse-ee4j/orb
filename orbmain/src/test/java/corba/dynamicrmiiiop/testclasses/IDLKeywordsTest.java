...
public class IDLKeywordsTest {
    ...
    //
    static final String[] IDL_NAMES = { "_Any", "_EXCEPTION", "_RaiseS", "_TRUE", "_attribute", "_context", "_falsE", "_in", "_inout",
            "_module", "_octet", "_oneway", "_out", "_readonly", "_sequence", "_string", "_struct", "_typedef", "_union", "_unsigNED" };
