...
public class InvalidObjRefs {
    ...
    public static final Class[] CLASSES = { InvalidObjRef1.class, InvalidObjRef2.class, InvalidObjRef3.class, InvalidObjRef4.class, InvalidObjRef5.class,
            InvalidObjRef6.class, InvalidObjRef7.class, InvalidObjRef8.class };
