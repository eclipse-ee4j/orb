...
import org.glassfish.corba.idl.SymtabFactory;
 ...
 **/
public class Compile extends org.glassfish.corba.idl.Compile
{
 /**
  *
  **/
  ...
  private void preParse()
  {
    ...
    Util.setPackageTranslation(((org.glassfish.corba.idl.toJavaPortable.Arguments) arguments).packageTranslation) ;
    ...
    while (elements.hasMoreElements ())
    {
      ...
      else if (element instanceof StructEntry)
      {
        ...
        while (members.hasMoreElements ())
          Util.fillInfo(members.nextElement());
      }
  ...
  protected void preEmitSTElement (SymtabEntry entry)
  {
    ...
    Hashtable<String, String> packages = ((org.glassfish.corba.idl.toJavaPortable.Arguments)arguments).packages;
    if (packages.size () > 0)
    {
