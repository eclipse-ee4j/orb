...
public class Preprocessor
{
  ...
  private void constExpr () throws IOException, ParseException
  {
    ...
    org.glassfish.corba.idl.constExpr.Expression boolExpr = booleanConstExpr (dummyEntry);
   ...
   *
   **/
  org.glassfish.corba.idl.constExpr.Expression booleanConstExpr (SymtabEntry entry) throws IOException, ParseException
  {
    ...
    catch (org.glassfish.corba.idl.constExpr.EvaluationException e)
    {
  ...
  private org.glassfish.corba.idl.constExpr.Expression orExpr (org.glassfish.corba.idl.constExpr.Expression e, SymtabEntry entry) throws IOException, ParseException
  {
    ...
    {
      match (token.type);
      org.glassfish.corba.idl.constExpr.BooleanOr or = parser.exprFactory.booleanOr (e, null);
      or.rep (e.rep () + " || ");
  ...
  private org.glassfish.corba.idl.constExpr.Expression andExpr (org.glassfish.corba.idl.constExpr.Expression e, SymtabEntry entry) throws IOException, ParseException
  {
    ...
    {
      match (token.type);
      org.glassfish.corba.idl.constExpr.BooleanAnd and = parser.exprFactory.booleanAnd (e, null);
      and.rep (e.rep () + " && ");
   ...
   *
   **/
  private org.glassfish.corba.idl.constExpr.Expression notExpr (/*boolean alreadySawExclamation, */SymtabEntry entry) throws IOException, ParseException
  {
    org.glassfish.corba.idl.constExpr.Expression e;
    if (token.equals (Token.Exclamation))
    {
      match (Token.Exclamation);
      e = parser.exprFactory.booleanNot (definedExpr (entry));
      e.rep ("!" + ((org.glassfish.corba.idl.constExpr.BooleanNot)e).operand ().rep ());
    }
    else
      e = definedExpr (entry);
    return e;
   ...
   *
   **/
  private org.glassfish.corba.idl.constExpr.Expression definedExpr (SymtabEntry entry) throws IOException, ParseException
  {
   ...
   *
   **/
  private org.glassfish.corba.idl.constExpr.Expression equalityExpr (org.glassfish.corba.idl.constExpr.Expression e, SymtabEntry entry) throws IOException, ParseException
  {
    if (e == null)
    {
    ...
    else
    {
      org.glassfish.corba.idl.constExpr.BinaryExpr b = (org.glassfish.corba.idl.constExpr.BinaryExpr)e;
      parser.token = token; // Since parser to parse, give it this token
      org.glassfish.corba.idl.constExpr.Expression constExpr = parser.constExp (entry);
      token = parser.token; // Since parser last parsed, get its token
      b.right (constExpr);
      e.rep (e.rep () + b.right ().rep ());
    }
    ...
    {
      match (token.type);
      org.glassfish.corba.idl.constExpr.Equal eq = parser.exprFactory.equal (e, null);
      eq.rep (e.rep () + " == ");
    ...
    {
      match (token.type);
      org.glassfish.corba.idl.constExpr.NotEqual n = parser.exprFactory.notEqual (e, null);
      n.rep (e.rep () + " != ");
    ...
    {
      match (token.type);
      org.glassfish.corba.idl.constExpr.GreaterThan g = parser.exprFactory.greaterThan (e, null);
      g.rep (e.rep () + " > ");
    ...
    {
      match (token.type);
      org.glassfish.corba.idl.constExpr.GreaterEqual g = parser.exprFactory.greaterEqual (e, null);
      g.rep (e.rep () + " >= ");
      return equalityExpr (g, entry);
    }
    ...
    {
      match (token.type);
      org.glassfish.corba.idl.constExpr.LessThan l = parser.exprFactory.lessThan (e, null);
      l.rep (e.rep () + " < ");
    ...
    {
      match (token.type);
      org.glassfish.corba.idl.constExpr.LessEqual l = parser.exprFactory.lessEqual (e, null);
      l.rep (e.rep () + " <= ");
      return equalityExpr (l, entry);
    }
    else
   ...
   *
   **/
  org.glassfish.corba.idl.constExpr.Expression primaryExpr (SymtabEntry entry) throws IOException, ParseException
  {
  ...
  private void otherPragmas (String pragmaType, String currentToken) throws IOException
  {
    ...
    {
      PragmaHandler handler = pragmaHandlers.elementAt (i);
   ...
   *
   **/
  private Vector<String> getParmValues () throws IOException, ParseException
  {
  ...
  private void macroParmValues(Vector<String> values) throws IOException, ParseException
  {
  ...
  private void macro (Vector<String> parmNames) throws IOException, ParseException
  {
    match (token.type);
    match (Token.LeftParen);
  ...
  private void macroParms (Vector<String> parmNames) throws IOException, ParseException
  {
    if (!token.equals (Token.RightParen))
    {
  ...
  private void macroParms2 (Vector<String> parmNames) throws IOException, ParseException
  {
    while (!token.equals (Token.RightParen))
    {
      match (Token.Comma);
