 ...
 **/
public class StringGen implements org.glassfish.corba.idl.StringGen, JavaGenerator
{
  /**
  ...
  public int type (int index, String indent, org.glassfish.corba.idl.toJavaPortable.TCOffsets tcoffsets, String name, SymtabEntry entry, PrintWriter stream) {
    ...
    if (stringEntry.maxSize () == null)
      ...
      bound = org.glassfish.corba.idl.toJavaPortable.Util.parseExpression(stringEntry.maxSize());
  ...
  public int read (int index, String indent, String name, SymtabEntry entry, PrintWriter stream)
  {
    ...
    {
      stream.println (indent + "if (" + name + ".length () > (" + org.glassfish.corba.idl.toJavaPortable.Util.parseExpression(string.maxSize()) + "))");
  ...
  public int write (int index, String indent, String name, SymtabEntry entry, PrintWriter stream)
  {
    ...
    if (string.maxSize () != null)
    {
      stream.print (indent + "if (" + name + ".length () > (" + org.glassfish.corba.idl.toJavaPortable.Util.parseExpression(string.maxSize()) + "))");
      stream.println (indent + "  throw new org.omg.CORBA.MARSHAL (0, org.omg.CORBA.CompletionStatus.COMPLETED_MAYBE);");
    }
    String entryName = entry.name ();
    if (entryName.equals ("string"))
