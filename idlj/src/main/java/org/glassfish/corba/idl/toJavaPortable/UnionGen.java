...
import org.glassfish.corba.idl.UnionBranch;
import org.glassfish.corba.idl.UnionEntry;

import org.glassfish.corba.idl.constExpr.Expression;
import org.glassfish.corba.idl.constExpr.EvaluationException;

/**
 *
 **/
public class UnionGen implements org.glassfish.corba.idl.UnionGen, org.glassfish.corba.idl.toJavaPortable.JavaGenerator
{
  /**
  ...
  protected void init ()
  {
    utype       = org.glassfish.corba.idl.toJavaPortable.Util.typeOf(u.type());
  ...
  {
    stream = org.glassfish.corba.idl.toJavaPortable.Util.stream(u, ".java");
  } // openStream
  ...
  {
    ((Factories) org.glassfish.corba.idl.toJavaPortable.Compile.compiler.factories ()).helper ().generate (symbolTable, u);
  } // generateHelper
  ...
  {
   ((Factories) org.glassfish.corba.idl.toJavaPortable.Compile.compiler.factories ()).holder ().generate (symbolTable, u);
  } // generateHolder
  ...
  protected void writeHeading ()
  {
    ...
    if (unionIsEnum)
      typePackage = org.glassfish.corba.idl.toJavaPortable.Util.javaQualifiedName(utype) + '.';
    else
      typePackage = "";

    org.glassfish.corba.idl.toJavaPortable.Util.writePackage(stream, u);
  ...
  protected void writeBody ()
  {
    ...
    while (e.hasMoreElements ())
    {
      ...
      org.glassfish.corba.idl.toJavaPortable.Util.fillInfo(branch.typedef);
      ...
      stream.println ("  private " + org.glassfish.corba.idl.toJavaPortable.Util.javaName(branch.typedef) + " ___" + branch.typedef.name () + ";");
      ++i;
    }
    stream.println ("  private " + org.glassfish.corba.idl.toJavaPortable.Util.javaName(utype) + " __discriminator;");
    ...
    // Write discriminator
    stream.println ();
    stream.println ("  public " + org.glassfish.corba.idl.toJavaPortable.Util.javaName(utype) + " " + safeName (u, "discriminator") + " ()");
    stream.println ("  {");
    ...
    if (u.defaultBranch () == null && !coversAll (u))
    {
      ...
      stream.println ();
      stream.println ("  public void _default (" + org.glassfish.corba.idl.toJavaPortable.Util.javaName(utype) +
        " discriminator)");
      stream.println ("  {");
  ...
  private void writeVerifyDefault()
  {
    ...
    stream.println( "" ) ;
    stream.println( "  private void verifyDefault( " + org.glassfish.corba.idl.toJavaPortable.Util.javaName(utype) +
        " value )" ) ;
    stream.println( "  {" ) ;
  ...
  private String defaultDiscriminator (UnionEntry u)
  {
    ...
    String ret = null;
    SymtabEntry utype = org.glassfish.corba.idl.toJavaPortable.Util.typeOf(u.type());
  ...
  private Vector vectorizeLabels (Vector branchVector, boolean useIntsForEnums )
  {
    ...
    while (branches.hasMoreElements ())
    {
      ...
      while (labels.hasMoreElements ())
      {
        ...
        if (unionIsEnum)
          if (useIntsForEnums)
            str = typePackage + "_" + org.glassfish.corba.idl.toJavaPortable.Util.parseExpression(expr) ;
          else
            str = typePackage + org.glassfish.corba.idl.toJavaPortable.Util.parseExpression(expr) ;
        else
          str = org.glassfish.corba.idl.toJavaPortable.Util.parseExpression(expr) ;
  ...
  private void writeBranchMethods (PrintWriter stream, UnionEntry u, UnionBranch branch, int i)
  {
    ...
    stream.println ("  public " + org.glassfish.corba.idl.toJavaPortable.Util.javaName(branch.typedef) + " " + branch.typedef.name () + " ()");
    stream.println ("  {");
    stream.println ("    if (__uninitialized)");
    stream.println ("      throw new org.omg.CORBA.BAD_OPERATION ();");
    ...
    stream.println ("  public void " + branch.typedef.name () + " (" + org.glassfish.corba.idl.toJavaPortable.Util.javaName(branch.typedef) + " value)");
    stream.println ("  {");
    ...
    else
    {
      ...
      if (unionIsEnum)
        stream.println ("    __discriminator = " + typePackage + org.glassfish.corba.idl.toJavaPortable.Util.parseExpression((Expression) branch.labels.firstElement()) + ";");
      else
    ...
    if (branch.labels.size () > 0 || branch.isDefault)
    {
      ...
      stream.println ("  public void " + branch.typedef.name () + " (" + org.glassfish.corba.idl.toJavaPortable.Util.javaName(utype) + " discriminator, " + org.glassfish.corba.idl.toJavaPortable.Util.javaName(branch.typedef) + " value)");
      stream.println ("  {");
    ...
    // Write verifyXXX
    stream.println ();
    stream.println ("  private void verify" + branch.typedef.name () + " (" + org.glassfish.corba.idl.toJavaPortable.Util.javaName(utype) + " discriminator)");
    stream.println ("  {");
          ...
          if (b != branch)
          {
            ...
            while (eLabels.hasMoreElements ())
            {
              ...
              if (!onlyOne)
                stream.print (" || ");
              if (unionIsEnum)
                stream.print ("discriminator == " + typePackage + org.glassfish.corba.idl.toJavaPortable.Util.parseExpression(label));
              else
                stream.print ("discriminator == " + org.glassfish.corba.idl.toJavaPortable.Util.parseExpression(label));
              onlyOne = false;
            }
          }
        }
  ...
  public int helperType (int index, String indent, org.glassfish.corba.idl.toJavaPortable.TCOffsets tcoffsets,
    String name, SymtabEntry entry, PrintWriter stream)
  {
    org.glassfish.corba.idl.toJavaPortable.TCOffsets innerOffsets = new org.glassfish.corba.idl.toJavaPortable.TCOffsets();
    ...
    index = ((org.glassfish.corba.idl.toJavaPortable.JavaGenerator)u.type ().generator ()).type (index + 1, indent,
    ...
    innerOffsets = new org.glassfish.corba.idl.toJavaPortable.TCOffsets();
    ...
    for (int i = 0; i < u.branches ().size (); ++i) {
        ...
        String memberName = org.glassfish.corba.idl.toJavaPortable.Util.stripLeadingUnderscores(member.name());
        ...
        if (labels.isEmpty()) {
            ...
            index = ((org.glassfish.corba.idl.toJavaPortable.JavaGenerator)member.generator ()).type (index, indent, innerOffsets, tcOfMembers, member, stream);
            ...
            while (enumeration.hasMoreElements()) {
                ...
                String elem = org.glassfish.corba.idl.toJavaPortable.Util.parseExpression(expr) ;
                ...
                if (utype instanceof PrimitiveEntry)
                    ...
                    org.glassfish.corba.idl.toJavaPortable.Util.collapseName(utype.name()) + " ((" + org.glassfish.corba.idl.toJavaPortable.Util.javaName(utype) +
                        ')' + elem + ");");
                else { // it must be enum
                    String enumClass = org.glassfish.corba.idl.toJavaPortable.Util.javaName(utype);
                    stream.println (indent + org.glassfish.corba.idl.toJavaPortable.Util.helperName(utype, false) + ".insert (" +
    ...
    stream.println (indent + name + " = org.omg.CORBA.ORB.init ().create_union_tc (" + 
        org.glassfish.corba.idl.toJavaPortable.Util.helperName(u, true) + ".id (), \"" + entry.name () + "\", " +
        discTypeCode + ", " + membersName + ");"); 
    return index;
  } // helperType

    @Override
    public int type (int index, String indent, org.glassfish.corba.idl.toJavaPortable.TCOffsets tcoffsets, String name,
                     SymtabEntry entry, PrintWriter stream)
    {
        stream.println (indent + name + " = " + org.glassfish.corba.idl.toJavaPortable.Util.helperName(entry, true) + ".type ();");
        return index;
    } 
        ...
        SymtabEntry entry, PrintWriter stream)
    {
        ...
        SymtabEntry utype = org.glassfish.corba.idl.toJavaPortable.Util.typeOf(u.type());
        org.glassfish.corba.idl.toJavaPortable.Util.writeInitializer(indent, disName, "", utype, stream);

        if (utype instanceof PrimitiveEntry)
            index = ((org.glassfish.corba.idl.toJavaPortable.JavaGenerator)utype.generator ()).read (index, indent, disName, utype, stream);
        else
            stream.println (indent + disName + " = " + org.glassfish.corba.idl.toJavaPortable.Util.helperName(utype, true) + ".read (istream);");
        ...
        String name, UnionEntry u, PrintWriter stream)
    {
        ...
        stream.println (indent + '{');
        String typePackage = org.glassfish.corba.idl.toJavaPortable.Util.javaQualifiedName(utype) + '.';
        ...
        while (e.hasMoreElements ()) {
            ...
            while (labels.hasMoreElements ()) {
                ...
                if (utype instanceof EnumEntry) {
                    String key = org.glassfish.corba.idl.toJavaPortable.Util.parseExpression(label);
    ...
    private int readBranch (int index, String indent, String name, String disName, TypedefEntry entry, PrintWriter stream)
    {
        ...
        org.glassfish.corba.idl.toJavaPortable.Util.writeInitializer(indent, '_' + name, "", entry, stream);

        if (!entry.arrayInfo ().isEmpty () || 
            type instanceof SequenceEntry || 
            type instanceof PrimitiveEntry || 
            type instanceof StringEntry) {
            index = ((org.glassfish.corba.idl.toJavaPortable.JavaGenerator)entry.generator ()).read (index, indent, '_' + name, entry, stream);
        } else {
            stream.println (indent + '_' + name + " = " + org.glassfish.corba.idl.toJavaPortable.Util.helperName(type, true) + ".read (istream);");
        }
  ...
  public int write (int index, String indent, String name, SymtabEntry entry, PrintWriter stream)
  {
    ...
    SymtabEntry utype = org.glassfish.corba.idl.toJavaPortable.Util.typeOf(u.type());
    if (utype instanceof PrimitiveEntry)
      index = ((org.glassfish.corba.idl.toJavaPortable.JavaGenerator)utype.generator ()).write (index, indent, name + ".discriminator ()", utype, stream);
    else
      stream.println (indent + org.glassfish.corba.idl.toJavaPortable.Util.helperName(utype, true) + ".write (ostream, " + name + ".discriminator ());"); // <d61056>
    if (utype.name ().equals ("boolean"))
  ...
  private int writeBranch (int index, String indent, String name, TypedefEntry entry, PrintWriter stream)
  {
    ...
    if (!entry.arrayInfo ().isEmpty () || type instanceof SequenceEntry || type instanceof PrimitiveEntry || type instanceof StringEntry)
      index = ((org.glassfish.corba.idl.toJavaPortable.JavaGenerator)entry.generator ()).write (index, indent, name + '.' + entry.name () + " ()", entry, stream);
    else
      stream.println (indent + org.glassfish.corba.idl.toJavaPortable.Util.helperName(type, true) + ".write (ostream, " + name + '.' + entry.name () + " ());"); // <d61056>
    return index;
  } // writeBranch
  ...
  {
    String ret = org.glassfish.corba.idl.toJavaPortable.Util.parseExpression(expr);
