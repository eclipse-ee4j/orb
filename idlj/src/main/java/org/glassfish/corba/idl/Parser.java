...
class Parser
{
  ...
  Parser (Preprocessor preprocessor, Arguments arguments, Hashtable overrides,
          Hashtable symtab, SymtabFactory stFac, org.glassfish.corba.idl.constExpr.ExprFactory exprFac, String [] genKeywords)
  {
  ...
  private void valueBox (ModuleEntry module, String name) throws IOException, ParseException
  {
    ...
    //   ParseException.badAbstract (scanner, entry.fullName());
    SymtabEntry valueForward = Parser.symbolTable.get(entry.fullName());
  ...
  private boolean hasArrayInfo (SymtabEntry entry)
  {
    ...
    {
      if (!((TypedefEntry)entry).arrayInfo ().isEmpty())
        return true;
      entry = entry.type ();
    }
  return false;
   ...
   *
   **/
  private void verifyConstType (org.glassfish.corba.idl.constExpr.Expression e, SymtabEntry t)
  {
   ...
   *
   **/
  private void verifyString (org.glassfish.corba.idl.constExpr.Expression e, SymtabEntry t)
  {
    ...
    if (!(t instanceof StringEntry)) {
        ...
        org.glassfish.corba.idl.constExpr.Expression maxExp = ((StringEntry)t).maxSize ();
        try {
   ...
   *
   **/
  private void verifyCharacter (org.glassfish.corba.idl.constExpr.Expression e, SymtabEntry t)
  {
   ...
   *
   **/
  org.glassfish.corba.idl.constExpr.Expression constExp (SymtabEntry entry) throws IOException, ParseException
  {
    // Parse the expression.
    org.glassfish.corba.idl.constExpr.Expression expr = orExpr (null, entry);
    ...
    try
    {
      ...
      if (expr instanceof org.glassfish.corba.idl.constExpr.Terminal &&
    ...
    catch (org.glassfish.corba.idl.constExpr.EvaluationException exception)
    {
   ...
   *
   **/
  private org.glassfish.corba.idl.constExpr.Expression orExpr (org.glassfish.corba.idl.constExpr.Expression e, SymtabEntry entry) throws IOException, ParseException
  {
    if (e == null)
      e = xorExpr (null, entry);
    else
    {
      org.glassfish.corba.idl.constExpr.BinaryExpr b = (org.glassfish.corba.idl.constExpr.BinaryExpr)e;
    ...
    {
      match (token.type);
      org.glassfish.corba.idl.constExpr.Or or = exprFactory.or (e, null);
   ...
   *
   **/
  private org.glassfish.corba.idl.constExpr.Expression xorExpr (org.glassfish.corba.idl.constExpr.Expression e, SymtabEntry entry) throws IOException, ParseException
  {
    if (e == null)
    ...
    {
      match (token.type);
      org.glassfish.corba.idl.constExpr.Xor xor = exprFactory.xor (e, null);
      xor.rep (e.rep () + " ^ ");
   ...
   *
   **/
  private org.glassfish.corba.idl.constExpr.Expression andExpr (org.glassfish.corba.idl.constExpr.Expression e, SymtabEntry entry) throws IOException, ParseException
  {
    if (e == null)
    ...
    {
      match (token.type);
      org.glassfish.corba.idl.constExpr.And and = exprFactory.and (e, null);
      and.rep(e.rep () + " & ");
   ...
   *
   **/
  private org.glassfish.corba.idl.constExpr.Expression shiftExpr (org.glassfish.corba.idl.constExpr.Expression e, SymtabEntry entry) throws IOException, ParseException
  {
    if (e == null)
    ...
    {
      match (token.type);
      org.glassfish.corba.idl.constExpr.ShiftLeft sl = exprFactory.shiftLeft (e, null);
    ...
    {
      match (token.type);
      org.glassfish.corba.idl.constExpr.ShiftRight sr = exprFactory.shiftRight (e, null);
   ...
   *
   **/
  private org.glassfish.corba.idl.constExpr.Expression addExpr (org.glassfish.corba.idl.constExpr.Expression e, SymtabEntry entry) throws IOException, ParseException
  {
    if (e == null)
    ...
    {
      match (token.type);
      org.glassfish.corba.idl.constExpr.Plus p = exprFactory.plus (e, null);
    ...
    {
      match (token.type);
      org.glassfish.corba.idl.constExpr.Minus m = exprFactory.minus (e, null);
   ...
   *
   **/
  private org.glassfish.corba.idl.constExpr.Expression multExpr (org.glassfish.corba.idl.constExpr.Expression e, SymtabEntry entry) throws IOException, ParseException
  {
    if (e == null)
    e = unaryExpr (entry);
    else
    ...
    {
      match (token.type);
      org.glassfish.corba.idl.constExpr.Times t = exprFactory.times (e, null);
    ...
    {
      match (token.type);
      org.glassfish.corba.idl.constExpr.Divide d = exprFactory.divide (e, null);
    ...
    {
      match (token.type);
      org.glassfish.corba.idl.constExpr.Modulo m = exprFactory.modulo (e, null);
      m.type (entry.typeName ());
      m.rep (e.rep () + " % ");
   ...
   *
   **/
  private org.glassfish.corba.idl.constExpr.Expression unaryExpr (SymtabEntry entry) throws IOException, ParseException
  {
    if (token.equals (Token.Plus))
    {
      match (token.type);
      org.glassfish.corba.idl.constExpr.Expression e   = primaryExpr (entry);
      org.glassfish.corba.idl.constExpr.Positive pos = exprFactory.positive (e);
    ...
    if (token.equals (Token.Minus))
    {
      match (token.type);
      org.glassfish.corba.idl.constExpr.Expression e   = primaryExpr (entry);
      org.glassfish.corba.idl.constExpr.Negative neg = exprFactory.negative (e);
    ...
    if (token.equals (Token.Tilde))
    {
      match (token.type);
      org.glassfish.corba.idl.constExpr.Expression e   = primaryExpr (entry);
      org.glassfish.corba.idl.constExpr.Not not = exprFactory.not (e);
   ...
   *
   **/
  private org.glassfish.corba.idl.constExpr.Expression primaryExpr (SymtabEntry entry)
      throws IOException, ParseException
  {
    org.glassfish.corba.idl.constExpr.Expression primary = null;
  ...
  org.glassfish.corba.idl.constExpr.Expression literal (SymtabEntry entry) throws IOException, ParseException
  {
    String     string  = token.name;
    org.glassfish.corba.idl.constExpr.Expression literal = null;
    switch (token.type)
    {
      case Token.IntegerLiteral:
  ...
  @SuppressWarnings("ThrowableResultOfMethodCallIgnored")
  private org.glassfish.corba.idl.constExpr.Terminal booleanLiteral() throws IOException, ParseException {
    Boolean bool;
    switch ( token.name ) {
      case "TRUE":
        bool = true;
   ...
   *
   **/
  private org.glassfish.corba.idl.constExpr.Expression stringLiteral () throws IOException, ParseException
  {
    ...
    org.glassfish.corba.idl.constExpr.Expression stringExpr = exprFactory.terminal (literal, isWide );
   ...
   *
   **/
  private org.glassfish.corba.idl.constExpr.Expression positiveIntConst (SymtabEntry entry) throws IOException, ParseException
  {
    org.glassfish.corba.idl.constExpr.Expression e     = constExp (entry);
    Object     value = e.value ();
...
//!!!      ((com.sun.tools.corba.ee.idl.IDLID)repIDStack.peek ()).appendToName (name);
  ...
  private void caseLabel (UnionEntry entry, UnionBranch branch) throws IOException, ParseException
  {
    if (token.type == Token.Case)
    {
      ...
      org.glassfish.corba.idl.constExpr.Expression label;
   ...
   *
   **/
  private org.glassfish.corba.idl.constExpr.Expression matchEnum (EnumEntry entry) throws IOException, ParseException
  {
   ...
   *
   **/
  private org.glassfish.corba.idl.constExpr.Expression stringType2 (SymtabEntry entry) throws IOException, ParseException
  {
...
());
      tmpEntry.sourceFile (scanner.fileEntry ());
      tmpEntry.type (qualifiedEntry ("long"));
      org.glassfish.corba.idl.constExpr.Expression maxSize = positiveIntConst (tmpEntry);
  ...
  private void fixedArraySize (TypedefEntry entry) throws IOException, ParseException
  {
    ...
    tmpEntry.type (qualifiedEntry ("long"));
    org.glassfish.corba.idl.constExpr.Expression expr = positiveIntConst (tmpEntry);
  ...
  */
  ...
  private     boolean       verbose;
              ...
              org.glassfish.corba.idl.constExpr.ExprFactory exprFactory;
