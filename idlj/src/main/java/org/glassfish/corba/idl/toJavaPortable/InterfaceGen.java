 ...
 *
 **/
public class InterfaceGen implements org.glassfish.corba.idl.InterfaceGen, JavaGenerator
{
  /**
    ...
    if (!isPseudo(i))
    {
      ...
      if (! (i.isLocalSignature())) {
          ...
          if (! (i.isLocal())) {
              ...
              org.glassfish.corba.idl.toJavaPortable.Arguments theArguments = (org.glassfish.corba.idl.toJavaPortable.Arguments) org.glassfish.corba.idl.toJavaPortable.Compile.compiler.arguments;
  ...
  protected void init ()
  {
    emit = ((org.glassfish.corba.idl.toJavaPortable.Arguments) org.glassfish.corba.idl.toJavaPortable.Compile.compiler.arguments).emit;
  ...
  protected void generateSkeleton ()
  {
    ...
    if (emit != org.glassfish.corba.idl.toJavaPortable.Arguments.Client)
      factories.skeleton ().generate (symbolTable, i);
  } // generateSkeleton
  ...
  protected void generateStub ()
  {
    ...
    if (emit != org.glassfish.corba.idl.toJavaPortable.Arguments.Server /* && !i.isAbstract () */)
  ...
  {
    if (emit != org.glassfish.corba.idl.toJavaPortable.Arguments.Server)
  ...
  protected void openStream ()
  {
    if (i.isAbstract () || intfType == SIGNATURE)
       stream = org.glassfish.corba.idl.toJavaPortable.Util.stream(i, ".java");
    else if (intfType == OPERATIONS)
       stream = org.glassfish.corba.idl.toJavaPortable.Util.stream(i, "Operations.java");
  } // openStream
  ...
  {
    org.glassfish.corba.idl.toJavaPortable.Util.writePackage (stream, i, org.glassfish.corba.idl.toJavaPortable.Util.TypeFile);
  ...
  public int helperType (int index, String indent, org.glassfish.corba.idl.toJavaPortable.TCOffsets tcoffsets, String name, SymtabEntry entry, PrintWriter stream)
  {
    ...
    if (entry.fullName ().equals ("org/omg/CORBA/Object"))
      ...
      stream.println (indent + name
          // <54697>
          //+ " = org.omg.CORBA.ORB.init ().create_interface_tc (_id, "
          + " = org.omg.CORBA.ORB.init ().create_interface_tc (" + org.glassfish.corba.idl.toJavaPortable.Util.helperName(i, true) + ".id (), " // <d61056>
  ...
  */
  public int read (int index, String indent, String name, SymtabEntry entry, PrintWriter stream)
  {
    ...
    if (entry.fullName ().equals ("org/omg/CORBA/Object"))
      ...
      stream.println (indent + name + " = " + org.glassfish.corba.idl.toJavaPortable.Util.helperName(entry, false) + ".narrow (istream.read_Object (_" + i.name () + "Stub.class));"); // <d61056>
    return index;
  } // read
