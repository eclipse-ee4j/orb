 ...
 *
 **/
public class PrimitiveGen implements org.glassfish.corba.idl.PrimitiveGen, JavaGenerator
{
  /**
  ...
  {
    stream.println (indent + name + " = " + "istream.read_" + org.glassfish.corba.idl.toJavaPortable.Util.collapseName(entry.name()) + " ();");
    return index;
  } // read

  public int write (int index, String indent, String name, SymtabEntry entry, PrintWriter stream)
  {
    stream.println (indent + "ostream.write_" + org.glassfish.corba.idl.toJavaPortable.Util.collapseName(entry.name()) + " (" + name + ");");
    return index;
  } // write
