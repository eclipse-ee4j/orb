...
public class TCOffsets {
    ...
    /**
     * Return the full length of the string type: 4 byte length, x bytes for string + 1 for the null terminator, align it so
     * it ends on a 4-byte boundary. This method assumes the string starts at a 4-byte boundary since it doesn't do any
     * leading alignment.
     **/
