...
public abstract class Expression {
     ...
     * @return the value of number coerced to the (target) type of this expression.
     **/
    ...
    /**
     * Coerces an integral value (BigInteger) to its corresponding unsigned representation, if the target type of this
     * expression is unsigned.
     *
     * @param b The BigInteger to be coerced.
     * @return the value of an integral type coerced to its corresponding unsigned integral type, if the target type of this
     * expression is unsigned.
     **/
    ...
    /**
     * Coerces an integral value (BigInteger) to its corresponding signed representation, if the target type of this
     * expression is signed.
     *
     * @param b The BigInteger to be coerced.
     * @return the value of an integral type coerced to its corresponding signed integral type, if the target type of this
     * expression is signed.
     **/
