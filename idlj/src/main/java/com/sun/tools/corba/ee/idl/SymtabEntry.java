...
public class SymtabEntry {
    ...
    /**
     * Other variables besides the default ones can be dynamically placed into SymTabEntry (and therefore on all symbol
     * table entries) by extenders. Before such a variable can exist, its key must be obtained by calling getVariableKey.
     */
    ...
    /**
     * Other variables besides the default ones can be dynamically placed into SymTabEntry (and therefore on all symbol
     * table entries) by extenders. This method assigns the value to the variable of the given key. A valid key must be
     * obtained by calling the method getVariableKey. If the key is invalid, NoSuchFieldException is thrown.
     */
    ...
    /**
     * Other variables besides the default ones can be dynamically placed into SymTabEntry (and therefore on all symbol
     * table entries) by extenders. This method gets the value of the variable of the given key. A valid key must be
     * obtained by calling the method getVariableKey. If the key is invalid, NoSuchFieldException is thrown.
     */
    ...
    /**
     * Invoke a generator. A call to this method is only meaningful for subclasses of SymtabEntry. If called on this class,
     * it is a no-op.
     *
    ...
    /**
     * Access a generator. A call to this method is only meaningful for subclasses of SymtabEntry. If called on this class,
     * it is a no-op.
     *
...
/*
 * ======================================================================================= DATE<AUTHOR> ACTION
 * --------------------------------------------------------------------------------------- 21jul1997<daz> Added _comment
 * data member to afford transferring comments from source file to target; added acessor methods for comment.
 * =======================================================================================
 */
