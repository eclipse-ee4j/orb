...
//      + "_id, \"" <54697>
                + com.sun.tools.corba.ee.idl.toJavaPortable.Util.stripLeadingUnderscores(entry.name()) + "\", " + new String(emit) + ");");
        return index + 1;
...
/*
 * ============================================================================ DATE<AUTHOR> ACTION
 * ---------------------------------------------------------------------------- 31jul1997<daz> Modified to write comment
 * immediately preceding class defining enumeration declaration. 12dec1998<klr> D55971 - omg 98-11-03 Java 2.4 RTF -
 * make subclassable ===========================================================================
 */
