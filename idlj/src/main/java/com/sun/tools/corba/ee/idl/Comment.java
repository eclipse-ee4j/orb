...
public class Comment {
    ...
    /**
     * Writes comment to the specified print stream without altering its format. This routine does not alter vertical or
     * horizontal spacing of comment text, thus, it only works well for comments with a non-indented first line.
     */
    ...
    /*
     * The following routines print formatted comments of differing styles. Each routine will alter the horizontal spacing
     * of the comment text, but not the vertical spacing.
     */
...
/*
 * ================================================================================== DATE<AUTHOR> ACTION
 * ---------------------------------------------------------------------------------- 11aug1997<daz> Initial version
 * completed. 18aug1997<daz> Modified generate to write comment unformatted.
 * ==================================================================================
 */
