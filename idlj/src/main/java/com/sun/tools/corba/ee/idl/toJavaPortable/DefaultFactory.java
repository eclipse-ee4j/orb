...
public class DefaultFactory implements AuxGen {
    ...
    /**
     * Generate the default value factory class. Provides general algorithm for auxiliary binding generation: 1.) Initialize
     * symbol table and symbol table entry members, common to all generators. 2.) Initialize members unique to this
     * generator. 3.) Open print stream 4.) Write class heading (package, prologue, source comment, class statement, open
     * curly 5.) Write class body (member data and methods) 6.) Write class closing (close curly) 7.) Close the print stream
     **/
    ...
    protected void writeHeading() {
        com.sun.tools.corba.ee.idl.toJavaPortable.Util.writePackage(stream, entry, com.sun.tools.corba.ee.idl.toJavaPortable.Util.TypeFile); // REVISIT - same
                                                                                                                                             // as interface?
