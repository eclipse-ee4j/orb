...
public class Util {
     ...
     *
     * @return the version number contained within the appropriate properties file, which indicates the build of this IDL
     * Parser Framework.
     **/
     ...
     * framework has been initialized. If the framework is initialized, the version information is extracted from the
     * message properties object; otherwise, it is extracted from the indicated messages file.
     *
    ...
    /**
     * Searches the current user directory and a list of directories for a given short file name and returns its absolute
     * file specification.
     *
     * @return Absolute file name of a given short filename
     * @throws FileNotFoundException The file does not exist in the current user or specified directories.
