 ...
 * <br>
 *
 * java Compile [options] &lt;idl file&gt; <br>
 * <br>
 *
 * where &lt;idl file&gt; is the name of a file containing IDL definitions, and [options] is any combination of the
 * options listed below. The options may appear in any order. <br>
 * <br>
 *
 * Options:
 * <dl>
 * <dt>-i &lt;include path&gt;
 * <dd>By default, the current directory is scanned for included files. This option adds another directory. See also the
 * note below.
 *
 * <dt>-d &lt;symbol&gt;
 ...
 *
 * <dt>-f&lt;side&gt;
 * <dd>Defines what bindings to emit. &lt;side&gt; is one of client, server, all, serverTIE, allTIE. serverTIE and
 * allTIE cause delegate model skeletons to be emitted. If this flag is not used, -fclient is assumed. allPOA has the
 * same effect as all, except for generation POA type skeletons.
 *
 * <dt>-keep
 * <dd>If a file to be generated already exists, do not overwrite it. By default it is overwritten.
 *
 * <dt>-sep &lt;string&gt;
 * <dd>Only valid with -m. Replace the file separator character with &lt;string&gt; in the file names listed in the .u
 * file.
 *
 * <dt>-emitAll
 ...
 * <dd>Whereever &lt;type&gt; is encountered, make sure it resides within &lt;package&gt; in all generated files.
 * &lt;type&gt; is a fully qualified, java-style name.
 * </dl>
 *
 * <B>Note:</B> If you have an include path or paths that you will always be using, it can get tedious putting these on
 * the command with the -i option all the time. Instead, these can be placed into a config file called idl.config. This
 * file must be in the CLASSPATH. The format of the includes line is:
 *
 * <pre>
...
public class Compile extends com.sun.tools.corba.ee.idl.Compile {
    ...
    private void preParse() {
        ...
        com.sun.tools.corba.ee.idl.toJavaPortable.Util
                .setPackageTranslation(((com.sun.tools.corba.ee.idl.toJavaPortable.Arguments) arguments).packageTranslation);
