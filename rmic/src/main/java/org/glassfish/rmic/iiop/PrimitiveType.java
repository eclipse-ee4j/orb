 ...
 * <p>
 * The static forPrimitive(...) method must be used to obtain an instance, and will return null if the type is
 * non-conforming.
 *
 * @author Bryan Atsatt
 */
public class PrimitiveType extends Type {
     ...
     *
     * If the type is not a properly formed or if some other error occurs, the return value will be null, and errors will
