 ...
 * <p>
 * The static forRemote(...) method must be used to obtain an instance, and will return null if the ClassDefinition is
 * non-conforming.
 *
 * @author Bryan Atsatt
 */
public class RemoteType extends InterfaceType {
    ...
    /**
     * Check to ensure that the interface and all it's methods and arguments conforms to the RMI/IDL java subset for remote
     * interfaces as defined by the "Java to IDL Mapping" specification, section 4.
     *
     * @param directInterfaces All directly implmented interfaces will be added to this list.
     * @param directMethods All directly implemented methods (other than constructors and initializers) will be added to
     * this list.
     * @param directConstants All constants defined by theInterface will be added to this list.
     * @param quiet True if should not report constraint failures.
     * @return true if constraints satisfied, false otherwise.
     */
    private boolean isConformingRemoteInterface(Vector directInterfaces, Vector directMethods, Vector directConstants, boolean quiet, ContextStack stack) {
