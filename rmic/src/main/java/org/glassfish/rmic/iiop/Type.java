...
/**
 * Type is an abstract base class for a family of types which provide conformance checking and name mapping as defined
 * in the "Java to IDL Mapping" OMG specification. The family is composed of the following fixed set of types:
 *
 * <pre>
 * {@literal
 *
 ...
 * java.rmi.Remote.
 * <p>
 * ImplementationType represents any non-special class which implements one or more interfaces which inherit from
 * java.rmi.Remote.
 * <p>
...
public abstract class Type implements org.glassfish.rmic.iiop.Constants, ContextElement, Cloneable {
    ...
    /**
     * Return the package of this type (e.g. com.acme.Dynamite would return "com.acme"). Will return null if default package
     * or if this type is a primitive.
     */
    ...
    /**
     * IDL_Naming Return the IDL module name for this type (e.g. com.acme.Dynamite would return a three element array of
     * {"com","acme"). May be a zero length array if there is no module name.
     */
    ...
    /**
     * IDL_Naming Return the fully qualified IDL name for this type (e.g. com.acme.Dynamite would return
     * "com::acme::Dynamite").
     *
    ...
    /**
     * Check for a certain type. Type codes are defined in org.glassfish.rmic.iiop.Constants. Returns true if all of the
     * bits in typeCodeMask are present in the full type code of this object.
     */
    ...
    /**
     * Like isType(), but returns true if <em>any</em> of the bits in typeCodeMask are present in the full type code of this
     * object.
     */
     ...
     *
     * @param typeCodeFilter The typeCode to use as a filter.
     * @param alreadyChecked Contains types which have previously been checked and will be ignored. Updated during
     * collection.
     */
     ...
     * @param globalIDLNames If true and useIDLNames true, prepends "::".
     */
    public static void print(IndentingWriter writer, Type[] theTypes, boolean useQualifiedNames, boolean useIDLNames, boolean globalIDLNames)
            throws IOException {
     ...
     *
     * @param constraintNum Used to generate a key of the form "rmic.iiop.constraint.N", which must identify a message in
     * the "rmic.properties" file.
    ...
    protected static boolean failedConstraint(int constraintNum, boolean quiet, ContextStack stack, Object arg0, Object arg1, Object arg2) {
        ...
        if (!quiet) {
            stack.getEnv().error(0, message, (arg0 != null ? arg0.toString() : null), (arg1 != null ? arg1.toString() : null),
    ...
    /*
     * Set the clz and repositoryID fields. Reports error and returns false if fails, returns true if succeeds.
     */
