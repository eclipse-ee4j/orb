...
public interface Constants extends org.glassfish.rmic.Constants {
    ...
    public static final Identifier idPOAServantType = Identifier.lookup("org.omg.PortableServer.Servant");
    ...
    public static final Identifier idClassDesc = Identifier.lookup("javax.rmi.CORBA.ClassDesc");
    ...
    public static final Identifier idByte = Identifier.lookup("byte");
    ...
    public static final Identifier idVoid = Identifier.lookup("void");
    ...
    public static final String[] IDL_KEYWORDS = { "abstract", "any", "attribute", "boolean", "case", "char", "const", "context", "custom", "default", "double",
            "enum", "exception", "factory", "FALSE", "fixed", "float", "in", "inout", "interface", "long", "module", "native", "Object", "octet", "oneway",
            "out", "private", "public", "raises", "readonly", "sequence", "short", "string", "struct", "supports", "switch", "TRUE", "truncatable", "typedef",
