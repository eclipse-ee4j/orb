 ...
 * <p>
 * (As a backwards compatibility trick, Parser implements this protocol, so that an instance of a Parser subclass can
 * handle its own actions. The preferred way to use a Parser, however, is to instantiate it directly with a reference to
 * your own ParserActions implementation.)
 *
...
public interface ParserActions {
     ...
     * Define class
     *
     * @return a cookie for the class This cookie is used by the parser when calling defineField and endClass, and is not
     * examined otherwise.
     */
