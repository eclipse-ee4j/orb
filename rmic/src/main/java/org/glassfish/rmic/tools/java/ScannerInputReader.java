...
/**
 * An input stream for java programs. The stream treats either "\n", "\r" or "\r\n" as the end of a line, it always
 * returns \n. It also parses UNICODE characters expressed as \uffff. However, if it sees "\\", the second slash cannot
 * begin a unicode sequence. It keeps track of the current position in the input stream.
 *
...
public class ScannerInputReader extends FilterReader implements Constants {
    ...
    /**
     * Get the next character from our buffer. Note: this method has been inlined by hand in the `read' method below. Any
     * changes made to this method should be equally applied to that code.
     */
