...
public class NotExpression extends UnaryExpression {
     ...
     *
     * For "not" expressions, we look at the inside expression, and then swap true and false.
     */
    ...
    /**
     * Instead of relying on the default code generation which uses conditional branching, generate a simpler stream using
     * XOR.
     */
