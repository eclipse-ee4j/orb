...
//JCOV
    boolean flagCondInverted; /*
                               * if true, the condition is reversed relatively of source code
                               */
    boolean flagNoCovered = false; /*
                                    * if true, the command will ignored for coverage
                                    */
...
//end JCOV
    ...
    /**
     * When deciding between a lookupswitch and a tableswitch, this value is used in determining how much size increase is
     * acceptable.
     */
